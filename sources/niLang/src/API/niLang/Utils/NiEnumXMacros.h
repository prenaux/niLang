...
#define NI_XENUM_ENTRY(ENUMNAME, NAME, VALUE, ATTR) \
  ENUMNAME##_##NAME ATTR = VALUE,
...
#define NI_XENUM_VALUE_DEF(ENUMNAME, name, value, attr) \
  { #name, ENUMNAME##_##name },
...
#define NI_IMPL_XENUM_DEF(ENUMNAME)                                            \
  ...
  {                                                                            \
    ...
    static const ni::sEnumDef Enum_##ENUMNAME = {                              \
      #ENUMNAME, niCountOf(Enum_##ENUMNAME##_Values), Enum_##ENUMNAME##_Values \
    };                                                                         \
