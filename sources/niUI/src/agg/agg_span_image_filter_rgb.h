...
class span_image_filter_rgb_2x2
 ...
 public:
  ...
  span_image_filter_rgb_2x2(source_type& src, interpolator_type& inter,
...
class span_image_filter_rgb : public span_image_filter<Source, Interpolator> {
 public:
  ...
  span_image_filter_rgb(source_type& src, interpolator_type& inter,
                        const image_filter_lut& filter)
      : base_type(src, inter, &filter)
  {
  }
...
class span_image_resample_rgb_affine
 ...
 public:
  ...
  span_image_resample_rgb_affine(source_type& src, interpolator_type& inter,
                                 const image_filter_lut& filter)
      : base_type(src, inter, filter)
  {
  }
...
class span_image_resample_rgb
 ...
 public:
  ...
  span_image_resample_rgb(source_type& src, interpolator_type& inter,
                          const image_filter_lut& filter)
      : base_type(src, inter, filter)
  {
  }
