...
static inline void Convert_RGB_YCoCg(uint8* d, const uint8* s, const int width,
                                     const int height)
{
  int i;
...
static inline void Convert_YCoCg_RGB(uint8* d, const uint8* s, const int width,
                                     const int height)
{
  int i;
  for (i = 0; i < width * height; ++i) {
...
static inline void Convert_RGBA_YCoCg(uint8* d, const uint8* s, const int width,
                                      const int height)
{
  int i;
  for (i = 0; i < width * height; ++i) {
...
static inline void Convert_YCoCgA_RGBA(uint8* d, const uint8* s,
