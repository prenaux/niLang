...
struct invoke_result_impl<F,
                          decltype(astl::detail::fnref::invoke(
                                     eastl::declval<F>(),
                                     eastl::declval<Us>()...),
                                   void()),
                          Us...> {
  using type = decltype(astl::detail::fnref::invoke(eastl::declval<F>(),
                                                    eastl::declval<Us>()...));
};
...
struct is_invocable_r_impl<
  typename eastl::is_convertible<invoke_result_t<F, Args...>, R>::type, R, F,
  Args...> : eastl::true_type {};
...
class function_ref<R(Args...)> {
 public:
  ...
  ASTL_FUNCTION_REF_11_CONSTEXPR function_ref(F&& f) noexcept
      : obj_(
          const_cast<void*>(reinterpret_cast<const void*>(eastl::addressof(f))))
  {
  ...
  ASTL_FUNCTION_REF_11_CONSTEXPR function_ref<R(Args...)>& operator=(
