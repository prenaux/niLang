...
///
  ...
  #define EASTL_FIXED_LIST_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX           \
      " fixed_list" // Unless the user overrides something, this is "EASTL fixed_list".
#endif

/// EASTL_FIXED_LIST_DEFAULT_ALLOCATOR
///
#ifndef EASTL_FIXED_LIST_DEFAULT_ALLOCATOR
  #define EASTL_FIXED_LIST_DEFAULT_ALLOCATOR \
    overflow_allocator_type(EASTL_FIXED_LIST_DEFAULT_NAME)
#endif
...
class fixed_list
 ...
 public:
  ...
  typedef fixed_list<T, nodeCount, bEnableOverflow, OverflowAllocator>
    this_type;
 ...
 public:
  ...
  fixed_list(std::initializer_list<value_type> ilist,
...
inline fixed_list<T, nodeCount, bEnableOverflow,
                  OverflowAllocator>::fixed_list()
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline fixed_list<T, nodeCount, bEnableOverflow, OverflowAllocator>::fixed_list(
  this_type&& x, const overflow_allocator_type& overflowAllocator)
    : base_type(fixed_allocator_type(mBuffer, overflowAllocator))
{
  // See comments above.
  mAllocator.copy_overflow_allocator(x.mAllocator);
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
template <typename InputIterator>
fixed_list<T, nodeCount, bEnableOverflow, OverflowAllocator>::fixed_list(
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline typename fixed_list<T, nodeCount, bEnableOverflow,
                           OverflowAllocator>::this_type&
fixed_list<T, nodeCount, bEnableOverflow, OverflowAllocator>::operator=(
  const this_type& x)
{
  if (this != &x) {
    base_type::clear();
    ...
    base_type::assign(
      x.begin(),
      x.end()); // It would probably be better to implement this like list::operator=.
  }
  return *this;
}
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline void fixed_list<T, nodeCount, bEnableOverflow, OverflowAllocator>::swap(
  this_type& x)
{
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline void fixed_list<T, nodeCount, bEnableOverflow,
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline bool fixed_list<T, nodeCount, bEnableOverflow, OverflowAllocator>::full()
  const
{
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline bool fixed_list<T, nodeCount, bEnableOverflow,
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline const typename fixed_list<T, nodeCount, bEnableOverflow,
                                 OverflowAllocator>::overflow_allocator_type&
fixed_list<T, nodeCount, bEnableOverflow,
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline void fixed_list<T, nodeCount, bEnableOverflow, OverflowAllocator>::
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline void swap(
  fixed_list<T, nodeCount, bEnableOverflow, OverflowAllocator>& a,
