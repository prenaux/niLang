...
///
  ...
  #define EASTL_STACK_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX      \
      " stack" // Unless the user overrides something, this is "EASTL stack".
#endif
 ...
 public:
  ...
  stack(
    std::initializer_list<value_type>
      ilist); // The first item in the initializer list is pushed first. C++11 doesn't specify that std::stack has initializer list support.
...
template <typename T, typename Container>
inline typename stack<T, Container>::container_type& stack<
...
template <typename T, typename Container>
inline const typename stack<T, Container>::container_type& stack<
...
template <typename T, typename Container>
void stack<T, Container>::swap(this_type& x)
...
template <typename T, typename Container>
inline bool operator==(const stack<T, Container>& a,
                       const stack<T, Container>& b)
{
  return (a.c == b.c);
}
...
inline void swap(stack<T, Container>& a, stack<T, Container>& b)
  EA_NOEXCEPT_IF((eastl::is_nothrow_swappable<
                  typename stack<T, Container>::container_type>::value))
{
  a.swap(b);
}
