...
///////////////////////////////////////////////
iFileBase* __stdcall cLang::CreateFileBaseMemory(tPtr pMem, tSize nSize,
                                                 tBool bFree,
                                                 const achar* aszPath)
{
  return ni::CreateFileBaseMemory(pMem, nSize, bFree, aszPath);
}
iFile* __stdcall cLang::CreateFileMemory(tPtr pMem, tSize nSize, tBool bFree,
                                         const achar* aszPath)
{
...
///////////////////////////////////////////////
iFileBase* __stdcall cLang::CreateFileBaseMemoryAlloc(tSize nSize,
                                                      const achar* aszPath)
{
...
///////////////////////////////////////////////
iFileBase* __stdcall cLang::CreateFileBaseDynamicMemory(tSize anSize,
                                                        const achar* aszPath)
{
  return ni::CreateFileBaseDynamicMemory(anSize, aszPath);
}
iFile* __stdcall cLang::CreateFileDynamicMemory(tSize anSize,
                                                const achar* aszPath)
{
...
///////////////////////////////////////////////
iFileBase* __stdcall cLang::CreateFileBaseWindow(iFileBase* apBase, tI64 anBase,
                                                 tI64 anSize,
                                                 const achar* aaszPath,
                                                 tBool abAutoSeekSet)
{
  return ni::CreateFileBaseWindow(apBase, anBase, anSize, aaszPath,
                                  abAutoSeekSet);
}
iFile* __stdcall cLang::CreateFileWindow(iFileBase* apBase, tI64 anBase,
...
///////////////////////////////////////////////
iFileSystem* __stdcall cLang::CreateFileSystemDir(
...
///////////////////////////////////////////////
iFileSystem* __stdcall cLang::CreateFileSystemHashed(
  const iFileSystem* apFS) const
{
  return ni::CreateFileSystemHashed(apFS);
}

///////////////////////////////////////////////
iFileBase* __stdcall cLang::CreateFileBaseBufferEncoder(iFileBase* apBase,
                                                        iBufferEncoder* apEnc)
{
  return ni::CreateFileBaseBufferEncoder(apBase, apEnc);
}

iFile* __stdcall cLang::CreateFileBufferEncoder(iFileBase* apBase,
                                                iBufferEncoder* apEnc)
{
  return ni::CreateFileBufferEncoder(apBase, apEnc);
}

iFileBase* __stdcall cLang::CreateFileBaseBufferDecoder(iFileBase* apBase,
...
iFile* __stdcall cLang::CreateFileBufferDecoder(iFileBase* apBase,
                                                iBufferDecoder* apDec,
                                                tSize aDecodedSize)
{
...
tSize __stdcall cLang::FileBufferEncode(iBufferEncoder* apEnc, iFile* apSrc,
                                        tSize anSrcSize, iFile* apDest)
{
  return ni::FileBufferEncode(apEnc, apSrc, anSrcSize, apDest);
}

tSize __stdcall cLang::FileBufferDecode(iBufferDecoder* apDec, iFile* apSrc,
                                        tSize anSrcSize, iFile* apDest,
                                        tSize anDestSize)
{
