...
class cDataTableWriteStack
    : public ni::ImplRC<ni::iDataTableWriteStack, ni::eImplFlags_Default> {
 ...
 public:
  ...
  void __stdcall SetEnum(const achar* aaszName, const sEnumDef* apEnumDef,
                         tEnumToStringFlags aFlags, tU32 anVal);
