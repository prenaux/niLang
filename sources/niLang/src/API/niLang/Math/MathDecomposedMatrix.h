...
///////////////////////////////////////////////
template <typename T>
sDecomposedMatrix<T>& DecomposedMatrixFromMatrix(sDecomposedMatrix<T>& Out,
                                                 const sMatrix<T>& In)
{
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& DecomposedMatrixToMatrix(sMatrix<T>& Out,
...
///////////////////////////////////////////////
template <typename T>
sDecomposedMatrix<T>& DecomposedMatrixLerp(sDecomposedMatrix<T>& Out,
                                           const sDecomposedMatrix<T>& A,
                                           const sDecomposedMatrix<T>& B, T fac,
...
///////////////////////////////////////////////
template <typename T>
sDecomposedMatrix<T>& DecomposedMatrixMultiply(sDecomposedMatrix<T>& Out,
                                               const sDecomposedMatrix<T>& A,
