...
nish_std_RayPayload TestGpuFuncs_triangle_instanceindex_rchit(nish_std_RayHitInfo aHitInfo, nish_std_RayGeometryIds aIds, nish_std_RayObjectParams aObject, nish_std_RayWorldParams aWorld, nish_std_RayParams aRay, nish_std_RayTransforms aTransforms);

// Function: TestGpuFuncs
nish_std_RayPayload TestGpuFuncs_triangle_instanceindex_rchit(nish_std_RayHitInfo aHitInfo, nish_std_RayGeometryIds aIds, nish_std_RayObjectParams aObject, nish_std_RayWorldParams aWorld, nish_std_RayParams aRay, nish_std_RayTransforms aTransforms) {
  vec3 instanceColor = nish_std_UIntToHashColor((aIds.instanceUserIndex + 1));
  vec3 _tmp_7 = instanceColor;
  vec4 _tmp_5 = vec4(_tmp_7.x,_tmp_7.y,_tmp_7.z,1.0);
  float _tmp_8 = aHitInfo.hitT;
  return nish_std_RayPayload_new(_tmp_5, _tmp_8);
}
...
void main(void) {
  ...
  nish_std_RayPayload _rval_ = TestGpuFuncs_triangle_instanceindex_rchit(aHitInfo, aIds, aObject, aWorld, aRay, aTransforms);
