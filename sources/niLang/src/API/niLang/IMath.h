...
struct iMath : public iUnknown {
  ...
  virtual tF64 __stdcall BlendIntoAccumulator(tF64 accumulator, tF64 newValue,
                                              tF64 smoothRate) const = 0;
  ...
  //! \remark Where is the upper hemisphere is defined by the specified normal.
  virtual sVec3f __stdcall RandomDirectionEx(const sVec3f& avN,
                                             tF32 afDeviAngle) const = 0;
  //! Rotates a ray to have avN as basis.
  virtual sVec3f __stdcall RotateRay(const sVec3f& avIn,
                                     const sVec3f& avN) const = 0;
  ...
  //! Add.
  virtual sVec2f __stdcall Vec2Add(const sVec2f& aLeft,
                                   const sVec2f& aRight) const = 0;
  //! Subtract.
  virtual sVec2f __stdcall Vec2Sub(const sVec2f& aLeft,
                                   const sVec2f& aRight) const = 0;
  //! Multiply.
  virtual sVec2f __stdcall Vec2Mul(const sVec2f& aLeft,
                                   const sVec2f& aRight) const = 0;
  //! Divide.
  virtual sVec2f __stdcall Vec2Div(const sVec2f& aLeft,
                                   const sVec2f& aRight) const = 0;
  //! Scale.
  virtual sVec2f __stdcall Vec2Scale(const sVec2f& aLeft,
                                     tF32 afRight) const = 0;
  //! Compare.
  virtual tI32 __stdcall Vec2Compare(const sVec2f& aLeft,
                                     const sVec2f& aRight) const = 0;
  //! Length.
  ...
  //! Dot product.
  virtual tF32 __stdcall Vec2Dot(const sVec2f& aLeft,
                                 const sVec2f& aRight) const = 0;
  //! Lerp.
  virtual sVec2f __stdcall Vec2Lerp(const sVec2f& aLeft, const sVec2f& aRight,
                                    tF32 afF) const = 0;
  //! Lerp.
  virtual sVec2f __stdcall Vec2Lerp2(const sVec2f& aLeft, const sVec2f& aRight,
                                     const sVec2f& aF) const = 0;
  //! Blends new values into an accumulator to produce a smoothed time series.
  //!
  //! \param accumulator is the current value of the accumulator
  //! \param newValue is the new value to accumulate
  ...
  //!            useful values are "near zero".
  //! \return the new smoothed value of the accumulator
  virtual sVec2f __stdcall Vec2BlendIntoAccumulator(const sVec2f& accumulator,
                                                    const sVec2f& newValue,
                                                    tF32 smoothRate) const = 0;
  //! Abs.
  virtual sVec2f __stdcall Vec2Abs(const sVec2f& aV) const = 0;
  //! Min.
  virtual sVec2f __stdcall Vec2Min(const sVec2f& aLeft,
                                   const sVec2f& aRight) const = 0;
  //! Max.
  virtual sVec2f __stdcall Vec2Max(const sVec2f& aLeft,
                                   const sVec2f& aRight) const = 0;
  //! CatmullRom spline.
  virtual sVec2f __stdcall Vec2CatmullRom(const sVec2f& V1, const sVec2f& V2,
                                          const sVec2f& V3, const sVec2f& V4,
                                          tF32 s) const = 0;
  //! Hermite spline.
  virtual sVec2f __stdcall Vec2Hermite(const sVec2f& V1, const sVec2f& V2,
                                       const sVec2f& V3, const sVec2f& V4,
                                       tF32 s) const = 0;
  //! BaryCentric.
  virtual sVec2f __stdcall Vec2BaryCentric(const sVec2f& V1, const sVec2f& V2,
                                           const sVec2f& V3, tF32 u,
                                           tF32 v) const = 0;
  //! Transform by the specified matrix.
  virtual sVec4f __stdcall Vec2Transform(const sVec2f& aVec,
                                         const sMatrixf& aMatrix) const = 0;
  //! Transform by the specified matrix.
  virtual sVec2f __stdcall Vec2TransformCoord(
    const sVec2f& aVec, const sMatrixf& aMatrix) const = 0;
  //! Transform by the specified matrix.
  virtual sVec2f __stdcall Vec2TransformNormal(
    const sVec2f& aVec, const sMatrixf& aMatrix) const = 0;
  //! Transform an array by the specified matrix.
  virtual void __stdcall Vec2TransformCoordArray(
    tVec2fCVec* apVecs, const sMatrixf& aMatrix) const = 0;
  //! Transform an array by the specified matrix.
  virtual void __stdcall Vec2TransformNormalArray(
    tVec2fCVec* apVecs, const sMatrixf& aMatrix) const = 0;
#endif
  //! @}
...
#if niMinFeatures(15)
  //! Add.
  virtual sVec3f __stdcall Vec3Add(const sVec3f& aLeft,
                                   const sVec3f& aRight) const = 0;
  //! Subtract.
  virtual sVec3f __stdcall Vec3Sub(const sVec3f& aLeft,
                                   const sVec3f& aRight) const = 0;
  //! Multiply.
  virtual sVec3f __stdcall Vec3Mul(const sVec3f& aLeft,
                                   const sVec3f& aRight) const = 0;
  //! Divide.
  virtual sVec3f __stdcall Vec3Div(const sVec3f& aLeft,
                                   const sVec3f& aRight) const = 0;
  //! Scale.
  virtual sVec3f __stdcall Vec3Scale(const sVec3f& aLeft,
                                     tF32 afRight) const = 0;
  //! Compare.
  virtual tI32 __stdcall Vec3Compare(const sVec3f& aLeft,
                                     const sVec3f& aRight) const = 0;
  //! Length.
  ...
  //! Dot product.
  virtual tF32 __stdcall Vec3Dot(const sVec3f& aLeft,
                                 const sVec3f& aRight) const = 0;
  //! Cross product.
  virtual sVec3f __stdcall Vec3Cross(const sVec3f& aLeft,
                                     const sVec3f& aRight) const = 0;
  //! Lerp.
  virtual sVec3f __stdcall Vec3Lerp(const sVec3f& aLeft, const sVec3f& aRight,
                                    tF32 afF) const = 0;
  //! Lerp.
  virtual sVec3f __stdcall Vec3Lerp2(const sVec3f& aLeft, const sVec3f& aRight,
                                     const sVec3f& aF) const = 0;
  //! Blends new values into an accumulator to produce a smoothed time series.
  //!
  //! \param accumulator is the current value of the accumulator
  //! \param newValue is the new value to accumulate
  ...
  //!            useful values are "near zero".
  //! \return the new smoothed value of the accumulator
  virtual sVec3f __stdcall Vec3BlendIntoAccumulator(const sVec3f& accumulator,
                                                    const sVec3f& newValue,
                                                    tF32 smoothRate) const = 0;
  //! Abs.
  virtual sVec3f __stdcall Vec3Abs(const sVec3f& aV) const = 0;
  //! Min.
  virtual sVec3f __stdcall Vec3Min(const sVec3f& aLeft,
                                   const sVec3f& aRight) const = 0;
  //! Max.
  virtual sVec3f __stdcall Vec3Max(const sVec3f& aLeft,
                                   const sVec3f& aRight) const = 0;
  //! CatmullRom spline.
  virtual sVec3f __stdcall Vec3CatmullRom(const sVec3f& V1, const sVec3f& V2,
                                          const sVec3f& V3, const sVec3f& V4,
                                          tF32 s) const = 0;
  //! Hermite spline.
  virtual sVec3f __stdcall Vec3Hermite(const sVec3f& V1, const sVec3f& V2,
                                       const sVec3f& V3, const sVec3f& V4,
                                       tF32 s) const = 0;
  //! BaryCentric.
  virtual sVec3f __stdcall Vec3BaryCentric(const sVec3f& V1, const sVec3f& V2,
                                           const sVec3f& V3, tF32 u,
                                           tF32 v) const = 0;
  //! Transform by the specified matrix.
  virtual sVec4f __stdcall Vec3Transform(const sVec3f& aVec,
                                         const sMatrixf& aMatrix) const = 0;
  //! Transform by the specified matrix.
  virtual sVec3f __stdcall Vec3TransformCoord(
    const sVec3f& aVec, const sMatrixf& aMatrix) const = 0;
  //! Transform by the specified matrix.
  virtual sVec3f __stdcall Vec3TransformNormal(
    const sVec3f& aVec, const sMatrixf& aMatrix) const = 0;
  //! Transform an array by the specified matrix.
  virtual void __stdcall Vec3TransformCoordArray(
    tVec3fCVec* apVecs, const sMatrixf& aMatrix) const = 0;
  //! Transform an array by the specified matrix.
  virtual void __stdcall Vec3TransformNormalArray(
    tVec3fCVec* apVecs, const sMatrixf& aMatrix) const = 0;
  //! Unproject a vector.
  virtual sVec3f __stdcall Vec3Unproject(
    const sVec3f& avIn, const sRectf& aVP,
    const sMatrixf& amtxViewProj) const = 0;
  //! Project a vector.
  virtual sVec3f __stdcall Vec3Project(const sVec3f& avPos,
                                       const sMatrixf& amtxWVP,
                                       const sRectf& aRect) const = 0;
  //! Project a vector.
  virtual sVec4f __stdcall Vec3ProjectRHW(const sVec3f& avPos,
                                          const sMatrixf& amtxWVP,
                                          const sRectf& aRect) const = 0;
  ...
  virtual sVec3f __stdcall Vec3Reflect(const sVec3f& Dir,
                                       const sVec3f& Normal) const = 0;
#endif
  //! @}
...
#if niMinFeatures(15)
  //! Add.
  virtual sVec4f __stdcall Vec4Add(const sVec4f& aLeft,
                                   const sVec4f& aRight) const = 0;
  //! Subtract.
  virtual sVec4f __stdcall Vec4Sub(const sVec4f& aLeft,
                                   const sVec4f& aRight) const = 0;
  //! Multiply.
  virtual sVec4f __stdcall Vec4Mul(const sVec4f& aLeft,
                                   const sVec4f& aRight) const = 0;
  //! Divide.
  virtual sVec4f __stdcall Vec4Div(const sVec4f& aLeft,
                                   const sVec4f& aRight) const = 0;
  //! Scale.
  virtual sVec4f __stdcall Vec4Scale(const sVec4f& aLeft,
                                     tF32 afRight) const = 0;
  //! Compare.
  virtual tI32 __stdcall Vec4Compare(const sVec4f& aLeft,
                                     const sVec4f& aRight) const = 0;
  //! Length.
  ...
  //! Dot product.
  virtual tF32 __stdcall Vec4Dot(const sVec4f& aLeft,
                                 const sVec4f& aRight) const = 0;
  //! Cross product.
  virtual sVec4f __stdcall Vec4Cross(const sVec4f& aA, const sVec4f& aB,
                                     const sVec4f& aC) const = 0;
  //! Lerp.
  virtual sVec4f __stdcall Vec4Lerp(const sVec4f& aLeft, const sVec4f& aRight,
                                    tF32 afF) const = 0;
  //! Lerp.
  virtual sVec4f __stdcall Vec4Lerp2(const sVec4f& aLeft, const sVec4f& aRight,
                                     const sVec4f& aF) const = 0;
  //! Blends new values into an accumulator to produce a smoothed time series.
  //!
  //! \param accumulator is the current value of the accumulator
  //! \param newValue is the new value to accumulate
  ...
  //!            useful values are "near zero".
  //! \return the new smoothed value of the accumulator
  virtual sVec4f __stdcall Vec4BlendIntoAccumulator(const sVec4f& accumulator,
                                                    const sVec4f& newValue,
                                                    tF32 smoothRate) const = 0;
  //! Abs.
  virtual sVec4f __stdcall Vec4Abs(const sVec4f& aV) const = 0;
  //! Min.
  virtual sVec4f __stdcall Vec4Min(const sVec4f& aLeft,
                                   const sVec4f& aRight) const = 0;
  //! Max.
  virtual sVec4f __stdcall Vec4Max(const sVec4f& aLeft,
                                   const sVec4f& aRight) const = 0;
  //! CatmullRom spline.
  virtual sVec4f __stdcall Vec4CatmullRom(const sVec4f& V1, const sVec4f& V2,
                                          const sVec4f& V3, const sVec4f& V4,
                                          tF32 s) const = 0;
  //! Hermite spline.
  virtual sVec4f __stdcall Vec4Hermite(const sVec4f& V1, const sVec4f& V2,
                                       const sVec4f& V3, const sVec4f& V4,
                                       tF32 s) const = 0;
  //! BaryCentric.
  virtual sVec4f __stdcall Vec4BaryCentric(const sVec4f& V1, const sVec4f& V2,
                                           const sVec4f& V3, tF32 u,
                                           tF32 v) const = 0;
  //! Transform by the specified matrix.
  virtual sVec4f __stdcall Vec4Transform(const sVec4f& aVec,
                                         const sMatrixf& aMatrix) const = 0;
  //! Transform an array by the specified matrix.
  virtual void __stdcall Vec4TransformArray(tVec4fCVec* apVecs,
                                            const sMatrixf& aMatrix) const = 0;
#endif
  //! @}
  ...
  //! Add.
  virtual sMatrixf __stdcall MatrixAdd(const sMatrixf& aLeft,
                                       const sMatrixf& aRight) const = 0;
  //! Subtract.
  virtual sMatrixf __stdcall MatrixSub(const sMatrixf& aLeft,
                                       const sMatrixf& aRight) const = 0;
  //! Scale.
  virtual sMatrixf __stdcall MatrixScale(const sMatrixf& aLeft,
                                         tF32 afRight) const = 0;
  //! Lerp.
  virtual sMatrixf __stdcall MatrixLerp(const sMatrixf& A, const sMatrixf& B,
                                        tF32 fFac) const = 0;
  //! Compare.
  virtual tI32 __stdcall MatrixCompare(const sMatrixf& aLeft,
                                       const sMatrixf& aRight) const = 0;
  //! Multiply two matrix.
  virtual sMatrixf __stdcall MatrixMultiply(const sMatrixf& M1,
                                            const sMatrixf& M2) const = 0;
  ...
  virtual sMatrixf __stdcall MatrixTransformInverse(
    const sMatrixf& M) const = 0;
  //! Make a right handed look at matrix.
  virtual sMatrixf __stdcall MatrixLookAtRH(const sVec3f& Eye, const sVec3f& At,
                                            const sVec3f& Up) const = 0;
  //! Make a left handed look at matrix.
  virtual sMatrixf __stdcall MatrixLookAtLH(const sVec3f& Eye, const sVec3f& At,
                                            const sVec3f& Up) const = 0;
  //! Make a right handed orthogonal projection matrix.
  virtual sMatrixf __stdcall MatrixOrthoRH(tF32 w, tF32 h, tF32 zn,
                                           tF32 zf) const = 0;
  //! Make a left handed orthogonal projection matrix.
  virtual sMatrixf __stdcall MatrixOrthoLH(tF32 w, tF32 h, tF32 zn,
                                           tF32 zf) const = 0;
  //! Make a right handed orthogonal projection matrix.
  virtual sMatrixf __stdcall MatrixOrthoOffCenterRH(tF32 l, tF32 r, tF32 t,
                                                    tF32 b, tF32 zn,
                                                    tF32 zf) const = 0;
  //! Make a left handed orthogonal projection matrix.
  virtual sMatrixf __stdcall MatrixOrthoOffCenterLH(tF32 l, tF32 r, tF32 t,
                                                    tF32 b, tF32 zn,
                                                    tF32 zf) const = 0;
  //! Make a right handed perspective projection matrix.
  virtual sMatrixf __stdcall MatrixPerspectiveRH(tF32 w, tF32 h, tF32 zn,
                                                 tF32 zf) const = 0;
  //! Make a left handed perspective projection matrix.
  virtual sMatrixf __stdcall MatrixPerspectiveLH(tF32 w, tF32 h, tF32 zn,
                                                 tF32 zf) const = 0;
  //! Make a right handed perspective projection matrix.
  virtual sMatrixf __stdcall MatrixPerspectiveFovRH(tF32 fovy, tF32 aspect,
                                                    tF32 zn, tF32 zf) const = 0;
  //! Make a left handed perspective projection matrix.
  virtual sMatrixf __stdcall MatrixPerspectiveFovLH(tF32 fovy, tF32 aspect,
                                                    tF32 zn, tF32 zf) const = 0;
  //! Make a right handed perspective projection matrix.
  virtual sMatrixf __stdcall MatrixPerspectiveOffCenterRH(tF32 l, tF32 r,
                                                          tF32 t, tF32 b,
                                                          tF32 zn,
                                                          tF32 zf) const = 0;
  //! Make a left handed perspective projection matrix.
  virtual sMatrixf __stdcall MatrixPerspectiveOffCenterLH(tF32 l, tF32 r,
                                                          tF32 t, tF32 b,
                                                          tF32 zn,
                                                          tF32 zf) const = 0;
  ...
  virtual sMatrixf __stdcall MatrixRotationAxis(const sVec3f& V,
                                                tF32 angle) const = 0;
  //! Make a rotation matrix.
  ...
  //! Make a rotation matrix.
  virtual sMatrixf __stdcall MatrixRotationYawPitchRoll(tF32 yaw, tF32 pitch,
                                                        tF32 roll) const = 0;
  ...
  virtual sVec3f __stdcall MatrixDecomposeYawPitchRoll(
    const sMatrixf& M) const = 0;
  //! Make a scaling matrix.
  virtual sMatrixf __stdcall MatrixScaling(const sVec3f& V) const = 0;
  //! Scale a matrix.
  virtual sMatrixf __stdcall MatrixVecScale(const sMatrixf& M,
                                            const sVec3f& V) const = 0;
  //! Make a shadow projection matrix.
  virtual sMatrixf __stdcall MatrixShadow(const sVec4f& vLight,
                                          const sPlanef& Plane) const = 0;
  ...
  virtual sMatrixf __stdcall MatrixTextureOffset(tF32 fBias, tI32 nTexW,
                                                 tI32 nTexH) const = 0;
  //! Texture offset matrix that takes in account a bit depth.
  virtual sMatrixf __stdcall MatrixTextureOffset2(tF32 fBias, tI32 nTexW,
                                                  tI32 nTexH,
                                                  tI32 nDepthBits) const = 0;
  ...
  virtual sMatrixf __stdcall MatrixSetForward(const sMatrixf& M,
                                              const sVec3f& V) const = 0;
  //! Set the up vector of a matrix.
  virtual sMatrixf __stdcall MatrixSetUp(const sMatrixf& M,
                                         const sVec3f& V) const = 0;
  //! Set the right vector of a matrix.
  virtual sMatrixf __stdcall MatrixSetRight(const sMatrixf& M,
                                            const sVec3f& V) const = 0;
  //! Set the translation vector of a matrix.
  virtual sMatrixf __stdcall MatrixSetTranslation(const sMatrixf& M,
                                                  const sVec3f& V) const = 0;
  ...
  virtual sMatrixf __stdcall MatrixSetRotation(const sMatrixf& In,
                                               const sMatrixf& RotM) const = 0;
  ...
  virtual sMatrixf __stdcall MatrixToCoordinateSystem(
    const sVec3f& avRight, const sVec3f& avUp, const sVec3f& avFwd,
  ...
  virtual sVec3f __stdcall MatrixGetProjectedTranslation(
    const sMatrixf& In) const = 0;
  ...
  virtual sMatrixf __stdcall MatrixSetProjectedTranslation(
    const sMatrixf& In, const sVec3f& avT) const = 0;
  //! Set the non-rotation part of the matrix.
  virtual sMatrixf __stdcall MatrixSetNotRotation(const sMatrixf& In,
                                                  const sMatrixf& M) const = 0;
  //! Rotate the matrix, this affects only the 3x3 top-left rotation part of the matrix.
  virtual sMatrixf __stdcall MatrixRotate(const sMatrixf& M1,
                                          const sMatrixf& M2) const = 0;
  ...
  virtual sMatrixf __stdcall MatrixViewport(const sVec4f& aVP, tF32 afMinZ,
                                            tF32 afMaxZ) const = 0;
  ...
  //! \remark MinZ/MaxZ is usually 0/1
  virtual sMatrixf __stdcall MatrixAdjustViewport(const sVec4f& aContextVP,
                                                  const sVec4f& aVirtualVP,
                                                  tF32 afMinZ,
                                                  tF32 afMaxZ) const = 0;

  //! Get the translation part of a matrix.
  virtual sVec3f __stdcall MatrixDecomposeGetTranslation(
    const sMatrixf& aMatrix) const = 0;
  //! Get the rotation part of a matrix as euler angle in the Z*Y*X rotation order.
  virtual sVec3f __stdcall MatrixDecomposeGetZYX(
    const sMatrixf& aMatrix) const = 0;
  //! Get the rotation part of a matrix as a quaternion.
  virtual sQuatf __stdcall MatrixDecomposeGetQuat(
    const sMatrixf& aMatrix) const = 0;
  //! Get the local scaling part of a matrix (x,y,z,handness)
  virtual sVec4f __stdcall MatrixDecomposeGetScale(
    const sMatrixf& aMatrix) const = 0;
  //! Build a matrix from a translation, zyx euler rotation and scale.
  virtual sMatrixf __stdcall MatrixCompose(const sVec3f& aT, const sVec3f& aZYX,
                                           const sVec4f& aS) const = 0;
  //! Build a matrix from a translation, rotation quaternion and scale.
  virtual sMatrixf __stdcall MatrixComposeQ(const sVec3f& aT, const sQuatf& aQ,
                                            const sVec4f& aS) const = 0;
#endif
  //! @}
  ...
  //! Add.
  virtual sQuatf __stdcall QuatAdd(const sQuatf& aLeft,
                                   const sQuatf& aRight) const = 0;
  //! Subtract.
  virtual sQuatf __stdcall QuatSub(const sQuatf& aLeft,
                                   const sQuatf& aRight) const = 0;
  //! Scale.
  virtual sQuatf __stdcall QuatScale(const sQuatf& aLeft,
                                     tF32 afRight) const = 0;
  //! Compare.
  virtual tI32 __stdcall QuatCompare(const sQuatf& aLeft,
                                     const sQuatf& aRight) const = 0;
  //! BaryCenter.
  virtual sQuatf __stdcall QuatBaryCentric(const sQuatf& Q1, const sQuatf& Q2,
                                           const sQuatf& Q3, tF32 f,
                                           tF32 g) const = 0;
  //! Quat conjugate.
  ...
  //! Quat multiply.
  virtual sQuatf __stdcall QuatMultiply(const sQuatf& Q1,
                                        const sQuatf& Q2) const = 0;
  //! Quat normalize.
  virtual sQuatf __stdcall QuatNormalize(const sQuatf& Q) const = 0;
  //! Rotation quaternion.
  virtual sQuatf __stdcall QuatRotationAxis(const sVec3f& V,
                                            tF32 angle) const = 0;
  //! Rotation quaternion.
  ...
  //! Rotation quaternion.
  virtual sQuatf __stdcall QuatRotationYawPitchRoll(const tF32 yaw,
                                                    const tF32 pitch,
                                                    const tF32 roll) const = 0;
  //! Rotation quaternion.
  virtual sQuatf __stdcall QuatRotationVector(const sVec3f& vFrom,
                                              const sVec3f& vTo) const = 0;
  //! Quat slerp.
  virtual sQuatf __stdcall QuatSlerp(const sQuatf& Q1, const sQuatf& Q2, tF32 t,
                                     eQuatSlerp mode) const = 0;
  //! Quat squad.
  virtual sQuatf __stdcall QuatSquad(const sQuatf& Q1, const sQuatf& Q2,
                                     const sQuatf& Q3, const sQuatf& Q4,
                                     tF32 t) const = 0;
  //! Quat to axis angle.
  ...
  virtual tF32 __stdcall PlaneDotCoord(const sPlanef& P,
                                       const sVec3f& V) const = 0;
  //! 3D dot product between a plane and a 3d vector.
  virtual tF32 __stdcall PlaneDotNormal(const sPlanef& P,
                                        const sVec3f& V) const = 0;
  //! Distance between a plane and the specified point.
  virtual tF32 __stdcall PlaneDistance(const sPlanef& P,
                                       const sVec3f& V) const = 0;
  //! Construct a plane from a point and a normal.
  virtual sPlanef __stdcall PlaneFromPointNormal(
    const sVec3f& vPoint, const sVec3f& vNormal) const = 0;
  //! Construct a plane from three points.
  virtual sPlanef __stdcall PlaneFromPoints(const sVec3f& V1, const sVec3f& V2,
                                            const sVec3f& V3) const = 0;
  ...
  virtual sVec4f __stdcall PlaneIntersectLine(const sPlanef& P,
                                              const sVec3f& V1,
                                              const sVec3f& V2) const = 0;
  //! Compute the intersection between a plane and a ray.
  //! \return the intersection point (x,y,z), t is stored in the w component
  //! \remark returns a null vector if the line is parralel to the plane.
  virtual sVec4f __stdcall PlaneIntersectRay(const sPlanef& P,
                                             const sVec3f& avRayPos,
                                             const sVec3f& avRayDir) const = 0;
  ...
  virtual sPlanef __stdcall PlaneTransform(const sPlanef& P,
                                           const sMatrixf& M) const = 0;
  //! Transform the plane by the inverse of the specified matrix.
  virtual sPlanef __stdcall PlaneTransformInversedMatrix(
    const sPlanef& P, const sMatrixf& M) const = 0;
  //! Get the intersection point between 3d planes.
  virtual sVec3f __stdcall PlaneIntersection(const sPlanef& PA,
                                             const sPlanef& PB,
                                             const sPlanef& PC) const = 0;
  //! Get the closest point on the plane to the specified vector.
  virtual sVec3f __stdcall PlaneClosest(const sPlanef& P,
                                        const sVec3f& A) const = 0;
  ...
  virtual sMatrixf __stdcall PlaneExtractCoordinateSystem(
    const sPlanef& Plane, const sVec3f& avFwdDir) const = 0;
  //! Check if the specified sphere intersect the specified plane.
  virtual tBool __stdcall PlaneIntersectSphere(const sPlanef& plane,
                                               const sVec3f& avCenter,
                                               const tF32 afRadius) const = 0;
#endif
  //! @}
  ...
  virtual sVec4f __stdcall TriangleAreaNormal(const sVec3f& V0,
                                              const sVec3f& V1,
                                              const sVec3f& V2) const = 0;
  //! Check whether the triangle is degenerated.
  virtual tBool __stdcall TriangleIsDegenerate(const sVec3f& V0,
                                               const sVec3f& V1,
                                               const sVec3f& V2) const = 0;
  //! Check triangle-triangle intersection.
  virtual tBool __stdcall TriangleIntersectTriangle(
    const sVec3f& V0, const sVec3f& V1, const sVec3f& V2, const sVec3f& U0,
    const sVec3f& U1, const sVec3f& U2) const = 0;
  //! Check triangle-ray intersection.
  virtual sVec3f __stdcall TriangleIntersectRay(const sVec3f& avOrigin,
                                                const sVec3f& avDir,
                                                const sVec3f& V0,
                                                const sVec3f& V1,
                                                const sVec3f& V2) const = 0;
  //! Check triangle-ray intersection with culling.
  virtual sVec3f __stdcall TriangleIntersectRayCull(const sVec3f& avOrigin,
                                                    const sVec3f& avDir,
                                                    const sVec3f& V0,
                                                    const sVec3f& V1,
                                                    const sVec3f& V2) const = 0;
  //! Check triangle-aabb intersection.
  virtual tBool __stdcall TriangleIntersectAABB(const sVec3f& V0,
                                                const sVec3f& V1,
                                                const sVec3f& V2,
                                                const sVec3f& avMin,
                                                const sVec3f& avMax) const = 0;
  //! Compute the barycentric coordinates of the specified point.
  virtual sVec3f __stdcall TriangleBaryCentric(const sVec3f& A, const sVec3f& B,
                                               const sVec3f& C,
                                               const sVec3f& P) const = 0;
#endif
  //! @}
  ...
  virtual tF32 __stdcall GetAngleFromPoints2D(const sVec2f& aStartPos,
                                              const sVec2f& aGoalPos) const = 0;
  ...
  //!     </ul>
  virtual sVec2f __stdcall GetAngleFromPoints3D(
    const sVec3f& aStartPos, const sVec3f& aGoalPos) const = 0;
  //! Check whether a point is in-front, behind or on a plane.
  virtual eClassify __stdcall ClassifyPoint(const sPlanef& plane,
                                            const sVec3f& point) const = 0;
  //! Check whether a point is on the specified edge.
  virtual tBool __stdcall IsPointInsideEdge(const sVec3f& A, const sVec3f& B,
                                            const sVec3f& P) const = 0;
  //! Return the closest point to the specified vector P on the specified AB line.
  virtual sVec3f __stdcall ClosestPointOnLine(const sVec3f& A, const sVec3f& B,
                                              const sVec3f& P) const = 0;
  //! Return the closest point to the specified vector P on the specified ABC triangle.
  virtual sVec3f __stdcall ClosestPointOnTriangle(const sVec3f& A,
                                                  const sVec3f& B,
                                                  const sVec3f& C,
                                                  const sVec3f& P) const = 0;
  ...
  virtual tF32 __stdcall ComputePixelWorldSizeY(const tF32 afPixelSize,
                                                const sVec3f& avPos,
                                                const sMatrixf& mtxWorldView,
                                                const sMatrixf& mtxProj,
                                                const sRectf& aVP) const = 0;
  //! Compute the world size of the given pixel size, scale based on the X and Y axis delta.
  virtual sVec2f __stdcall ComputePixelWorldSizeVec2(
    const tF32 afPixelSize, const sVec3f& avPos, const sMatrixf& mtxWorldView,
    const sMatrixf& mtxProj, const sRectf& aVP) const = 0;
  //! Compute the world size of the give pixel size, scale based on the axis with the highest resolution.
  virtual tF32 __stdcall ComputePixelWorldSize(const tF32 afPixelSize,
                                               const sVec3f& avPos,
                                               const sMatrixf& amtxWorldView,
                                               const sMatrixf& amtxProj,
                                               const sRectf& aVP) const = 0;
  //! Computes a 2x2 matrix determinant.
  virtual tF32 __stdcall Det2x2f(const tF32 a, const tF32 b, const tF32 c,
                                 const tF32 d) const = 0;
  //! Computes a 3x3 matrix determinant.
  virtual tF32 __stdcall Det3x3f(const tF32 a0, const tF32 a1, const tF32 a2,
                                 const tF32 a3, const tF32 a4, const tF32 a5,
                                 const tF32 a6, const tF32 a7,
                                 const tF32 a8) const = 0;
  //! Computes a 4x4 matrix determinant.
  virtual tF32 __stdcall Det4x4f(const tF32 a0, const tF32 a1, const tF32 a2,
                                 const tF32 a3, const tF32 a4, const tF32 a5,
                                 const tF32 a6, const tF32 a7, const tF32 a8,
                                 const tF32 a9, const tF32 a10, const tF32 a11,
                                 const tF32 a12, const tF32 a13, const tF32 a14,
                                 const tF32 a15) const = 0;
  //! Computes a 2x2 matrix determinant.
  virtual tF64 __stdcall Det2x2d(const tF64 a, const tF64 b, const tF64 c,
                                 const tF64 d) const = 0;
  //! Computes a 3x3 matrix determinant.
  virtual tF64 __stdcall Det3x3d(const tF64 a0, const tF64 a1, const tF64 a2,
                                 const tF64 a3, const tF64 a4, const tF64 a5,
                                 const tF64 a6, const tF64 a7,
                                 const tF64 a8) const = 0;
  //! Computes a 4x4 matrix determinant.
  virtual tF64 __stdcall Det4x4d(const tF64 a0, const tF64 a1, const tF64 a2,
                                 const tF64 a3, const tF64 a4, const tF64 a5,
                                 const tF64 a6, const tF64 a7, const tF64 a8,
                                 const tF64 a9, const tF64 a10, const tF64 a11,
                                 const tF64 a12, const tF64 a13, const tF64 a14,
                                 const tF64 a15) const = 0;
  ...
  virtual tF64 __stdcall CurveHermite(tF64 V1, tF64 T1, tF64 V2, tF64 T2,
                                      tF64 s) const = 0;
  virtual tF64 __stdcall CurveCatmullRom(tF64 V1, tF64 V2, tF64 V3, tF64 V4,
                                         tF64 s) const = 0;
  virtual tF64 __stdcall CurveCardinal(tF64 V1, tF64 V2, tF64 s,
                                       tF64 a) const = 0;
  virtual tF64 __stdcall CurveCardinal4(tF64 V1, tF64 V2, tF64 V3, tF64 V4,
                                        tF64 s, tF64 a) const = 0;
  ...
  virtual tF64 __stdcall CycleCardinal(tF64 aX, tF64 aMin, tF64 aMax,
                                       tF64 a) const = 0;
#endif
  //! @}
  ...
  virtual tBool __stdcall ProbSampleBuildAliasMethodArrays(
    const tF64CVec* apProbs, tF64CVec* apAMQ, tU32CVec* apAMA) const = 0;
  virtual tBool __stdcall ProbSampleAliasMethod(
    tU32CVec* apResults, const tF64CVec* apAMQ,
    const tU32CVec* apAMA) const = 0;
  //! @}
};
