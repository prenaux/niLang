...
///////////////////////////////////////////////
template <typename T>
inline sVec2<T>& VecClamp(sVec2<T>& Out, const sVec2<T>& V,
...
///////////////////////////////////////////////
template <class T>
sVec2<T>& VecMAD(sVec2<T>& Out, const sVec2<T>& A, const sVec2<T>& B,
                 const sVec2<T>& C)
{
  Out.x = (A.x * B.x) + C.x;
  Out.y = (A.y * B.y) + C.y;
...
///////////////////////////////////////////////
template <class T>
sVec2<T>& VecBaryCentric(sVec2<T>& Out, const sVec2<T>& V1, const sVec2<T>& V2,
                         const sVec2<T>& V3, T f, T g)
{
...
///////////////////////////////////////////////
template <class T>
sVec2<T>& VecCatmullRom(sVec2<T>& Out, const sVec2<T>& V1, const sVec2<T>& V2,
                        const sVec2<T>& V3, const sVec2<T>& V4, T s)
{
  T ss, sss, a, b, c, d;
...
///////////////////////////////////////////////
template <class T>
sVec2<T>& VecHermite(sVec2<T>& Out, const sVec2<T>& V1, const sVec2<T>& T1,
                     const sVec2<T>& V2, const sVec2<T>& T2, T s)
{
  T ss, sss, a, b, c, d;
...
///////////////////////////////////////////////
template <class T>
sVec2<T>& VecTransformCoord(sVec2<T>& Out, const sVec2<T>& V,
                            const sMatrix<T>& M)
{
  T rhw, x, y;
...
///////////////////////////////////////////////
template <class T>
sVec2<T>& VecTransformNormal(sVec2<T>& Out, const sVec2<T>& V,
                             const sMatrix<T>& M)
{
  T x, y;
...
///////////////////////////////////////////////
template <class T>
sVec2<T>& VecLerp(sVec2<T>& Out, const sVec2<T>& V1, const sVec2<T>& V2,
                  const sVec2<T>& V3)
{
...
///////////////////////////////////////////////
template <class T>
inline tBool VecEqual(const sVec2<T>& A, const sVec2<T>& B,
