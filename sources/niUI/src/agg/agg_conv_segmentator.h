...
struct conv_segmentator : public conv_adaptor_vpgen<VertexSource, vpgen_segmentator>
{
  ...
  void approximation_scale(agg_real s) { base_type::vpgen().approximation_scale(s);        }
  agg_real approximation_scale() const { return base_type::vpgen().approximation_scale();  }
