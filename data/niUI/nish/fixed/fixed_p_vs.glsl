...
nish_std_VertexOutput niUIGpuFuncs_fixed_p_vs(nish_std_VertexP aInput, niUIGpuFuncs_FixedUniforms aUniforms);
...
nish_std_VertexOutput niUIGpuFuncs_fixed_p_vs(nish_std_VertexP aInput, niUIGpuFuncs_FixedUniforms aUniforms) {
  ...
  vec4 _tmp_a = aUniforms.materialColor;
  vec2 _tmp_c = vec2_Zero;
  return nish_std_VertexOutput_new(_tmp_5, _tmp_9, _tmp_a, _tmp_c);
}
// MODULE END niUIGpuFuncs

// Vertex Shader main: niUIGpuFuncs_fixed_p_vs
...
void main(void) {
  ...
  nish_std_VertexOutput _rval_ = niUIGpuFuncs_fixed_p_vs(aInput, aUniforms);
