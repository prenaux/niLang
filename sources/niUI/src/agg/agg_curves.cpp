...
//------------------------------------------------------------------------
void curve3_inc::init(agg_real x1, agg_real y1, agg_real x2, agg_real y2,
...
//------------------------------------------------------------------------
void curve3_div::init(agg_real x1, agg_real y1, agg_real x2, agg_real y2,
                      agg_real x3, agg_real y3)
{
  m_points.remove_all();
...
//------------------------------------------------------------------------
void curve3_div::recursive_bezier(agg_real x1, agg_real y1, agg_real x2,
...
//------------------------------------------------------------------------
void curve3_div::bezier(agg_real x1, agg_real y1, agg_real x2, agg_real y2,
                        agg_real x3, agg_real y3)
{
...
static agg_real MSC60_fix_ICE(agg_real v)
{
  return v;
}
#endif
...
//------------------------------------------------------------------------
void curve4_inc::init(agg_real x1, agg_real y1, agg_real x2, agg_real y2,
                      agg_real x3, agg_real y3, agg_real x4, agg_real y4)
{
  ...
  m_saved_dfx = m_dfx =
    (x2 - x1) * pre1 + tmp1x * pre2 + tmp2x * subdivide_step3;
  m_saved_dfy = m_dfy =
    (y2 - y1) * pre1 + tmp1y * pre2 + tmp2y * subdivide_step3;
...
//------------------------------------------------------------------------
void curve4_div::init(agg_real x1, agg_real y1, agg_real x2, agg_real y2,
                      agg_real x3, agg_real y3, agg_real x4, agg_real y4)
{
  m_points.remove_all();
  m_distance_tolerance_square = 0.5 / m_approximation_scale;
...
//------------------------------------------------------------------------
void curve4_div::recursive_bezier(agg_real x1, agg_real y1, agg_real x2,
                                  agg_real y2, agg_real x3, agg_real y3,
                                  agg_real x4, agg_real y4, unsigned level)
{
  if (level > curve_recursion_limit) {
    return;
  }
...
//------------------------------------------------------------------------
void curve4_div::bezier(agg_real x1, agg_real y1, agg_real x2, agg_real y2,
                        agg_real x3, agg_real y3, agg_real x4, agg_real y4)
{
  m_points.add(point_d(x1, y1));
