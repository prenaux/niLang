...
class cWidgetTree : public ni::ImplRC<ni::iWidgetSink, ni::eImplFlags_Default,
                                      ni::iWidgetTree> {
 ...
 public:
  ...
  tBool __stdcall LoadTreeStates(iDataTable* apStates,
  ...
  void _ProcessClick(tU32 aMsg, const sVec2f& avMousePos, tBool abExecute,
                     tU32 aModifier);
  ...
  tBool _DoSelect(ni::iWidgetTreeNode* apNode, tU32 aModifier,
                  tBool abForceSetSelect);
  tBool _DoSelectFinal(ni::iWidgetTreeNode* apNode, tU32 aModifier,
                       tBool abForceSetSelect);
  void _ClearSelectRange();
  void _SetSelectRange(ni::iWidgetTreeNode* apFirst,
                       ni::iWidgetTreeNode* apLast);
