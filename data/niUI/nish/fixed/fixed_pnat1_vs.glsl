...
nish_std_VertexOutput niUIGpuFuncs_fixed_pnat1_vs(nish_std_VertexPNAT1 aInput, niUIGpuFuncs_FixedUniforms aUniforms);
...
nish_std_VertexOutput niUIGpuFuncs_fixed_pnat1_vs(nish_std_VertexPNAT1 aInput, niUIGpuFuncs_FixedUniforms aUniforms) {
  ...
  vec4 _tmp_i = (aInput.color*aUniforms.materialColor);
  vec2 _tmp_n = aInput.tex0;
  return nish_std_VertexOutput_new(_tmp_5, _tmp_9, _tmp_i, _tmp_n);
}
// MODULE END niUIGpuFuncs

// Vertex Shader main: niUIGpuFuncs_fixed_pnat1_vs
...
void main(void) {
  ...
  nish_std_VertexOutput _rval_ = niUIGpuFuncs_fixed_pnat1_vs(aInput, aUniforms);
