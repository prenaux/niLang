...
///
  ...
  #define EASTL_VECTOR_MULTISET_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX                \
      " vector_multiset" // Unless the user overrides something, this is "EASTL vector_multiset".
#endif

/// EASTL_VECTOR_MULTISET_DEFAULT_ALLOCATOR
///
#ifndef EASTL_VECTOR_MULTISET_DEFAULT_ALLOCATOR
  #define EASTL_VECTOR_MULTISET_DEFAULT_ALLOCATOR \
    allocator_type(EASTL_VECTOR_MULTISET_DEFAULT_NAME)
#endif
...
class vector_multiset : public RandomAccessContainer {
 public:
  ...
  typedef vector_multiset<Key, Compare, Allocator, RandomAccessContainer>
    this_type;
  ...
  typedef typename base_type::iterator
    iterator; // **Currently typedefing from iterator instead of const_iterator due to const issues **: Note that we typedef from const_iterator. This is by design, as sets are sorted and values cannot be modified. To consider: allow values to be modified and thus risk changing their sort values.
  typedef typename base_type::const_iterator const_iterator;
  typedef typename base_type::reverse_iterator
    reverse_iterator; // See notes directly above regarding const_iterator.
 ...
 protected:
  value_compare
    mCompare; // To consider: Declare this instead as: 'key_compare mKeyCompare'
 ...
 public:
  ...
  explicit vector_multiset(
    const key_compare& comp,
    const allocator_type& allocator = EASTL_VECTOR_MULTISET_DEFAULT_ALLOCATOR);
  ...
  vector_multiset(
    ...
    const key_compare&
      compare); // allocator arg removed because VC7.1 fails on the default arg. To do: Make a second version of this function without a default arg.
  ...
  iterator insert(
    const value_type&
      value); // The signature of this function was change in EASTL v2.05.00 from (the mistaken) pair<iterator, bool> to (the correct) iterator.
  ...
  eastl::pair<const_iterator, const_iterator> equal_range_small(
    const key_type& k) const;
...
template <typename K, typename C, typename A, typename RAC>
inline vector_multiset<K, C, A, RAC>::vector_multiset(
  const key_compare& comp, const allocator_type& allocator)
    : base_type(allocator)
    , mCompare(comp)
{
  // Empty
...
template <typename K, typename C, typename A, typename RAC>
template <typename InputIterator>
inline vector_multiset<K, C, A, RAC>::vector_multiset(InputIterator first,
                                                      InputIterator last)
    : base_type(EASTL_VECTOR_MULTISET_DEFAULT_ALLOCATOR)
...
template <typename InputIterator>
inline vector_multiset<K, C, A, RAC>::vector_multiset(
  InputIterator first, InputIterator last, const key_compare& compare)
    : base_type(EASTL_VECTOR_MULTISET_DEFAULT_ALLOCATOR)
    , mCompare(compare)
{
  insert(first, last);
...
template <typename K, typename C, typename A, typename RAC>
inline vector_multiset<K, C, A, RAC>& vector_multiset<K, C, A, RAC>::operator=(
  const this_type& x)
{
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::key_compare& vector_multiset<
  K, C, A, RAC>::key_comp()
{
  return mCompare;
}
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::value_compare& vector_multiset<
  K, C, A, RAC>::value_comp()
{
  return mCompare;
}
...
template <typename K, typename C, typename A, typename RAC>
template <class... Args>
typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::emplace(Args&&... args)
{
...
template <class... Args>
typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::emplace_hint(const_iterator position, Args&&... args)
{
#if EASTL_USE_FORWARD_WORKAROUND
  auto value = value_type(eastl::forward<Args>(
    args)...); // Workaround for compiler bug in VS2013 which results in a compiler internal crash while compiling this code.
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::insert(const value_type& value)
{
...
template <typename K, typename C, typename A, typename RAC>
inline void vector_multiset<K, C, A, RAC>::insert(
  std::initializer_list<value_type> ilist)
{
  insert(ilist.begin(), ilist.end());
}
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::insert(const_iterator position, const value_type& value)
{
  ...
  if ((position == end()) ||
      !mCompare(*position, value)) // If value is <= the element at position...
  {
    if ((position == begin()) ||
        !mCompare(value, *(position -
                           1))) // If value is >= the element before position...
...
template <typename K, typename C, typename A, typename RAC>
typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::insert(const_iterator position, value_type&& value)
{
  if ((position == end()) ||
      !mCompare(*position, value)) // If value is <= the element at position...
  {
...
template <typename K, typename C, typename A, typename RAC>
template <typename InputIterator>
inline void vector_multiset<K, C, A, RAC>::insert(InputIterator first,
                                                  InputIterator last)
{
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::erase(const_iterator position)
{
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::erase(const_iterator first, const_iterator last)
{
  return base_type::erase(first, last);
}

template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::reverse_iterator vector_multiset<
  K, C, A, RAC>::erase(const_reverse_iterator position)
{
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::reverse_iterator vector_multiset<
  K, C, A, RAC>::erase(const_reverse_iterator first,
                       const_reverse_iterator last)
{
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::size_type vector_multiset<
  K, C, A, RAC>::erase(const key_type& k)
{
  ...
  return (size_type)eastl::distance(
    pairIts.first, pairIts.second); // This can result in any value >= 0.
}

template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::find(const key_type& k)
{
  const eastl::pair<iterator, iterator> pairIts(equal_range(k));
...
template <typename U, typename BinaryPredicate>
inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::find_as(const U& u, BinaryPredicate predicate)
{
  const eastl::pair<iterator, iterator> pairIts(
    eastl::equal_range(begin(), end(), u, predicate));
  return (pairIts.first != pairIts.second) ? pairIts.first : end();
}

template <typename K, typename C, typename A, typename RAC>
template <typename U, typename BinaryPredicate>
inline typename vector_multiset<K, C, A, RAC>::const_iterator vector_multiset<
  K, C, A, RAC>::find_as(const U& u, BinaryPredicate predicate) const
{
  const eastl::pair<const_iterator, const_iterator> pairIts(
    eastl::equal_range(begin(), end(), u, predicate));
  return (pairIts.first != pairIts.second) ? pairIts.first : end();
}
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::const_iterator vector_multiset<
  K, C, A, RAC>::find(const key_type& k) const
{
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::size_type vector_multiset<
  K, C, A, RAC>::count(const key_type& k) const
{
  const eastl::pair<const_iterator, const_iterator> pairIts(equal_range(k));
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::lower_bound(const key_type& k)
{
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::const_iterator vector_multiset<
  K, C, A, RAC>::lower_bound(const key_type& k) const
{
  return eastl::lower_bound(begin(), end(), k, mCompare);
}
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::iterator vector_multiset<
  K, C, A, RAC>::upper_bound(const key_type& k)
{
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_multiset<K, C, A, RAC>::const_iterator vector_multiset<
  K, C, A, RAC>::upper_bound(const key_type& k) const
{
  return eastl::upper_bound(begin(), end(), k, mCompare);
}

template <typename K, typename C, typename A, typename RAC>
inline eastl::pair<typename vector_multiset<K, C, A, RAC>::iterator,
...
template <typename K, typename C, typename A, typename RAC>
inline eastl::pair<typename vector_multiset<K, C, A, RAC>::const_iterator,
                   typename vector_multiset<K, C, A, RAC>::const_iterator>
...
inline bool operator==(
  const vector_multiset<Key, Compare, Allocator, RandomAccessContainer>& a,
...
template <typename Key, typename Compare, typename Allocator,
          typename RandomAccessContainer>
inline void swap(
  vector_multiset<Key, Compare, Allocator, RandomAccessContainer>& a,
