...
nish_std_PixelOutput niUIGpuFuncs_fixed_tex_ps(nish_std_VertexOutput aInput, niUIGpuFuncs_FixedUniforms aUniforms, texture2D aTexture, sampler aSS);
...
void main(void) {
  ...
  nish_std_PixelOutput _rval_ = niUIGpuFuncs_fixed_tex_ps(aInput, aUniforms, IN_1_aTexture, IN_1_aSS);
