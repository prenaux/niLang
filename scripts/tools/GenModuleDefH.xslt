...
/**@}*/
  ...
  <xsl:template name="write_header">
    <xsl:text>#ifndef __MODULEDEF_</xsl:text><xsl:value-of select="/niIDL/@name"/><xsl:text>_H__</xsl:text>
    <xsl:call-template name="newline"/>
    <xsl:text>#define __MODULEDEF_</xsl:text><xsl:value-of select="/niIDL/@name"/><xsl:text>_H__</xsl:text>
    <xsl:call-template name="newline"/>
...
#include &lt;niLang/ObjModel.h&gt;
  ...
  <xsl:template name="write_footer">
    ...
    <xsl:call-template name="newline"/>
    <xsl:text>#endif /// __MODULEDEF_</xsl:text><xsl:value-of select="/niIDL/@name"/><xsl:text>_H__</xsl:text>
    <xsl:call-template name="newline"/>
  </xsl:template>
