...
///
  ...
  #define EASTL_VECTOR_SET_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX           \
      " vector_set" // Unless the user overrides something, this is "EASTL vector_set".
#endif

/// EASTL_VECTOR_SET_DEFAULT_ALLOCATOR
///
#ifndef EASTL_VECTOR_SET_DEFAULT_ALLOCATOR
  #define EASTL_VECTOR_SET_DEFAULT_ALLOCATOR \
    allocator_type(EASTL_VECTOR_SET_DEFAULT_NAME)
#endif
...
class vector_set : public RandomAccessContainer {
 ...
 public:
  ...
  explicit vector_set(
    ...
    const allocator_type& allocator = EASTL_VECTOR_SET_DEFAULT_ALLOCATOR);
...
template <typename K, typename C, typename A, typename RAC>
inline vector_set<K, C, A, RAC>::vector_set(const key_compare& compare,
...
template <typename K, typename C, typename A, typename RAC>
template <typename InputIterator>
inline vector_set<K, C, A, RAC>::vector_set(InputIterator first,
                                            InputIterator last)
...
template <typename K, typename C, typename A, typename RAC>
inline vector_set<K, C, A, RAC>& vector_set<K, C, A, RAC>::operator=(
  const this_type& x)
{
...
template <typename K, typename C, typename A, typename RAC>
inline const typename vector_set<K, C, A, RAC>::key_compare& vector_set<
  K, C, A, RAC>::key_comp() const
{
  return mCompare;
}

template <typename K, typename C, typename A, typename RAC>
inline typename vector_set<K, C, A, RAC>::key_compare& vector_set<
  K, C, A, RAC>::key_comp()
{
  return mCompare;
}
...
template <typename K, typename C, typename A, typename RAC>
inline const typename vector_set<K, C, A, RAC>::value_compare& vector_set<
  K, C, A, RAC>::value_comp() const
{
  return mCompare;
}

template <typename K, typename C, typename A, typename RAC>
inline typename vector_set<K, C, A, RAC>::value_compare& vector_set<
...
template <typename K, typename C, typename A, typename RAC>
template <class... Args>
inline typename vector_set<K, C, A, RAC>::iterator vector_set<
...
template <typename K, typename C, typename A, typename RAC>
inline void vector_set<K, C, A, RAC>::insert(
  std::initializer_list<value_type> ilist)
{
  insert(ilist.begin(), ilist.end());
}
...
template <typename K, typename C, typename A, typename RAC>
template <typename InputIterator>
inline void vector_set<K, C, A, RAC>::insert(InputIterator first,
                                             InputIterator last)
{
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_set<K, C, A, RAC>::size_type vector_set<
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_set<K, C, A, RAC>::reverse_iterator vector_set<
...
template <typename K, typename C, typename A, typename RAC>
inline typename vector_set<K, C, A, RAC>::const_iterator vector_set<
...
template <typename K, typename C, typename A, typename RAC>
inline eastl::pair<typename vector_set<K, C, A, RAC>::iterator,
                   typename vector_set<K, C, A, RAC>::iterator>
...
template <typename K, typename C, typename A, typename RAC>
inline eastl::pair<typename vector_set<K, C, A, RAC>::const_iterator,
                   typename vector_set<K, C, A, RAC>::const_iterator>
...
vector_set<K, C, A, RAC>::equal_range(const U& u, BinaryPredicate predicate)
{
  ...
  if ((itLower == end()) ||
      predicate(u, *itLower)) // If at the end or if (k is < itLower)...
    return eastl::pair<iterator, iterator>(itLower, itLower);
...
inline eastl::pair<typename vector_set<K, C, A, RAC>::const_iterator,
                   typename vector_set<K, C, A, RAC>::const_iterator>
vector_set<K, C, A, RAC>::equal_range(const U& u,
                                      BinaryPredicate predicate) const
{
  ...
  const const_iterator itLower(
    eastl::lower_bound(begin(), end(), u, predicate));
...
inline bool operator==(
  const vector_set<Key, Compare, Allocator, RandomAccessContainer>& a,
