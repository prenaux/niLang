...
AGG_INLINE int iround(agg_real v)
{
  return int(v);
}
AGG_INLINE int uround(agg_real v)
{
  return unsigned(v);
}
AGG_INLINE unsigned ufloor(agg_real v)
{
  return unsigned(floor(v));
}
AGG_INLINE unsigned uceil(agg_real v)
{
  return unsigned(ceil(v));
}
#else
...
//-----------------------------------------------------------------------pi
const agg_real pi = 3.14159265358979323846;

//------------------------------------------------------------------deg2rad
inline agg_real deg2rad(agg_real deg)
{
  return deg * pi / 180.0;
}

//------------------------------------------------------------------rad2deg
inline agg_real rad2deg(agg_real rad)
{
  return rad * 180.0 / pi;
}
