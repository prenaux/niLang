                      ...
                      gpc_polygon *result)
{
  ...
  edge_node     *edge = NULL, *prev_edge = NULL, *next_edge = NULL, *succ_edge = NULL, *e0 = NULL, *e1 = NULL;
  edge_node     *aet= NULL, *c_heap= NULL, *s_heap= NULL;
  lmt_node      *lmt= NULL, *local_min;
  polygon_node  *out_poly= NULL, *p = NULL, *q = NULL, *poly = NULL, *npoly = NULL, *cf= NULL;
                       ...
                       gpc_tristrip *result)
{
  ...
  int            vclass = 0, bl = 0, br = 0, tl = 0, tr = 0;
  GPC_REAL        *sbt= NULL, xb = 0, px = 0, nx = 0, yb = 0, yt = 0, dy = 0, ix = 0, iy = 0;
