...
template <typename T, typename TF, typename BASE = ni::cUnknown,
...
struct sDampedSpring : public BASE {
  ...
  void __stdcall UpdateVelocityWithAcceleration(ni::tF32 afDeltaTime,
                                                TREF avAcc)
  {
    TF time = afDeltaTime;
    while (time > kfDampedSpringUpdateDefaultTimeStep) {
...
typedef sDampedSpring<tF32, tF32, ImplRC<iDampedSpring1>, tF32>
  sDampedSpring1fImpl;
//! 2D spring.
...
template <typename T, typename TF>
void DampedSpringIntegrateFrameEuler(T& aP, T& aV, const T& I, const TF Ks,
                                     const TF Kd, const TF dT)
{
...
template <typename T>
inline tF32 _DampedSpringDistance(const T& a, const T& b)
{
  niCAssert(-1);
  return -1; /*error*/
}
...
//! 1D spring position.
typedef sDampedSpringPosition<tF32, tF32, cUnknown, tF32>
...
typedef sDampedSpringPosition<
  tF32, tF32,
  ImplRC<iDampedSpringPosition1, eImplFlags_DontInherit1, iDampedSpring1>, tF32>
...
typedef sDampedSpringPosition<
  sVec2f, tF32,
  ImplRC<iDampedSpringPosition2, eImplFlags_DontInherit1, iDampedSpring2>>
...
typedef sDampedSpringPosition<
  sVec3f, tF32,
  ImplRC<iDampedSpringPosition3, eImplFlags_DontInherit1, iDampedSpring3>>
...
typedef sDampedSpringPosition<
  sVec4f, tF32,
  ImplRC<iDampedSpringPosition4, eImplFlags_DontInherit1, iDampedSpring4>>
