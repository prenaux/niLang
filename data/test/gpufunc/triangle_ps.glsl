...
TestGpuFuncs_PixelOutput TestGpuFuncs_VertexOutput_triangle_ps(TestGpuFuncs_VertexOutput aInput);
...
// Pixel Shader main: TestGpuFuncs_VertexOutput_triangle_ps
...
void main(void) {
  ...
  TestGpuFuncs_PixelOutput _rval_ = TestGpuFuncs_VertexOutput_triangle_ps(aInput);
