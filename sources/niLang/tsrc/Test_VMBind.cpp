...
DECLARE_VMBIND_PARAM_ENUM_TRAITS(ni::eFileOpenMode, eType_Enum,
                                 "eFileOpenMode");
...
niExportFunc(const ni::sInterfaceDef*) ManualInterfaceDef_iFileSystem()
{
  ...
  static const ni::sMethodDef iFileSystem_GetRightsFlags = {
    "GetRightsFlags",
    ni::eTypeFlags_MethodGetter | 0 | ni::eType_Enum,
    NULL,
    "tFileSystemRightsFlags",
    0,
    NULL,
    NULL
  };
  ...
  static const ni::sMethodDef iFileSystem_GetBaseContainer = {
    "GetBaseContainer",
    ni::eTypeFlags_MethodGetter | 0 | ni::eTypeFlags_Constant |
      ni::eType_AChar | ni::eTypeFlags_Pointer,
    NULL,
    "const achar*",
    0,
    NULL,
  ...
  static const ni::sParameterDef iFileSystem_FileMakeDir_Parameters[1] = {
    { "aszDir",
      ni::eTypeFlags_Constant | ni::eType_AChar | ni::eTypeFlags_Pointer, NULL,
      "const achar*" }
  };
  static const ni::sMethodDef iFileSystem_FileMakeDir = {
    ...
    "tBool",
    1,
    iFileSystem_FileMakeDir_Parameters,
    NULL
  };
  ...
  static const ni::sMethodDef iFileSystem_FileDeleteDir = {
    ...
    "tBool",
    1,
    iFileSystem_FileDeleteDir_Parameters,
    NULL
  };
  ...
  static const ni::sMethodDef iFileSystem_FileDelete = {
    ...
    "tBool",
    1,
    iFileSystem_FileDelete_Parameters,
    NULL
  };
  ...
  static const ni::sParameterDef iFileSystem_FileEnum_Parameters[3] = {
    ...
    { "pSink", ni::eType_IUnknown | ni::eTypeFlags_Pointer,
      &niGetInterfaceUUID(iFileEnumSink), "iFileEnumSink*" }
  };
  static const ni::sMethodDef iFileSystem_FileEnum = {
    "FileEnum", 0 | ni::eType_U32,
    NULL,       "tU32",
  ...
  static const ni::sMethodDef iFileSystem_FileExists = {
    ...
    "tU32",
    2,
    iFileSystem_FileExists_Parameters,
    NULL
  };
  ...
  static const ni::sMethodDef iFileSystem_FileOpen = {
    "FileOpen",
    0 | ni::eType_IUnknown | ni::eTypeFlags_Pointer,
    &niGetInterfaceUUID(iFile),
    "iFile*",
    2,
    iFileSystem_FileOpen_Parameters,
    NULL
  };
  ...
  static const ni::sMethodDef iFileSystem_FileBaseOpen = {
    ...
    "iFileBase*",
    2,
    iFileSystem_FileBaseOpen_Parameters,
    NULL
  };
  ...
  static const ni::sMethodDef iFileSystem_GetAbsolutePath = {
    ...
    "cString",
    1,
    iFileSystem_GetAbsolutePath_Parameters,
    NULL
  };
  ...
  static const ni::sMethodDef* Methods_iFileSystem[] = {
    &iFileSystem_GetRightsFlags,  &iFileSystem_GetBaseContainer,
    &iFileSystem_FileMakeDir,     &iFileSystem_FileDeleteDir,
    &iFileSystem_FileCopy,        &iFileSystem_FileMove,
    &iFileSystem_FileDelete,      &iFileSystem_FileEnum,
    &iFileSystem_FileExists,      &iFileSystem_FileSize,
    &iFileSystem_FileOpen,        &iFileSystem_FileBaseOpen,
    &iFileSystem_GetAbsolutePath, &iFileSystem_CreateEnumerator,
...
niExportFunc(const ni::sInterfaceDef*) TestInterfaceDef_iFileSystem()
{
  static const sInterfaceDef& InterfaceDef_iFileSystem =
    vmbind::interface_def<iFileSystem>()
      .parent<ni::iUnknown>()
      .method<&iFileSystem::GetRightsFlags>("GetRightsFlags",
                                            eTypeFlags_MethodGetter)
      .method<&iFileSystem::GetBaseContainer>("GetBaseContainer",
                                              eTypeFlags_MethodGetter)
...
static const ni::sEnumDef* ManualGetEnumDef_eFileOpenMode()
{
  ...
  static const ni::sEnumDef Enum_eFileOpenMode = {
    "eFileOpenMode", niCountOf(Enum_eFileOpenMode_Values),
    Enum_eFileOpenMode_Values
  };
...
TEST_FIXTURE(FVMBind, InterfaceDef)
{
  ...
  niLoop (i, ni::Min(midef->mnNumMethods, tidef->mnNumMethods)) {
    ...
    niDebugFmt(("... tmeth->mReturnType: %d:%s, %s", tmeth->mReturnType,
                ni::GetTypeString(tmeth->mReturnType), tmeth->mReturnTypeName));
    niDebugFmt(("... mmeth->mReturnType: %d:%s, %s", mmeth->mReturnType,
                ni::GetTypeString(mmeth->mReturnType), mmeth->mReturnTypeName));
...
TEST_FIXTURE(FVMBind, EnumDef)
{
  ...
  ni::eFileOpenMode mmode =
    (ni::eFileOpenMode)(ni::eFileOpenMode_Read | ni::eFileOpenMode_Write);
  ...
  _xmacro_enums::eXFileOpenMode omode = (_xmacro_enums::eXFileOpenMode)(
    _xmacro_enums::eXFileOpenMode_Read | _xmacro_enums::eXFileOpenMode_Write);
  CHECK_EQUAL((tU32)mmode, (tU32)tmode);
  CHECK_EQUAL((tU32)mmode, (tU32)omode);

  niLoop (i, ni::Min(medef->mnNumValues, tedef->mnNumValues)) {
    niDebugFmt(("... medef[%d]: %s = %d", i, medef->mpValues[i].maszName,
                medef->mpValues[i].mnValue));
    niDebugFmt(("... tedef[%d]: %s = %d", i, tedef->mpValues[i].maszName,
                tedef->mpValues[i].mnValue));
    ...
    niDebugFmt(("... oedef[%d]: %s = %d", i, oedef->mpValues[i].maszName,
                oedef->mpValues[i].mnValue));
