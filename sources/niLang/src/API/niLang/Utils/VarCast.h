...
#define DO_VAR_CAST(TYPE, TYPEB) DO_VAR_CAST_(TYPE, TYPEB, (t##TYPEB))
  ...
  {
    DO_VAR_CAST(Float, F32);
  }
  operator ni::tF64() const
  {
    DO_VAR_CAST(Float, F64);
  }
  operator ni::sVec2f() const
  {
    DO_VAR_CAST_(Vec2f, Vec2f, );
  }
  operator ni::sVec2i() const
  {
    DO_VAR_CAST_(Vec2i, Vec2i, );
  }
  operator ni::sVec3f() const
  {
    DO_VAR_CAST_(Vec3f, Vec3f, );
  }
  operator ni::sVec3i() const
  {
    DO_VAR_CAST_(Vec3i, Vec3i, );
  }
  operator ni::sVec4f() const
  {
    DO_VAR_CAST_(Vec4f, Vec4f, );
  }
  operator ni::sVec4i() const
  {
    DO_VAR_CAST_(Vec4i, Vec4i, );
  }
