...
#if defined( \
  EA_HAVE_CPP11_INITIALIZER_LIST) // If the compiler can generate calls to std::initializer_list...
...
class initializer_list {
 public:
  ...
  typedef const E*
    iterator; // Must be const, as initializer_list (and its mpArray) is an immutable temp object.
