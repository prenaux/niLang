...
class cQNXWindow : public ni::ImplRC<ni::iOSWindow, ni::eImplFlags_Default,
                                     ni::iOSWindowQNX> {
 ...
 public:
  cQNXWindow(sVec2i aSize)
  {
    ...
    screen_set_window_property_iv(screen_win, SCREEN_PROPERTY_SWAP_INTERVAL,
                                  &interval);
    ...
    eglsurface = eglCreateWindowSurface(egldisplay, eglconfig, screen_win,
                                        eglSurfaceAttrs);
