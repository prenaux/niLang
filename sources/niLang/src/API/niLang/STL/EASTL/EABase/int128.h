...
struct EA_INT128_ALIGNAS int128_t_base {
  ...
  int128_t_base(uint32_t nPart0, uint32_t nPart1, uint32_t nPart2,
                uint32_t nPart3);
  ...
  // Math operators
  static void OperatorPlus(const int128_t_base& value1,
                           const int128_t_base& value2, int128_t_base& result);
  static void OperatorMinus(const int128_t_base& value1,
                            const int128_t_base& value2, int128_t_base& result);
  static void OperatorMul(const int128_t_base& value1,
                          const int128_t_base& value2, int128_t_base& result);

  // Shift operators
  static void OperatorShiftRight(const int128_t_base& value, int nShift,
                                 int128_t_base& result);
  static void OperatorShiftLeft(const int128_t_base& value, int nShift,
                                int128_t_base& result);
  ...
  // Logical operators
  static void OperatorXOR(const int128_t_base& value1,
                          const int128_t_base& value2, int128_t_base& result);
  static void OperatorOR(const int128_t_base& value1,
                         const int128_t_base& value2, int128_t_base& result);
  static void OperatorAND(const int128_t_base& value1,
                          const int128_t_base& value2, int128_t_base& result);
...
struct int128_t : public int128_t_base {
 ...
 protected:
  ...
  void Negate();
  void Modulus(const int128_t& divisor, int128_t& quotient,
               int128_t& remainder) const;
...
struct uint128_t : public int128_t_base {
 ...
 protected:
  ...
  void Negate();
  void Modulus(const uint128_t& divisor, uint128_t& quotient,
               uint128_t& remainder) const;
  bool IsNegative() const; // Returns true for value <  0
  bool IsPositive() const; // Returns true for value >= 0
};
...
inline int128_t_base::int128_t_base(uint32_t nPart0, uint32_t nPart1,
                                    uint32_t nPart2, uint32_t nPart3)
{
...
//
inline void int128_t_base::OperatorPlus(const int128_t_base& value1,
                                        const int128_t_base& value2,
                                        int128_t_base& result)
{
...
// To consider: Fix 'defect' of this function whereby it doesn't implement overflow wraparound.
//
inline void int128_t_base::OperatorMinus(const int128_t_base& value1,
                                         const int128_t_base& value2,
                                         int128_t_base& result)
{
  uint64_t t = (value1.mPart0 - value2.mPart0);
...
//     -------------------------------------------------------------------------
//
inline void int128_t_base::OperatorMul(const int128_t_base& a,
                                       const int128_t_base& b,
                                       int128_t_base& result)
{
  ...
  int128_t v11 =
    ((a.mPart0 >> 32) & 0xffffffff) * ((b.mPart0 >> 32) & 0xffffffff);
...
//
inline void int128_t_base::OperatorShiftRight(const int128_t_base& value,
                                              int nShift, int128_t_base& result)
{
  if (nShift >= 0) {
    if (nShift < 64) { // 0 - 63
      ...
      if (nShift == 0)
        ...
        result.mPart0 =
          (value.mPart0 >> nShift) | (value.mPart1 << (64 - nShift));
    }
    else { // 64+
      result.mPart1 = 0;
...
// With rightward shifts of negative numbers, shift in zero from the left side.
//
inline void int128_t_base::OperatorShiftLeft(const int128_t_base& value,
                                             int nShift, int128_t_base& result)
{
  if (nShift >= 0) {
    if (nShift < 64) {
      if (
        nShift) // We need to have a special case because CPUs convert a shift by 64 to a no-op.
      {
        // 1 - 63
        result.mPart0 = (value.mPart0 << nShift);
        result.mPart1 =
          (value.mPart1 << nShift) | (value.mPart0 >> (64 - nShift));
      }
      else {
...
//
inline void int128_t_base::OperatorXOR(const int128_t_base& value1,
                                       const int128_t_base& value2,
                                       int128_t_base& result)
{
...
// The output 'result' may be the same as one the input.
//
inline void int128_t_base::OperatorOR(const int128_t_base& value1,
                                      const int128_t_base& value2,
                                      int128_t_base& result)
{
  result.mPart0 = (value1.mPart0 | value2.mPart0);
...
// The output 'result' may be the same as one the input.
//
inline void int128_t_base::OperatorAND(const int128_t_base& value1,
                                       const int128_t_base& value2,
                                       int128_t_base& result)
{
  result.mPart0 = (value1.mPart0 & value2.mPart0);
...
{
  return (mPart0 ==
          0) && // Check mPart0 first as this will likely yield faster execution.
         (mPart1 == 0);
}
...
inline void uint128_t::Modulus(const uint128_t& divisor, uint128_t& quotient,
                               uint128_t& remainder) const
{
...
inline bool uint128_t::operator==(const uint128_t& other) const
{
  return (mPart0 ==
          other
            .mPart0) && // Check mPart0 first as this will likely yield faster execution.
         (mPart1 == other.mPart1);
}
...
EA_DISABLE_VC_WARNING(4723) // warning C4723: potential divide by 0
inline void int128_t::Modulus(const int128_t& divisor, int128_t& quotient,
                              int128_t& remainder) const
{
