...
template <typename RandomAccessIterator, typename Distance, typename T,
          typename ValueType>
inline void promote_heap_impl(RandomAccessIterator first, Distance topPosition,
                              Distance position, T value)
{
  for (
  ...
  {
    *(first + position) = eastl::forward<ValueType>(
...
///
template <typename RandomAccessIterator, typename Distance, typename T>
inline void promote_heap(RandomAccessIterator first, Distance topPosition,
                         Distance position, const T& value)
{
                         ...
                         Distance position, T&& value)
{
  ...
  promote_heap_impl<RandomAccessIterator, Distance, T&&, value_type>(
    first, topPosition, position, eastl::forward<T>(value));
}

template <typename RandomAccessIterator, typename Distance, typename T,
          typename Compare, typename ValueType>
inline void promote_heap_impl(RandomAccessIterator first, Distance topPosition,
...
template <typename RandomAccessIterator, typename Distance, typename T,
          typename Compare>
inline void promote_heap(RandomAccessIterator first, Distance topPosition,
                         Distance position, const T& value, Compare compare)
{
  typedef typename iterator_traits<RandomAccessIterator>::value_type value_type;
  promote_heap_impl<RandomAccessIterator, Distance, const T&, Compare,
                    const value_type>(first, topPosition, position, value,
                                      compare);
}
                         ...
                         Distance position, T&& value, Compare compare)
{
  ...
  promote_heap_impl<RandomAccessIterator, Distance, T&&, Compare, value_type>(
    first, topPosition, position, eastl::forward<T>(value), compare);
}
...
template <typename RandomAccessIterator, typename Distance, typename T,
          typename ValueType>
void adjust_heap_impl(RandomAccessIterator first, Distance topPosition,
                      Distance heapSize, Distance position, T value)
{
  ...
  for (; childPosition < heapSize; childPosition = (2 * childPosition) + 2) {
    if (*(first + childPosition) <
        *(first +
          (childPosition - 1))) // Choose the larger of the two children.
      --childPosition;
    *(first + position) = eastl::forward<ValueType>(
  ...
  if (childPosition ==
      heapSize) // If we are at the very last index of the bottom...
  {
    *(first + position) =
      eastl::forward<ValueType>(*(first + (childPosition - 1)));
    position = childPosition - 1;
  }

  eastl::promote_heap<RandomAccessIterator, Distance, T>(
    first, topPosition, position, eastl::forward<ValueType>(value));
}
...
///
template <typename RandomAccessIterator, typename Distance, typename T>
void adjust_heap(RandomAccessIterator first, Distance topPosition,
                 Distance heapSize, Distance position, const T& value)
{
  typedef typename iterator_traits<RandomAccessIterator>::value_type value_type;
  adjust_heap_impl<RandomAccessIterator, Distance, const T&, const value_type>(
    first, topPosition, heapSize, position, eastl::forward<const T&>(value));
}
                 ...
                 Distance heapSize, Distance position, T&& value)
{
  ...
  adjust_heap_impl<RandomAccessIterator, Distance, T&&, value_type>(
    first, topPosition, heapSize, position, eastl::forward<T>(value));
}
                      ...
                      Compare compare)
{
  ...
  for (; childPosition < heapSize; childPosition = (2 * childPosition) + 2) {
    if (compare(*(first + childPosition),
                *(first + (childPosition -
                           1)))) // Choose the larger of the two children.
      --childPosition;
    *(first + position) = eastl::forward<ValueType>(
      *(first + childPosition)); // Swap positions with this child.
    position = childPosition;
  ...
  eastl::promote_heap<RandomAccessIterator, Distance, T, Compare>(
    first, topPosition, position, eastl::forward<ValueType>(value), compare);
}
...
{
  typedef typename iterator_traits<RandomAccessIterator>::value_type value_type;
  adjust_heap_impl<RandomAccessIterator, Distance, const T&, Compare,
                   const value_type>(first, topPosition, heapSize, position,
                                     eastl::forward<const T&>(value), compare);
}
                 ...
                 Compare compare)
{
  ...
  adjust_heap_impl<RandomAccessIterator, Distance, T&&, Compare, value_type>(
    first, topPosition, heapSize, position, eastl::forward<T>(value), compare);
}
                      ...
                      Compare compare)
{
  ...
  eastl::promote_heap<RandomAccessIterator, difference_type, value_type,
                      Compare>(first, (difference_type)0,
                               (difference_type)(last - first - 1), tempBottom,
                               compare);
}
...
inline void pop_heap(RandomAccessIterator first, RandomAccessIterator last)
{
  ...
  *(last - 1) = eastl::forward<value_type>(*first);
  eastl::adjust_heap<RandomAccessIterator, difference_type, value_type>(
    ...
    eastl::forward<value_type>(tempBottom));
}
                     ...
                     Compare compare)
{
  ...
  *(last - 1) = eastl::forward<value_type>(*first);
  eastl::adjust_heap<RandomAccessIterator, difference_type, value_type,
                     Compare>(first, (difference_type)0,
                              (difference_type)(last - first - 1), 0,
                              eastl::forward<value_type>(tempBottom), compare);
}
...
void make_heap(RandomAccessIterator first, RandomAccessIterator last)
{
    ...
    2) // If there is anything to do... (we need this check because otherwise the math fails below).
  {
    ...
    do {
      ...
      eastl::adjust_heap<RandomAccessIterator, difference_type, value_type>(
        first, parentPosition, heapSize, parentPosition,
        eastl::forward<value_type>(temp));
               ...
               Compare compare)
{
    ...
    2) // If there is anything to do... (we need this check because otherwise the math fails below).
  {
    ...
    do {
      ...
      value_type temp(eastl::forward<value_type>(*(first + parentPosition)));
      eastl::adjust_heap<RandomAccessIterator, difference_type, value_type,
                         Compare>(first, parentPosition, heapSize,
                                  parentPosition,
                                  eastl::forward<value_type>(temp), compare);
    } while (parentPosition != 0);
  }
}
...
inline void remove_heap(RandomAccessIterator first, Distance heapSize,
                        Distance position)
{
  typedef typename eastl::iterator_traits<RandomAccessIterator>::difference_type
    difference_type;
  ...
  *(first + heapSize - 1) = *(first + position);
  eastl::adjust_heap<RandomAccessIterator, difference_type, value_type>(
    first, (difference_type)0, (difference_type)(heapSize - 1),
    (difference_type)position, tempBottom);
}
...
inline void remove_heap(RandomAccessIterator first, Distance heapSize,
                        Distance position, Compare compare)
{
  typedef typename eastl::iterator_traits<RandomAccessIterator>::difference_type
    difference_type;
  typedef typename eastl::iterator_traits<RandomAccessIterator>::value_type
  ...
  *(first + heapSize - 1) = *(first + position);
  eastl::adjust_heap<RandomAccessIterator, difference_type, value_type,
                     Compare>(first, (difference_type)0,
                              ...
                              (difference_type)position, tempBottom, compare);
}
...
///
template <typename RandomAccessIterator, typename Distance>
inline void change_heap(RandomAccessIterator first, Distance heapSize,
                        Distance position)
{
  typedef typename eastl::iterator_traits<RandomAccessIterator>::difference_type
    difference_type;
                        ...
                        Distance position, Compare compare)
{
  ...
  eastl::remove_heap<RandomAccessIterator, Distance, Compare>(
  ...
  eastl::promote_heap<RandomAccessIterator, difference_type, value_type,
                      Compare>(first, (difference_type)0,
                               (difference_type)(heapSize - 1), tempBottom,
                               compare);
}
...
///
template <typename RandomAccessIterator>
inline RandomAccessIterator is_heap_until(RandomAccessIterator first,
                                          RandomAccessIterator last)
{
  int counter = 0;

  for (RandomAccessIterator child = first + 1; child < last;
       ++child, counter ^= 1)
  {
    if (
      *first <
