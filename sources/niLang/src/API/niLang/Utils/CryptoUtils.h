...
{
  return (iCryptoHash*)niCreateInstance(niLang, CryptoHash, aHashType,
                                        niVarNull);
}
...
inline Ptr<iCryptoHash> HashString(iCryptoHash* apHash, const achar* aString,
