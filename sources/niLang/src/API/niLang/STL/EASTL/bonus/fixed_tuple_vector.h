...
///
  ...
  #define EASTL_FIXED_TUPLE_VECTOR_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX                   \
      " fixed_tuple_vector" // Unless the user overrides something, this is "EASTL fixed_vector".
#endif

/// EASTL_FIXED_TUPLE_VECTOR_DEFAULT_ALLOCATOR
///
#ifndef EASTL_FIXED_TUPLE_VECTOR_DEFAULT_ALLOCATOR
  #define EASTL_FIXED_TUPLE_VECTOR_DEFAULT_ALLOCATOR \
    overflow_allocator_type(EASTL_FIXED_TUPLE_VECTOR_DEFAULT_NAME)
#endif
...
class fixed_tuple_vector
    : public TupleVecInternal::TupleVecImpl<
        fixed_vector_allocator<
          TupleVecInternal::TupleRecurser<Ts...>::GetTotalAllocationSize(
            nodeCount, 0),
          1, TupleVecInternal::TupleRecurser<Ts...>::GetTotalAlignment(), 0,
          bEnableOverflow, EASTLAllocatorType>,
        make_index_sequence<sizeof...(Ts)>, Ts...> {
 public:
  typedef fixed_vector_allocator<
    TupleVecInternal::TupleRecurser<Ts...>::GetTotalAllocationSize(nodeCount,
                                                                   0),
    1, TupleVecInternal::TupleRecurser<Ts...>::GetTotalAlignment(), 0,
    bEnableOverflow, EASTLAllocatorType>
    fixed_allocator_type;
  typedef aligned_buffer<fixed_allocator_type::kNodesSize,
                         fixed_allocator_type::kNodeAlignment>
    aligned_buffer_type;
  ...
  typedef TupleVecInternal::TupleVecImpl<
    fixed_allocator_type, make_index_sequence<sizeof...(Ts)>, Ts...>
    base_type;
 ...
 public:
  fixed_tuple_vector()
      : base_type(fixed_allocator_type(mBuffer.buffer), mBuffer.buffer,
                  nodeCount, fixed_allocator_type::kNodeSize)
  {
  }

  fixed_tuple_vector(const overflow_allocator_type& allocator)
      : base_type(fixed_allocator_type(mBuffer.buffer, allocator),
                  mBuffer.buffer, nodeCount, fixed_allocator_type::kNodeSize)
  {
  }
                  ...
                  nodeCount, fixed_allocator_type::kNodeSize)
  {
    ...
    base_type::DoInitFromIterator(make_move_iterator(x.begin()),
  ...
  fixed_tuple_vector(move_iterator<MoveIterBase> begin,
  ...
  fixed_tuple_vector(Iterator begin, Iterator end,
                     const overflow_allocator_type& allocator =
                       EASTL_FIXED_TUPLE_VECTOR_DEFAULT_ALLOCATOR)
      : base_type(fixed_allocator_type(mBuffer.buffer, allocator),
                  mBuffer.buffer, nodeCount, fixed_allocator_type::kNodeSize)
  ...
  fixed_tuple_vector(size_type n, const overflow_allocator_type& allocator =
                                    EASTL_FIXED_TUPLE_VECTOR_DEFAULT_ALLOCATOR)
      : base_type(fixed_allocator_type(mBuffer.buffer, allocator),
                  mBuffer.buffer, nodeCount, fixed_allocator_type::kNodeSize)
  {
  ...
  fixed_tuple_vector(size_type n, typename base_type::const_reference_tuple tup,
                     const overflow_allocator_type& allocator =
                       EASTL_FIXED_TUPLE_VECTOR_DEFAULT_ALLOCATOR)
      : base_type(fixed_allocator_type(mBuffer.buffer, allocator),
                  mBuffer.buffer, nodeCount, fixed_allocator_type::kNodeSize)
  ...
  fixed_tuple_vector(const typename base_type::value_tuple* first,
  ...
  this_type& operator=(this_type&& other)
  {
    ...
    base_type::DoInitFromIterator(make_move_iterator(other.begin()),
  ...
  bool full() const
  {
    return (base_type::mNumElements >= nodeCount) ||
           ((void*)base_type::mpData != (void*)mBuffer.buffer);
  }
  ...
  {
    return ((void*)base_type::mpData != (void*)mBuffer.buffer);
  }
