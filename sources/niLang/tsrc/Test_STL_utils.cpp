...
{
  {
    ...
    static_assert(
      astl::is_same<decltype(it), astl::vector<tInt>::iterator>::value,
      "Unexpected type");
    CHECK_EQUAL(1, *it);
  }

  {
    ...
    static_assert(astl::is_same<decltype(it), astl::dangling_iterator>::value,
                  "Unexpected type");
...

  {
    ...
    auto it = astl::find(v, 1);
    static_assert(
      astl::is_same<decltype(it), astl::vector<tInt>::const_iterator>::value,
      "Unexpected type");
    CHECK_EQUAL(1, *it);
  }
...
{
  {
    ...
    static_assert(
      astl::is_same<decltype(it), astl::map<tInt, cString>::iterator>::value,
      "Unexpected type");
