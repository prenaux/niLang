...
struct SQFuncState {
  ...
  void AddInstruction(SQOpcode _op, int arg0 = 0, int arg1 = 0, int arg2 = 0,
                      int arg3 = 0, int ext = 0)
  {
    SQInstruction i(_op, arg0, arg1, arg2, arg3, ext);
    AddInstruction(i);
  }
  void AddInstruction(const SQInstruction& i);
  void SetIntructionParams(int pos, int arg0, int arg1, int arg2 = 0,
                           int arg3 = 0);
  void SetIntructionParam(int pos, int arg, int val);
  SQInstruction& GetInstruction(int pos)
  {
    return _instructions[pos];
  }
  void PopInstructions(int size)
  {
  ...
  int GetCurrentPos()
  {
    return (int)(_instructions.size() - 1);
  }
  ...
  int PushTarget()
  {
    return this->PushTargetAt(-1);
  }
  int PushTargetThis()
  {
    return this->PushTargetAt(0);
  };
  int PopTarget();
  int TopTarget();
  ...
  tI32CVec* __stdcall GetBreakTargets() const
  {
    return _breaktargets;
  }
  tI32CVec* __stdcall GetUnresolvedBreaks() const
  {
    return _unresolvedbreaks;
  }
  tI32CVec* __stdcall GetContinueTargets() const
  {
    return _continuetargets;
  }
  tI32CVec* __stdcall GetUnresolvedContinues() const
  {
    return _unresolvedcontinues;
  }
