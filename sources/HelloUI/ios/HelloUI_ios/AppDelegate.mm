  ...
  didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
  ...
  niUIView* view =
    [[niUIView alloc] initWithFrame:[[UIScreen mainScreen] bounds]
                            context:context];
  ...
  {
    viewController =
      [[[UIViewController alloc] initWithNibName:@"ViewController_iPhone"
                                          bundle:nil] autorelease];
  }
  else {
    viewController =
      [[[UIViewController alloc] initWithNibName:@"ViewController_iPad"
                                          bundle:nil] autorelease];
  }
