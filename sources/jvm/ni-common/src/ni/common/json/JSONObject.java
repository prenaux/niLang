 ...
 * <ul>
 * <li>When the requested type is a boolean, strings will be coerced using
 ...
 * <li>When the requested type is a long, other {@link Number} types will be
 * coerced using {@link Number#longValue() longValue}. Strings that can be
 * coerced using {@link Double#valueOf(String)} will be, and then cast to long.
 * This two-step conversion is lossy for very large values. For example, the
 * string "9223372036854775806" yields the long 9223372036854775807.
...
public class JSONObject {
    ...
    /**
     * Adds all of the elements in the specified object to this object.
     * 
     * @param o object containing elements to be added to this object
     * @return this object.
     * @throws JSONException
     */
    public JSONObject addAll(final JSONObject o) throws JSONException {
        for (final Map.Entry<String,Object> entry : o.nameValuePairs.entrySet()) {
    ...
    {
        final Object current = nameValuePairs.get(checkName(name));
        if (current == null) {
            return put(name, value);
        }
    ...
    public boolean isNull(final String name) {
        final Object value = nameValuePairs.get(name);
    ...
    public Object get(final String name) throws JSONException {
        final Object result = nameValuePairs.get(name);
        if (result == null) {
    ...
    void writeTo(final JSONStringer stringer) throws JSONException {
        stringer.object();
        for (final Map.Entry<String,Object> entry : nameValuePairs.entrySet()) {
