...
nish_std_PixelOutput TestGpuFuncs_raytracer_instindex_ps(nish_std_PixelInput aInput, TestGpuFuncs_RayUniforms aUniforms, accelerationStructureEXT aAS);
...
void main(void) {
  ...
  nish_std_PixelOutput _rval_ = TestGpuFuncs_raytracer_instindex_ps(aInput, aUniforms, IN_1_aAS);
