...
class cScriptObject : public ImplRC<iScriptObject> {
 ...
 public:
  ...
  inline tBool HoldRef() const
  {
    return mbHoldRef;
  }
  inline HSQOBJECT& GetSQObject()
  {
    return mObject;
  }

  inline tBool __stdcall Is(eScriptObjectType aType) const
  {
    return GetType() == aType;
  }
  inline tBool __stdcall IsUnknown() const
  {
    return Is(eScriptObjectType_Unknown);
  }
  inline tBool __stdcall IsFunction() const
  {
    return Is(eScriptObjectType_Function);
  }
  inline tBool __stdcall IsTable() const
  {
    return Is(eScriptObjectType_Table);
  }
  inline tBool __stdcall IsNull() const
  {
    return Is(eScriptObjectType_Null);
  }
  inline tBool __stdcall IsInt() const
  {
    return Is(eScriptObjectType_Int);
  }
  inline tBool __stdcall IsFloat() const
  {
    return Is(eScriptObjectType_Float);
  }
  inline tBool __stdcall IsString() const
  {
    return Is(eScriptObjectType_String);
  }
  inline tBool __stdcall IsUserData() const
  {
    return Is(eScriptObjectType_UserData);
  }
  inline tBool __stdcall IsVM() const
  {
    return Is(eScriptObjectType_VM);
  }
  inline tBool __stdcall IsIUnknown() const
  {
    return Is(eScriptObjectType_IUnknown);
  }
  inline tBool __stdcall IsVec2() const
  {
    return Is(eScriptObjectType_Vec2);
  }
  inline tBool __stdcall IsVec3() const
  {
    return Is(eScriptObjectType_Vec3);
  }
  inline tBool __stdcall IsVec4() const
  {
    return Is(eScriptObjectType_Vec4);
  }
  inline tBool __stdcall IsMatrix() const
  {
    return Is(eScriptObjectType_Matrix);
  }
  inline tBool __stdcall IsUUID() const
  {
    return Is(eScriptObjectType_UUID);
  }
