...
enum eWidgetFormStyle {
  ...
  eWidgetFormStyle_ResizeAnyCorner = eWidgetFormStyle_ResizeTopLeftCorner |
  ...
  eWidgetFormStyle_ResizeAnyEdge =
    eWidgetFormStyle_ResizeLeftEdge | eWidgetFormStyle_ResizeRightEdge |
    eWidgetFormStyle_ResizeTopEdge | eWidgetFormStyle_ResizeBottomEdge,
  //! The form can be resized using any of the edges and corners.
  eWidgetFormStyle_ResizeAny =
    eWidgetFormStyle_ResizeAnyCorner | eWidgetFormStyle_ResizeAnyEdge,
  ...
  eWidgetFormStyle_Default =
    eWidgetFormStyle_Dock | eWidgetFormStyle_ResizeAny | eWidgetFormStyle_Move,
  //! Default form flags with close button.
  eWidgetFormStyle_DefaultButtons =
    eWidgetFormStyle_Dock | eWidgetFormStyle_ResizeAny | eWidgetFormStyle_Move |
    eWidgetFormStyle_CloseButton | eWidgetFormStyle_FormManagerButtons,
