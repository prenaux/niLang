...
nish_std_VertexOutput niUIGpuFuncs_fixed_pna_vs(nish_std_VertexPNA aInput, niUIGpuFuncs_FixedUniforms aUniforms);
...
void main(void) {
  ...
  nish_std_VertexOutput _rval_ = niUIGpuFuncs_fixed_pna_vs(aInput, aUniforms);
