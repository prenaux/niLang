...
struct CollectionTraitsVector : public astl::vector<typename BASE::tValueType>,
                                public BASE {
  enum {
    eKeyType = eType_Null,
    eValType = BASE::eType,
  ...
  {
    return static_cast<const tContainer*>(this)->at(anIndex);
  }
  tValType& operator[](tU32 anIndex)
  {
    return static_cast<tContainer*>(this)->at(anIndex);
  }
  ...
  tValType& front()
  {
    return static_cast<tContainer*>(this)->front();
  }
  const tValType& front() const
  {
    return static_cast<const tContainer*>(this)->front();
  }
  tValType& back()
  {
    return static_cast<tContainer*>(this)->back();
  }
  const tValType& back() const
  {
    return static_cast<const tContainer*>(this)->back();
  }

  static typename tContainer::iterator Find(const tContainer& aContainer,
                                            const tValType& aVal)
  {
  ...
  static tBool __stdcall Put(tContainer& aContainer, const Var& aKey,
                             const Var& aValue)
  {
...
struct CollectionTraitsMap
    : public astl::map<typename KEYT::tValueType, typename VALT::tValueType>,
      public KEYT {
  enum {
    eKeyType = KEYT::eType,
    eValType = VALT::eType,
  ...
  {
    return (*static_cast<tContainer*>(this))[aKey];
  }
  const tValType& operator[](const tKeyType& aKey) const
  {
    return (*static_cast<const tContainer*>(this))[aKey];
  }
  ...
  static tBool __stdcall CanPut(const Var& aKey, const Var& aValue)
  {
    if (!KEYT::IsValueType(aKey))
      return eFalse;
    if (!VALT::IsValueType(aValue))
      return eFalse;
    return eTrue;
  }
  static tBool __stdcall Put(tContainer& aContainer, const Var& aKey,
...
class cCollectionImpl : public TRAITS, public BASEIMPL {
 ...
 public:
  ...
  static tImmutable* __stdcall Remove(tImmutable* apColl, const Var& avVar,
                                      tBool* apDidContain = NULL)
  {
    ...
    typename tContainer::iterator it =
      TRAITS::Find(newColl.raw_ptr()->_Base(), v);
  ...
  static tImmutable* __stdcall Put(tImmutable* apColl, const Var& aKey,
                                   const Var& aVal)
  {
  ...
  {
    return niNew sIterator(niThis(tThisImmutable),
                           niThis(tThisImmutable)->_Base().begin());
  }
...
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsI8>>
  tI8CVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsU8>>
  tU8CVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsI16>>
  tI16CVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsU16>>
  tU16CVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsI32>>
  tI32CVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsU32>>
  tU32CVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsF32>>
  tF32CVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsF64>>
  tF64CVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsVec2i>>
  tVec2iCVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsVec2f>>
  tVec2fCVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsVec3i>>
  tVec3iCVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsVec3f>>
  tVec3fCVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsVec4i>>
  tVec4iCVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsVec4f>>
  tVec4fCVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsMatrixf>>
  tMatrixfCVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsIUnknown>>
  tIUnknownCVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsString>>
  tStringCVec;
typedef ni::cMutableCollectionImpl<
  ni::CollectionTraitsVector<ni::CollectionTraitsUUID>>
  tUUIDCVec;

//! Create a collection to store the specified type of elements
static inline ni::iMutableCollection* __stdcall CreateCollectionVector(
  tType aType)
{
  switch (niType(aType)) {
...
typedef ni::cMutableCollectionImpl<
  ...
  tI32U32CMap;
typedef ni::cMutableCollectionImpl<ni::CollectionTraitsMap<
  ni::CollectionTraitsI32, ni::CollectionTraitsIUnknown>>
  tI32IUnknownCMap;
typedef ni::cMutableCollectionImpl<
...
typedef ni::cMutableCollectionImpl<
  ...
  tU32CMap;
typedef ni::cMutableCollectionImpl<ni::CollectionTraitsMap<
  ni::CollectionTraitsU32, ni::CollectionTraitsIUnknown>>
  tU32IUnknownCMap;
typedef ni::cMutableCollectionImpl<
...
typedef ni::cMutableCollectionImpl<ni::CollectionTraitsMap<
  ni::CollectionTraitsIUnknown, ni::CollectionTraitsI32>>
  tIUnknownI32CMap;
typedef ni::cMutableCollectionImpl<ni::CollectionTraitsMap<
  ni::CollectionTraitsIUnknown, ni::CollectionTraitsU32>>
  tIUnknownU32CMap;
typedef ni::cMutableCollectionImpl<ni::CollectionTraitsMap<
  ni::CollectionTraitsIUnknown, ni::CollectionTraitsIUnknown>>
  tIUnknownCMap;
typedef ni::cMutableCollectionImpl<ni::CollectionTraitsMap<
  ni::CollectionTraitsIUnknown, ni::CollectionTraitsString>>
  tIUnknownStringCMap;
...
typedef ni::cMutableCollectionImpl<
  ...
  tStringU32CMap;
typedef ni::cMutableCollectionImpl<ni::CollectionTraitsMap<
  ni::CollectionTraitsString, ni::CollectionTraitsIUnknown>>
  tStringIUnknownCMap;
typedef ni::cMutableCollectionImpl<ni::CollectionTraitsMap<
  ni::CollectionTraitsString, ni::CollectionTraitsString>>
  tStringCMap;

//! Create a collection to store the specified type of elements
static inline ni::iMutableCollection* __stdcall CreateCollectionMap(
  tType aKeyType, tType aValType)
{
  ...
  case (eType_IUnknown | (eType_IUnknown << 16)):
    return tIUnknownCMap::Create();
  case (eType_IUnknown | (eType_String << 16)):
    return tIUnknownStringCMap::Create();
  case (eType_String | (eType_I32 << 16)): return tStringI32CMap::Create();
  case (eType_String | (eType_U32 << 16)): return tStringU32CMap::Create();
  case (eType_String | (eType_IUnknown << 16)):
    return tStringIUnknownCMap::Create();
...
struct tStringInterfaceCMap
    : public cMutableCollectionImpl<ni::CollectionTraitsMap<
        ni::CollectionTraitsString, ni::CollectionTraitsInterface<T>>> {
...
#define niLoopIterator(NAME, C)                                             \
  if (!niIsOK(C) || (C)->IsEmpty()) {                                       \
  }                                                                         \
  else                                                                      \
    for (ni::Nonnull<ni::iIterator> NAME{ C->Iterator() }; NAME->HasNext(); \
         NAME->Next())

#define niLoopImmutableIterator(TYPE, NAME, C)                         \
  if (!niIsOK(C) || ni::ptr_cast<TYPE*>(C)->empty()) {                 \
  }                                                                    \
  else                                                                 \
