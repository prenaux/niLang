 ...
 public:
  ...
  void generate(color_type* span, int x, int y, unsigned len)
  {
    ...
    do {
      ...
      const value_type* fg_ptr = (const value_type*)base_type::source().span(
        x >> image_subpixel_shift, y >> image_subpixel_shift, 1);
 ...
 public:
  ...
  void generate(color_type* span, int x, int y, unsigned len)
  {
    ...
    do {
      ...
      fg[0] = fg[1] = fg[2] = fg[3] =
        image_subpixel_scale * image_subpixel_scale / 2;
  ...
  void generate(color_type* span, int x, int y, unsigned len)
  {
    ...
    do {
      ...
      if (x_lr >= 0 && y_lr >= 0 && x_lr < maxx && y_lr < maxy) {
        ...
        fg_ptr =
          (const value_type*)base_type::source().row_ptr(y_lr) + (x_lr << 2);
        ...
        if (x_lr < -1 || y_lr < -1 || x_lr > maxx || y_lr > maxy) {
          ...
          weight =
            (image_subpixel_scale - x_hr) * (image_subpixel_scale - y_hr);
          if (x_lr >= 0 && y_lr >= 0 && x_lr <= maxx && y_lr <= maxy) {
...
class span_image_filter_rgba_2x2
 ...
 public:
  ...
  span_image_filter_rgba_2x2(source_type& src, interpolator_type& inter,
  ...
  void generate(color_type* span, int x, int y, unsigned len)
  {
    ...
    const int16* weight_array =
      ...
      ((base_type::filter().diameter() / 2 - 1) << image_subpixel_shift);
    ...
    do {
      ...
      fg_ptr = (const value_type*)base_type::source().next_x();
      weight =
        (weight_array[x_hr] * weight_array[y_hr] + image_filter_scale / 2) >>
        image_filter_shift;
      fg[0] += weight * *fg_ptr++;
      fg[1] += weight * *fg_ptr++;
      fg[2] += weight * *fg_ptr++;
...
class span_image_filter_rgba : public span_image_filter<Source, Interpolator> {
 public:
  ...
  span_image_filter_rgba(source_type& src, interpolator_type& inter,
                         const image_filter_lut& filter)
      : base_type(src, inter, &filter)
  {
  }
  ...
  void generate(color_type* span, int x, int y, unsigned len)
  {
    ...
    do {
      ...
      fg_ptr = (const value_type*)base_type::source().span(
        x_lr + start, y_lr + start, diameter);
      for (;;) {
        x_count = diameter;
        ...
        for (;;) {
          int weight =
            (weight_y * weight_array[x_hr] + image_filter_scale / 2) >>
            image_filter_shift;
...
class span_image_resample_rgba_affine
 ...
 public:
  ...
  span_image_resample_rgba_affine(source_type& src, interpolator_type& inter,
                                  const image_filter_lut& filter)
      : base_type(src, inter, filter)
  {
  }
  ...
  void generate(color_type* span, int x, int y, unsigned len)
  {
    ...
    int len_x_lr = (diameter * base_type::m_rx + image_subpixel_mask) >>
...
class span_image_resample_rgba
 ...
 public:
  ...
  span_image_resample_rgba(source_type& src, interpolator_type& inter,
                           const image_filter_lut& filter)
      : base_type(src, inter, filter)
  {
  }
  ...
  void generate(color_type* span, int x, int y, unsigned len)
  {
    ...
    do {
      ...
      int len_x_lr =
        (diameter * rx + image_subpixel_mask) >> image_subpixel_shift;
      ...
      int y_lr = y >> image_subpixel_shift;
      int y_hr = ((image_subpixel_mask - (y & image_subpixel_mask)) * ry_inv) >>
                 image_subpixel_shift;
      int total_weight = 0;
      int x_lr = x >> image_subpixel_shift;
      int x_hr = ((image_subpixel_mask - (x & image_subpixel_mask)) * rx_inv) >>
                 image_subpixel_shift;
      int x_hr2 = x_hr;
      const value_type* fg_ptr =
        (const value_type*)base_type::source().span(x_lr, y_lr, len_x_lr);
      ...
      if (fg[order_type::A] > base_mask)
        fg[order_type::A] = base_mask;
      if (fg[order_type::R] > fg[order_type::R])
        fg[order_type::R] = fg[order_type::R];
      if (fg[order_type::G] > fg[order_type::G])
        fg[order_type::G] = fg[order_type::G];
      if (fg[order_type::B] > fg[order_type::B])
        fg[order_type::B] = fg[order_type::B];
