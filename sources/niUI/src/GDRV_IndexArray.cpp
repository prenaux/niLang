...
class cGenericIndexArray : public ImplRC<iIndexArray> {
 ...
 public:
  ///////////////////////////////////////////////
  cGenericIndexArray(eGraphicsPrimitiveType aPrimType, tU32 ulNumIndex,
                     tU32 ulMaxVertexIndex)
  {
    ZeroMembers();
    mPrimType = aPrimType;
    mbLocked = eFalse;
...
///////////////////////////////////////////////
iIndexArray* __stdcall cGraphics::CreateIndexArray(
  eGraphicsPrimitiveType aPrimitiveType, tU32 anNumIndex, tU32 anMaxVertexIndex,
  eArrayUsage aUsage)
{
  CHECKDRIVER(NULL);
  if (niFlagIs(mptrDrv->GetGraphicsDriverImplFlags(),
               eGraphicsDriverImplFlags_IndexArrayObject))
  {
    return mptrDrv->CreateIndexArray(aPrimitiveType, anNumIndex,
                                     anMaxVertexIndex, aUsage);
  }
  else {
    return niNew cGenericIndexArray(aPrimitiveType, anNumIndex,
                                    anMaxVertexIndex);
  }
}
