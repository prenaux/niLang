...
// cWidget declaration.
class cWidget
    : public ImplRC<iWidget, ni::eImplFlags_DontInherit1, iMessageHandler> {
 ...
 public:
  ...
  //! Constructor.
  cWidget(cUIContext* pUICtx, iHString* ahspClass, cWidget* pwParent,
  ...
  void __stdcall SetStatus(tBool abVisible, tBool abEnabled,
                           tBool abIgnoreInput);
  ...
  iFont* __stdcall FindSkinFont(iHString* ahspSkinClass, iHString* ahspState,
                                iHString* ahspName) const;
  iOverlay* __stdcall FindSkinCursor(iHString* ahspSkinClass,
                                     iHString* ahspState,
                                     iHString* ahspName) const;
  iOverlay* __stdcall FindSkinElement(iHString* ahspSkinClass,
                                      iHString* ahspState,
                                      iHString* ahspName) const;
  sColor4f __stdcall FindSkinColor(const sColor4f& aDefault,
                                   iHString* ahspSkinClass, iHString* ahspState,
                                   iHString* ahspName) const;
  ...
  tBool __stdcall Place(const sRectf& aRect, eWidgetDockStyle aStyle,
  ...
  tBool __stdcall SendCommand(iWidget* apDest, tU32 anCommand,
                              const Var& avarExtra1, const Var& avarExtra2);
  tBool __stdcall BroadcastMessage(tU32 aMsg, const Var& avarA,
                                   const Var& avarB);

  void __stdcall SetCanvas(iCanvas* apCanvas);
  iCanvas* __stdcall GetCanvas() const;

  tBool __stdcall SerializeLayout(iDataTable* apDT,
                                  tWidgetSerializeFlags anFlags);
  tBool __stdcall SerializeChildren(iDataTable* apDT,
                                    tWidgetSerializeFlags anFlags);
  ...
  tBool __stdcall ShowHoverWidget(ni::iWidget* apWidget,
  ...
  tBool __stdcall PopAt(iWidget* apContainer, const sVec2f& avAbsPos,
                        tF32 afSnapMargin);
  ...
  cWidget* GetMessageTargetByPos(const sVec2f& pos,
                                 tBool (*apfnExcludeWidget)(const cWidget* w,
                                                            tIntPtr apUserData),
  ...
  void _ComputeRectSize(const sRectf& newRect, tBool abForceSendMessage,
                        const sVec2f& avNewSize);
  void ClearSinks();
