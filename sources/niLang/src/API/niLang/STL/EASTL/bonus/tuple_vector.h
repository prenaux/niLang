...
EA_DISABLE_VC_WARNING(
  4244) // warning C4244: 'conversion from '___' to '___', possible loss of data
EA_DISABLE_VC_WARNING(
  4623) // warning C4623: default constructor was implicitly defined as deleted
EA_DISABLE_VC_WARNING(
  4625) // warning C4625: copy constructor was implicitly defined as deleted
EA_DISABLE_VC_WARNING(
  4510) // warning C4510: default constructor could not be generated
...
///
  ...
  #define EASTL_TUPLE_VECTOR_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX             \
      " tuple-vector" // Unless the user overrides something, this is "EASTL tuple-vector".
#endif

/// EASTL_TUPLE_VECTOR_DEFAULT_ALLOCATOR
///
#ifndef EASTL_TUPLE_VECTOR_DEFAULT_ALLOCATOR
  #define EASTL_TUPLE_VECTOR_DEFAULT_ALLOCATOR \
    allocator_type(EASTL_TUPLE_VECTOR_DEFAULT_NAME)
#endif
...
struct tuplevec_element<0, T, Ts...> {
  tuplevec_element() =
    delete; // tuplevec_element should only be used for compile-time assistance, and never be instantiated
  typedef T type;
};
...
struct tuplevec_index<T, TupleTypes<>> {
  ...
  tuplevec_index() =
    delete; // tuplevec_index should only be used for compile-time assistance, and never be instantiated
...
struct tuplevec_index<T, TupleTypes<T, TsRest...>> {
  ...
  static_assert(
    is_void<typename tuplevec_index<
      T, TupleTypes<TsRest...>>::DuplicateTypeCheck>::value,
    "duplicate type T in tuple_vector::get<T>(); unique types must be provided in declaration, or only use get<eastl_size_t>()");
...
struct tuplevec_index<T, TupleTypes<Ts, TsRest...>> {
  typedef typename tuplevec_index<T, TupleTypes<TsRest...>>::DuplicateTypeCheck
    DuplicateTypeCheck;
  static const eastl_size_t index =
    tuplevec_index<T, TupleTypes<TsRest...>>::index + 1;
};

template <typename Allocator, typename T, typename Indices, typename... Ts>
struct tuplevec_index<T, TupleVecImpl<Allocator, Indices, Ts...>>
    : public tuplevec_index<T, TupleTypes<Ts...>> {};
...
struct TupleRecurser<> {
  ...
  static EA_CONSTEXPR size_type GetTotalAllocationSize(size_type capacity,
                                                       size_type offset)
  {
    (void)capacity;
    return offset;
  ...
  template <typename Allocator, size_type I, typename Indices,
            typename... VecTypes>
  static pair<void*, size_type> DoAllocate(
    TupleVecImpl<Allocator, Indices, VecTypes...>& vec, void** ppNewLeaf,
    size_type capacity, size_type offset)
  {
    EA_UNUSED(ppNewLeaf);
    ...
    void* ptr = capacity
                  ? allocate_memory(vec.get_allocator(), offset, alignment, 0)
                  : nullptr;

#if EASTL_ASSERT_ENABLED
    if (EASTL_UNLIKELY((size_t)ptr & (alignment - 1)) != 0) {
      EASTL_FAIL_MSG(
        "tuple_vector::DoAllocate -- memory not alignment at requested alignment");
    }
#endif
  ...
  static void SetNewData(TupleVecImplType& vec, void* pData, size_type capacity,
                         size_type offset)
  {
    EA_UNUSED(vec);
    EA_UNUSED(pData);
...
struct TupleRecurser<T, Ts...> : TupleRecurser<Ts...> {
  ...
  static EA_CONSTEXPR size_type GetTotalAlignment()
  {
    return max(static_cast<size_type>(alignof(T)),
               TupleRecurser<Ts...>::GetTotalAlignment());
  }

  static EA_CONSTEXPR size_type GetTotalAllocationSize(size_type capacity,
                                                       size_type offset)
  {
    return TupleRecurser<Ts...>::GetTotalAllocationSize(
      capacity, CalculateAllocationSize(offset, capacity));
  }
    ...
    size_type capacity, size_type offset)
  {
    ...
    pair<void*, size_type> allocation =
      TupleRecurser<Ts...>::template DoAllocate<Allocator, I + 1, Indices,
                                                VecTypes...>(
                         ...
                         size_type offset)
  {
    ...
    TupleRecurser<Ts...>::template SetNewData<TupleVecImplType, I + 1>(
      vec, pData, capacity, allocationSize);
  }

 private:
  static EA_CONSTEXPR size_type CalculateAllocationSize(size_type offset,
                                                        size_type capacity)
  {
    return CalculatAllocationOffset(offset) + sizeof(T) * capacity;
  }

  static EA_CONSTEXPR size_type CalculatAllocationOffset(size_type offset)
  {
...
struct TupleVecLeaf {
  ...
  void DoUninitializedMoveAndDestruct(const size_type begin,
                                      const size_type end, T* pDest)
  {
  ...
  void DoInsertAndFill(size_type pos, size_type n, size_type numElements,
                       const T& arg)
  {
    T* pDest = mpData + pos;
      ...
      nExtra) // If the inserted values are entirely within initialized memory (i.e. are before mpEnd)...
    {
      ...
      eastl::move_backward(
        pDest, pDataEnd - n,
        pDataEnd); // We need move_backward because of potential overlap issues.
  ...
  void DoInsertRange(T* pSrcBegin, T* pSrcEnd, T* pDestBegin,
                     size_type numDataElements)
  {
...
template <>
struct TupleVecIterCompatibleImpl<true, TupleTypes<>, TupleTypes<>>
    : public true_type {};

template <typename From, typename... FromRest, typename To, typename... ToRest>
struct TupleVecIterCompatibleImpl<true, TupleTypes<From, FromRest...>,
                                  TupleTypes<To, ToRest...>>
    : public integral_constant<
        bool, TupleVecIterCompatibleImpl<true, TupleTypes<FromRest...>,
                                         TupleTypes<ToRest...>>::value &&
                is_same<typename remove_const<From>::type,
                        typename remove_const<To>::type>::value> {};
...
struct TupleVecIterCompatible<TupleTypes<Us...>, TupleTypes<Ts...>>
    : public TupleVecIterCompatibleImpl<sizeof...(Us) == sizeof...(Ts),
                                        TupleTypes<Us...>, TupleTypes<Ts...>> {
};
...
struct TupleVecIter<index_sequence<Indices...>, Ts...>
    : public iterator<random_access_iterator_tag, tuple<Ts...>, eastl_size_t,
                      tuple<Ts*...>, tuple<Ts&...>> {
 private:
  typedef TupleVecIter<index_sequence<Indices...>, Ts...> this_type;
  typedef eastl_size_t size_type;

  typedef iterator<random_access_iterator_tag, tuple<Ts...>, eastl_size_t,
                   tuple<Ts*...>, tuple<Ts&...>>
    iter_type;
 ...
 public:
  ...
  template <
    typename OtherIndicesType, typename... Us,
    typename = typename enable_if<
      TupleVecIterCompatible<TupleTypes<Us...>, TupleTypes<Ts...>>::value,
      bool>::type>
  ...
  bool operator==(const TupleVecIter& other) const
  {
    return mIndex == other.mIndex && mpData[0] == other.mpData[0];
  }
  bool operator!=(const TupleVecIter& other) const
  {
    return mIndex != other.mIndex || mpData[0] != other.mpData[0];
...
class TupleVecImpl<Allocator, index_sequence<Indices...>, Ts...>
    : public TupleVecLeaf<Indices, Ts>... {
  typedef Allocator allocator_type;
  typedef index_sequence<Indices...> index_sequence_type;
  typedef TupleVecImpl<Allocator, index_sequence_type, Ts...> this_type;
  typedef TupleVecImpl<Allocator, index_sequence_type, const Ts...>
    const_this_type;

 public:
  typedef TupleVecInternal::TupleVecIter<index_sequence_type, Ts...> iterator;
  typedef TupleVecInternal::TupleVecIter<index_sequence_type, const Ts...>
    const_iterator;
      ...
      : mDataSizeAndAllocator(0, allocator)
  {
    if (
      get_allocator() ==
      x.get_allocator()) // If allocators are equivalent, then we can safely swap member-by-member
    {
      swap(x);
    }
    else {
  ...
  TupleVecImpl(
    const TupleVecImpl<OtherAllocator, index_sequence_type, Ts...>& x,
  ...
  TupleVecImpl(
    move_iterator<MoveIterBase> begin, move_iterator<MoveIterBase> end,
    const allocator_type& allocator = EASTL_TUPLE_VECTOR_DEFAULT_ALLOCATOR)
      : mDataSizeAndAllocator(0, allocator)
  {
  ...
  TupleVecImpl(size_type n, const allocator_type& allocator =
                              EASTL_TUPLE_VECTOR_DEFAULT_ALLOCATOR)
      : mDataSizeAndAllocator(0, allocator)
  {
    DoInitDefaultFill(n);
  ...
  TupleVecImpl(
    size_type n, const_reference_tuple tup,
    const allocator_type& allocator = EASTL_TUPLE_VECTOR_DEFAULT_ALLOCATOR)
      : mDataSizeAndAllocator(0, allocator)
  {
  ...
  TupleVecImpl(
    const value_tuple* first, const value_tuple* last,
    const allocator_type& allocator = EASTL_TUPLE_VECTOR_DEFAULT_ALLOCATOR)
      : mDataSizeAndAllocator(0, allocator)
  {
  ...
  TupleVecImpl(
    std::initializer_list<value_tuple> iList,
    const allocator_type& allocator = EASTL_TUPLE_VECTOR_DEFAULT_ALLOCATOR)
      : mDataSizeAndAllocator(0, allocator)
  {
 ...
 protected:
  ...
  TupleVecImpl(const allocator_type& allocator, void* pData, size_type capacity,
               size_type dataSize)
      : mpData(pData)
      , mNumCapacity(capacity)
      , mDataSizeAndAllocator(dataSize, allocator)
  {
    TupleRecurser<Ts...>::template SetNewData<this_type, 0>(*this, mpData,
                                                            mNumCapacity, 0);
  }
 ...
 public:
  ~TupleVecImpl()
  {
    swallow((eastl::destruct(TupleVecLeaf<Indices, Ts>::mpData,
  ...
  void assign(size_type n, const Ts&... args)
  {
    if (n > mNumCapacity) {
      this_type temp(
        n, args...,
        get_allocator()); // We have little choice but to reallocate with new memory.
      swap(temp);
    }
    else if (n > mNumElements) // If n > mNumElements ...
    {
      ...
      swallow(
        (eastl::fill(TupleVecLeaf<Indices, Ts>::mpData,
                     TupleVecLeaf<Indices, Ts>::mpData + oldNumElements, args),
         0)...);
      swallow((eastl::uninitialized_fill_ptr(
    ...
    {
      swallow((eastl::fill(TupleVecLeaf<Indices, Ts>::mpData,
                           TupleVecLeaf<Indices, Ts>::mpData + n, args),
               0)...);
      erase(begin() + n, end());
    }
  ...
  void assign(const_iterator first, const_iterator last)
  {
    ...
    if (newNumElements > mNumCapacity) {
      ...
      if (newNumElements > mNumElements) // If n > mNumElements ...
      {
        size_type oldNumElements = mNumElements;
        swallow(
          (eastl::copy((Ts*)(ppOtherData[Indices]) + firstIdx,
  ...
  void assign(const value_tuple* first, const value_tuple* last)
  {
    ...
    if (newNumElements > mNumCapacity) {
      ...
      if (newNumElements > mNumElements) // If n > mNumElements ...
      {
        ...
        DoUninitializedCopyFromTupleArray(begin() + oldNumElements,
  ...
  void push_back(const Ts&... args)
  {
    ...
    mNumElements = newNumElements;
    DoGrow(oldNumElements, oldNumCapacity, newNumElements);
    swallow(::new (TupleVecLeaf<Indices, Ts>::mpData + oldNumElements)
              Ts(args)...);
  }
    ...
    if (newNumElements > oldNumCapacity || firstIdx != oldNumElements) {
      if (newNumElements > oldNumCapacity) {
        const size_type newCapacity =
          max(GetNewCapacity(oldNumCapacity), newNumElements);

        void* ppNewLeaf[sizeof...(Ts)];
        pair<void*, size_type> allocation =
          TupleRecurser<Ts...>::template DoAllocate<allocator_type, 0,
                                                    index_sequence_type, Ts...>(
        ...
        swallow((TupleVecLeaf<Indices, Ts>::DoUninitializedMoveAndDestruct(
                 ...
                 0)...);
        swallow(
          (TupleVecLeaf<Indices, Ts>::DoUninitializedMoveAndDestruct(
             firstIdx, oldNumElements, (Ts*)ppNewLeaf[Indices] + firstIdx + 1),
           0)...);
        swallow(::new ((Ts*)ppNewLeaf[Indices] + firstIdx)
                  Ts(eastl::forward<Ts>(args))...);
        ...
        swallow((TupleVecLeaf<Indices, Ts>::DoInsertValue(
                   firstIdx, oldNumElements, eastl::forward<Ts>(args)),
                 0)...);
      }
    }
    else {
    ...
    if (newNumElements > oldNumCapacity || firstIdx != oldNumElements) {
      if (newNumElements > oldNumCapacity) {
        ...
        swallow((eastl::uninitialized_fill_ptr(
                   ...
                   (Ts*)ppNewLeaf[Indices] + lastIdx, args),
                 0)...);
        swallow(TupleVecLeaf<Indices, Ts>::mpData = (Ts*)ppNewLeaf[Indices]...);
        ...
        swallow((TupleVecLeaf<Indices, Ts>::DoInsertAndFill(
                   firstIdx, n, oldNumElements, args),
                 0)...);
      }
    }
    else {
    ...
    if (newNumElements > oldNumCapacity || posIdx != oldNumElements) {
      if (newNumElements > oldNumCapacity) {
        ...
        swallow((TupleVecLeaf<Indices, Ts>::DoUninitializedMoveAndDestruct(
                 ...
                 0)...);
        swallow((TupleVecLeaf<Indices, Ts>::DoUninitializedMoveAndDestruct(
                   posIdx, oldNumElements,
                   (Ts*)ppNewLeaf[Indices] + posIdx + numToInsert),
                 0)...);
        swallow(
          (eastl::uninitialized_copy_ptr((Ts*)(ppOtherData[Indices]) + firstIdx,
                                         (Ts*)(ppOtherData[Indices]) + lastIdx,
  ...
  iterator insert(const_iterator pos, const value_tuple* first,
                  const value_tuple* last)
  {
#if EASTL_ASSERT_ENABLED
    if (EASTL_UNLIKELY(validate_iterator(pos) == isf_none))
      EASTL_FAIL_MSG("tuple_vector::insert -- invalid iterator");
    ...
    if (newNumElements > oldNumCapacity || posIdx != oldNumElements) {
      if (newNumElements > oldNumCapacity) {
        ...
        DoUninitializedCopyFromTupleArray(
          begin() + posIdx, begin() + posIdx + numToInsert, first);
        ...
        void* ppDataEnd[sizeof...(Ts)] = { (
          void*)(TupleVecLeaf<Indices, Ts>::mpData + oldNumElements)... };
        void* ppDataBegin[sizeof...(Ts)] = { (
          void*)(TupleVecLeaf<Indices, Ts>::mpData + posIdx)... };
        if (
          numToInsert <
          nExtra) // If the inserted values are entirely within initialized memory (i.e. are before mpEnd)...
        {
          swallow((eastl::uninitialized_move_ptr(
                     (Ts*)ppDataEnd[Indices] - numToInsert,
                     (Ts*)ppDataEnd[Indices], (Ts*)ppDataEnd[Indices]),
                   0)...);
          // We need move_backward because of potential overlap issues.
          swallow((eastl::move_backward((Ts*)ppDataBegin[Indices],
                                        (Ts*)ppDataEnd[Indices] - numToInsert,
                                        (Ts*)ppDataEnd[Indices]),
                   0)...);
          ...
          swallow((eastl::uninitialized_move_ptr(
                     (Ts*)ppDataBegin[Indices], (Ts*)ppDataEnd[Indices],
                     (Ts*)ppDataEnd[Indices] + numToInitialize),
                   0)...);

          DoCopyFromTupleArray(pos, begin() + oldNumElements, first);
          DoUninitializedCopyFromTupleArray(begin() + oldNumElements,
                                            pos + numToInsert, first + nExtra);
        }
      }
    }
    else {
  ...
  {
#if EASTL_ASSERT_ENABLED
    if (EASTL_UNLIKELY(validate_iterator(first) == isf_none ||
                       validate_iterator(last) == isf_none))
    ...
    if (first != last) {
      ...
      swallow((eastl::move(TupleVecLeaf<Indices, Ts>::mpData + lastIdx,
               ...
               0)...);
      swallow(
        (eastl::destruct(TupleVecLeaf<Indices, Ts>::mpData + newNumElements,
                         TupleVecLeaf<Indices, Ts>::mpData + oldNumElements),
         0)...);
    }
  ...
  void resize(size_type n)
  {
    ...
    if (n > oldNumElements) {
      if (n > oldNumCapacity) {
        DoReallocate(oldNumElements,
                     eastl::max<size_type>(GetNewCapacity(oldNumCapacity), n));
      }
      swallow((eastl::uninitialized_default_fill_n(
                 TupleVecLeaf<Indices, Ts>::mpData + oldNumElements,
                 n - oldNumElements),
               0)...);
    }
      ...
      swallow(
        (eastl::destruct(TupleVecLeaf<Indices, Ts>::mpData + n,
                         TupleVecLeaf<Indices, Ts>::mpData + oldNumElements),
         0)...);
    }
  }
  ...
  void shrink_to_fit()
  {
    this_type temp(move_iterator<iterator>(begin()),
                   move_iterator<iterator>(end()), get_allocator());
    swap(temp);
  }
  ...
  void clear() EA_NOEXCEPT
  {
    ...
    mNumElements = 0;
    swallow(
      (eastl::destruct(TupleVecLeaf<Indices, Ts>::mpData,
                       TupleVecLeaf<Indices, Ts>::mpData + oldNumElements),
       0)...);
  }
  ...
  void pop_back()
  {
    ...
    size_type oldNumElements = mNumElements--;
    swallow(
      (eastl::destruct(TupleVecLeaf<Indices, Ts>::mpData + oldNumElements - 1,
                       TupleVecLeaf<Indices, Ts>::mpData + oldNumElements),
       0)...);
  }
  ...
  {
    swallow((eastl::swap(TupleVecLeaf<Indices, Ts>::mpData,
                         x.TupleVecLeaf<Indices, Ts>::mpData),
             0)...);
  ...
  void assign(size_type n, const_reference_tuple tup)
  {
    assign(n, eastl::get<Indices>(tup)...);
  }
  ...
  {
    emplace_back(eastl::forward<Ts>(args)...);
  }
  void push_back(const_reference_tuple tup)
  {
    push_back(eastl::get<Indices>(tup)...);
  }
  void push_back(rvalue_tuple tup)
  {
    emplace_back(eastl::forward<Ts>(eastl::get<Indices>(tup))...);
  }

  void emplace_back(rvalue_tuple tup)
  {
    emplace_back(eastl::forward<Ts>(eastl::get<Indices>(tup))...);
  }
  void emplace(const_iterator pos, rvalue_tuple tup)
  {
    emplace(pos, eastl::forward<Ts>(eastl::get<Indices>(tup))...);
  }
  ...
  {
    return emplace(pos, eastl::forward<Ts>(args)...);
  }
  iterator insert(const_iterator pos, rvalue_tuple tup)
  {
    return emplace(pos, eastl::forward<Ts>(eastl::get<Indices>(tup))...);
  }
  iterator insert(const_iterator pos, const_reference_tuple tup)
  {
    return insert(pos, eastl::get<Indices>(tup)...);
  }
  iterator insert(const_iterator pos, size_type n, const_reference_tuple tup)
  {
    return insert(pos, n, eastl::get<Indices>(tup)...);
  }
  iterator insert(const_iterator pos, std::initializer_list<value_tuple> iList)
  {
  ...
  void resize(size_type n, const_reference_tuple tup)
  {
    resize(n, eastl::get<Indices>(tup)...);
  }
  ...
  {
    return const_iterator((const_this_type*)(this), 0);
  }
  ...
  {
    return const_iterator((const_this_type*)(this), size());
  }
  ...
  ptr_tuple data() EA_NOEXCEPT
  {
    return ptr_tuple(TupleVecLeaf<Indices, Ts>::mpData...);
  }
  const_ptr_tuple data() const EA_NOEXCEPT
  {
    return const_ptr_tuple(TupleVecLeaf<Indices, Ts>::mpData...);
  }
  ...
  reference_tuple operator[](size_type n)
  {
    return at(n);
  }
  const_reference_tuple operator[](size_type n) const
  {
    return at(n);
  }
  ...
  reference_tuple front()
  {
    ...
    if (EASTL_UNLIKELY(
          mNumElements ==
          0)) // We don't allow the user to reference an empty container.
  ...
  {
    if (!(variadicAnd(iter.mpData[Indices] ==
                      TupleVecLeaf<Indices, Ts>::mpData...)))
      return isf_none;
  ...
  static bool validate_iterator_pair(const_iterator first,
                                     const_iterator last) EA_NOEXCEPT
  {
    return (first.mIndex <= last.mIndex) &&
           variadicAnd(first.mpData[Indices] == last.mpData[Indices]...);
  }

  template <typename Iterator,
            typename = typename enable_if<is_iterator_wrapper<Iterator>::value,
                                          bool>::type>
  int validate_iterator(Iterator iter) const EA_NOEXCEPT
  {
    return validate_iterator(unwrap_iterator(iter));
  }

  template <typename Iterator,
            typename = typename enable_if<is_iterator_wrapper<Iterator>::value,
                                          bool>::type>
  static bool validate_iterator_pair(Iterator first, Iterator last) EA_NOEXCEPT
  {
    return validate_iterator_pair(unwrap_iterator(first),
                                  unwrap_iterator(last));
  }

  allocator_type& get_allocator() EA_NOEXCEPT
  {
    return mDataSizeAndAllocator.second();
  }
 ...
 protected:
  ...
  size_type& internalDataSize() EA_NOEXCEPT
  {
    return mDataSizeAndAllocator.first();
  }
  size_type const& internalDataSize() const EA_NOEXCEPT
  {
    return mDataSizeAndAllocator.first();
  }
  ...
  template <typename MoveIterBase>
  void DoInitFromIterator(move_iterator<MoveIterBase> begin,
                          move_iterator<MoveIterBase> end)
  {
#if EASTL_ASSERT_ENABLED
    ...
    const void* ppOtherData[sizeof...(Ts)] = {
  ...
  void DoInitFromIterator(const_iterator begin, const_iterator end)
  {
    ...
    mNumElements = newNumElements;
    swallow(
      (eastl::uninitialized_copy_ptr((Ts*)(ppOtherData[Indices]) + beginIdx,
                                     (Ts*)(ppOtherData[Indices]) + endIdx,
                                     TupleVecLeaf<Indices, Ts>::mpData),
       0)...);
  }

  void DoInitFillTuple(size_type n, const_reference_tuple tup)
  {
    DoInitFillArgs(n, eastl::get<Indices>(tup)...);
  }
  ...
  void DoInitDefaultFill(size_type n)
  {
    ...
    mNumElements = n;
    swallow((
      eastl::uninitialized_default_fill_n(TupleVecLeaf<Indices, Ts>::mpData, n),
      0)...);
  }
  ...
  void DoCopyFromTupleArray(iterator destPos, iterator destEnd,
                            const value_tuple* srcTuple)
  {
  ...
  void DoUninitializedCopyFromTupleArray(iterator destPos, iterator destEnd,
                                         const value_tuple* srcTuple)
  {
    // placement-new/copy-ctor to unconstructed regions
    while (destPos < destEnd) {
      swallow(::new (eastl::get<Indices>(destPos.MakePointer()))
                Ts(eastl::get<Indices>(*srcTuple))...);
      ++destPos;
      ++srcTuple;
    }
  }
  ...
  void DoGrow(size_type oldNumElements, size_type oldNumCapacity,
  ...
  void DoConditionalReallocate(size_type oldNumElements,
                               size_type oldNumCapacity,
                               size_type requiredCapacity)
  {
    if (requiredCapacity > oldNumCapacity)
  ...
  void DoReallocate(size_type oldNumElements, size_type requiredCapacity)
  {
    ...
    swallow((TupleVecLeaf<Indices, Ts>::DoUninitializedMoveAndDestruct(
               0, oldNumElements, (Ts*)ppNewLeaf[Indices]),
             0)...);
    swallow(TupleVecLeaf<Indices, Ts>::mpData = (Ts*)ppNewLeaf[Indices]...);
...
template <eastl_size_t... Indices, typename... Ts>
class move_iterator<
  TupleVecInternal::TupleVecIter<index_sequence<Indices...>, Ts...>> {
 public:
  typedef TupleVecInternal::TupleVecIter<index_sequence<Indices...>, Ts...>
    iterator_type;
  typedef iterator_type
    wrapped_iterator_type; // This is not in the C++ Standard; it's used by use to identify it as
 ...
 public:
  ...
  reference operator*() const
  {
    return eastl::move(MakeReference());
  }
 ...
 private:
  ...
  {
    return reference(
      eastl::move(((Ts*)mIterator.mpData[Indices])[mIterator.mIndex])...);
  }
};

template <typename AllocatorA, typename AllocatorB, typename Indices,
          typename... Ts>
inline bool operator==(
  const TupleVecInternal::TupleVecImpl<AllocatorA, Indices, Ts...>& a,
...
template <typename... Ts>
inline typename enable_if<conjunction<is_swappable<Ts>...>::value>::type swap(
  tuple<Ts&...>&& a, tuple<Ts&...>&& b)
{
  a.swap(b);
}
...
template <typename... Ts>
inline typename enable_if<!conjunction<is_swappable<Ts>...>::value>::type swap(
  tuple<Ts&...>&& a, tuple<Ts&...>&& b) = delete;

// External interface of tuple_vector
template <typename... Ts>
class tuple_vector
    : public TupleVecInternal::TupleVecImpl<
        EASTLAllocatorType, make_index_sequence<sizeof...(Ts)>, Ts...> {
 ...
 public:
  this_type& operator=(
    std::initializer_list<typename base_type::value_tuple> iList)
  {
...
class tuple_vector_alloc
    : public TupleVecInternal::TupleVecImpl<
        AllocatorType, make_index_sequence<sizeof...(Ts)>, Ts...> {
