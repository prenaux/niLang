...
class trans_viewport {
 public:
  ...
  //-------------------------------------------------------------------
  void preserve_aspect_ratio(agg_real alignx, agg_real aligny,
  ...
  //-------------------------------------------------------------------
  void device_viewport(agg_real* x1, agg_real* y1, agg_real* x2,
                       agg_real* y2) const
  {
    *x1 = m_device_x1;
    *y1 = m_device_y1;
  ...
  //-------------------------------------------------------------------
  void world_viewport(agg_real* x1, agg_real* y1, agg_real* x2,
                      agg_real* y2) const
  {
    *x1 = m_world_x1;
    *y1 = m_world_y1;
  ...
  //-------------------------------------------------------------------
  void world_viewport_actual(agg_real* x1, agg_real* y1, agg_real* x2,
                             agg_real* y2) const
  {
    *x1 = m_wx1;
    *y1 = m_wy1;
  ...
  agg_real align_x() const
  {
    return m_align_x;
  }
  agg_real align_y() const
  {
    return m_align_y;
  }
  ...
  //-------------------------------------------------------------------
  agg_real device_dx() const
  {
    return m_dx1 - m_wx1 * m_kx;
  }
  agg_real device_dy() const
  {
