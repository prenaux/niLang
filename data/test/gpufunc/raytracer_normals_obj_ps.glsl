...
TestGpuFuncs_PixelOutput TestGpuFuncs_raytracer_normals_obj_ps(lib_shader_PixelInput aInput, TestGpuFuncs_RayUniforms aUniforms, accelerationStructureEXT aAS);
...
void main(void) {
  ...
  TestGpuFuncs_PixelOutput _rval_ = TestGpuFuncs_raytracer_normals_obj_ps(aInput, aUniforms, IN_1_aAS);
