...
class linked_array {
 ...
 public:
  ...
  int use_count() const
  {
    ...
    for (const linked_ptr_base* pCurrent = this; pCurrent->mpNext != this;
...
inline bool operator==(const linked_array<T, TD>& linkedArray1,
                       const linked_array<U, UD>& linkedArray2)
{
