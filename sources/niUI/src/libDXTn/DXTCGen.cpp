...
void DXTCGen::BuildCodes3(cbVector *pVects, cbVector &v1, cbVector &v2)
{
  ...
  pVects[2] = v2;
  pVects[1][0] = v1[0];
  pVects[1][1] = (ni::tU8)( ((long)v1[1] + (long)v2[1]) / 2 );
  pVects[1][2] = (ni::tU8)( ((long)v1[2] + (long)v2[2]) / 2 );
  pVects[1][3] = (ni::tU8)( ((long)v1[3] + (long)v2[3]) / 2 );
#else
  __asm {
...
#if defined USE_CODEBOOKMMX
ni::tI64 ScaleOneThird = 0x5500550055005500;
#endif
...
void DXTCGen::BuildCodes4(cbVector *pVects, cbVector &v1, cbVector &v2)
{
  ...
  pVects[1][0] = v1[0];
  pVects[1][1] = (ni::tU8)( ((long)v1[1] * 2 + (long)v2[1]) / 3 );
  pVects[1][2] = (ni::tU8)( ((long)v1[2] * 2 + (long)v2[2]) / 3 );
  pVects[1][3] = (ni::tU8)( ((long)v1[3] * 2 + (long)v2[3]) / 3 );

  pVects[2][0] = v1[0];
  pVects[2][1] = (ni::tU8)( ((long)v2[1] * 2 + (long)v1[1]) / 3 );
  pVects[2][2] = (ni::tU8)( ((long)v2[2] * 2 + (long)v1[2]) / 3 );
  pVects[2][3] = (ni::tU8)( ((long)v2[3] * 2 + (long)v1[3]) / 3 );
#else
  __asm {
    mov     ecx, dword ptr pVects
        mov     eax, dword ptr v1
...
void DXTCGen::BuildCodes3(cbVector *pVects, long Channel, cbVector &v1, cbVector &v2)
{
  ...
  pVects[1][Channel] = (ni::tU8)( ((long)v1[Channel] + (long)v2[Channel]) / 2 );
}
...
void DXTCGen::BuildCodes4(cbVector *pVects, long Channel, cbVector &v1, cbVector &v2)
{
  ...
  pVects[1][Channel] = (ni::tU8)( ((long)v1[Channel] * 2 + (long)v2[Channel]) / 3 );
  pVects[2][Channel] = (ni::tU8)( ((long)v2[Channel] * 2 + (long)v1[Channel]) / 3 );
}
...
long DXTCGen::Execute3(CodeBook &Source, CodeBook &Pixels, CodeBook &Dest)
{
  ...
  for(c=1; c<4; c++)
  {
    ...
    Start0 = ni::Max(0, Start0);
    End0 = ni::Min(255, End0);

    Start1 = (long)Test[1][c] - ScanRange/2;
    End1 = Start1 + ScanRange;

    Start1 = ni::Max(0, Start1);
    End1 = ni::Min(255, End1);
