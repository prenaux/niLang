...
template <typename T>
__forceinline void _RegisterStandardWidget(tCreateInstanceCMap* map,
                                           const achar* aName, const T& aFun)
{
...
void _RegisterStandardWidgets()
{
  ...
  _RegisterStandardWidget(
    map, "Dummy", [](iWidget* apWidget) -> iWidgetSink* { return NULL; });
  ...
  _RegisterStandardWidget(map, "ScrollBar",
                          [](iWidget* apWidget) -> iWidgetSink* {
                            return niNew cScrollBarWidget(apWidget);
                          });

  _RegisterStandardWidget(map, "ListBox",
                          [](iWidget* apWidget) -> iWidgetSink* {
                            return niNew cWidgetListBox(apWidget);
                          });

  _RegisterStandardWidget(map, "EditBox",
                          [](iWidget* apWidget) -> iWidgetSink* {
                            return niNew cEditBoxWidget(apWidget);
                          });

  _RegisterStandardWidget(map, "ComboBox",
                          [](iWidget* apWidget) -> iWidgetSink* {
                            return niNew cComboBoxWidget(apWidget);
                          });

  _RegisterStandardWidget(map, "ProgressBar",
                          [](iWidget* apWidget) -> iWidgetSink* {
  ...
  _RegisterStandardWidget(map, "Splitter",
                          [](iWidget* apWidget) -> iWidgetSink* {
                            return niNew cWidgetSplitter(apWidget);
                          });

  _RegisterStandardWidget(map, "DockingManager",
                          [](iWidget* apWidget) -> iWidgetSink* {
  ...
  _RegisterStandardWidget(map, "PropertyBox",
                          [](iWidget* apWidget) -> iWidgetSink* {
  #if niMinFeatures(20)
  ...
  _RegisterStandardWidget(map, "ColorPicker",
                          [](iWidget* apWidget) -> iWidgetSink* {
  ...
  _RegisterStandardWidget(
    map, "Toolbar",
    [](iWidget* apWidget) -> iWidgetSink* { return New_WidgetToolbar(); });

  _RegisterStandardWidget(
    map, "ToolbarGroup",
    [](iWidget* apWidget) -> iWidgetSink* { return New_WidgetToolbarGroup(); });

  _RegisterStandardWidget(map, "SearchBar",
                          [](iWidget* apWidget) -> iWidgetSink* {
  #if niMinFeatures(20)
