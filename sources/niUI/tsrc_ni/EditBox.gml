<Canvas
  title="EditBox"
  id="ID_EditBoxForm"
  client_size="Vec2(800,600)">
  <Canvas
    margin="Vec4(50,50,150,50)"
    padding="Vec4(2,2,2,2)"
    border="Vec4(2,2,2,2)"
    dock_style="DockFill"
    >
    <EditBox
...
function SomeCode(int x) {
  Println! "Using a monospace font"
  if (x < 10) {
    Println! "#{x} < 10"
  }
}

--- Text below is to make sure we have a scrollbar
