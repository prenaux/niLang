...
// Pixel Shader main: niUIGpuFuncs_raytracer_mat_diffuse_b_ps
...
void main(void) {
  ...
  nish_std_PixelOutput _rval_ = niUIGpuFuncs_raytracer_mat_diffuse_b_ps(aInput, aUniforms, IN_1_aAS, IN_1_aSS);
