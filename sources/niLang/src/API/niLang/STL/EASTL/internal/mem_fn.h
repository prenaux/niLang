...
struct derives_from_unary_function {
 ...
 public:
  static const bool value =
    !is_same<decltype(test((T*)0)), eastl::no_type>::value;
...
struct derives_from_binary_function {
 private:
  ...
  static binary_function<A1, A2, R> test(
    const volatile binary_function<A1, A2, R>*);
...
template <class T>
struct weak_result_type_imp<T, false>
    : public maybe_derive_from_unary_function<T>,
      public maybe_derive_from_binary_function<T> {};
...
struct weak_result_type<R(A1)> : public unary_function<A1, R> {};
template <class R, class A1>
struct weak_result_type<R (&)(A1)> : public unary_function<A1, R> {};
template <class R, class A1>
struct weak_result_type<R (*)(A1)> : public unary_function<A1, R> {};
template <class R, class C>
struct weak_result_type<R (C::*)()> : public unary_function<C*, R> {};
template <class R, class C>
struct weak_result_type<R (C::*)() const> : public unary_function<const C*, R> {
};
template <class R, class C>
struct weak_result_type<R (C::*)() volatile>
    : public unary_function<volatile C*, R> {};
template <class R, class C>
struct weak_result_type<R (C::*)() const volatile>
    : public unary_function<const volatile C*, R> {};

// 2 argument case
template <class R, class A1, class A2>
struct weak_result_type<R(A1, A2)> : public binary_function<A1, A2, R> {};
template <class R, class A1, class A2>
struct weak_result_type<R (*)(A1, A2)> : public binary_function<A1, A2, R> {};
template <class R, class A1, class A2>
struct weak_result_type<R (&)(A1, A2)> : public binary_function<A1, A2, R> {};
template <class R, class C, class A1>
struct weak_result_type<R (C::*)(A1)> : public binary_function<C*, A1, R> {};
template <class R, class C, class A1>
struct weak_result_type<R (C::*)(A1) const>
    : public binary_function<const C*, A1, R> {};
template <class R, class C, class A1>
struct weak_result_type<R (C::*)(A1) volatile>
    : public binary_function<volatile C*, A1, R> {};
template <class R, class C, class A1>
struct weak_result_type<R (C::*)(A1) const volatile>
    : public binary_function<const volatile C*, A1, R> {};

// 3 or more arguments
#if EASTL_VARIADIC_TEMPLATES_ENABLED
template <class R, class A1, class A2, class A3, class... A4>
struct weak_result_type<R(A1, A2, A3, A4...)> {
  typedef R result_type;
};
template <class R, class A1, class A2, class A3, class... A4>
struct weak_result_type<R (&)(A1, A2, A3, A4...)> {
...
struct weak_result_type<R (C::*)(A1, A2, A3...)> {
  typedef R result_type;
};
template <class R, class C, class A1, class A2, class... A3>
struct weak_result_type<R (C::*)(A1, A2, A3...) const> {
  typedef R result_type;
};
template <class R, class C, class A1, class A2, class... A3>
struct weak_result_type<R (C::*)(A1, A2, A3...) volatile> {
  typedef R result_type;
};
template <class R, class C, class A1, class A2, class... A3>
struct weak_result_type<R (C::*)(A1, A2, A3...) const volatile> {
  typedef R result_type;
};
#endif
...
#endif
{
 ...
 public:
  EASTL_FORCE_INLINE mem_fn_impl(type _func)
      : func(_func)
  {
  }
  ...
  typename invoke_result<type, ArgTypes...>::type operator()(
    ArgTypes&&... args) const
  {
  ...
  typename invoke_result2<type, A0, A1, A2>::type operator()(A0& a0, A1& a1,
                                                             A2& a2) const
  {
...
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)(A0, A1, A2)> mem_fn(R (T::*pm)(A0, A1,
                                                                       A2))
{
...
template <class R, class T, class A0, class A1>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)(A0, A1) const> mem_fn(R (T::*pm)(A0, A1)
                                                                const)
{
...
template <class R, class T, class A0, class A1, class A2>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)(A0, A1, A2) const> mem_fn(
  R (T::*pm)(A0, A1, A2) const)
{
  return mem_fn_impl<R (T::*)(A0, A1, A2) const>(pm);
}

template <class R, class T>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)() volatile> mem_fn(
  R (T::*pm)() volatile)
{
...
template <class R, class T, class A0>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)(A0) volatile> mem_fn(
  R (T::*pm)(A0) volatile)
{
...
template <class R, class T, class A0, class A1>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)(A0, A1) volatile> mem_fn(
  R (T::*pm)(A0, A1) volatile)
{
  return mem_fn_impl<R (T::*)(A0, A1) volatile>(pm);
}

template <class R, class T, class A0, class A1, class A2>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)(A0, A1, A2) volatile> mem_fn(
  R (T::*pm)(A0, A1, A2) volatile)
{
  return mem_fn_impl<R (T::*)(A0, A1, A2) volatile>(pm);
}

template <class R, class T>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)() const volatile> mem_fn(
  R (T::*pm)() const volatile)
{
  return mem_fn_impl<R (T::*)() const volatile>(pm);
}

template <class R, class T, class A0>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)(A0) const volatile> mem_fn(
  R (T::*pm)(A0) const volatile)
{
  return mem_fn_impl<R (T::*)(A0) const volatile>(pm);
}

template <class R, class T, class A0, class A1>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)(A0, A1) const volatile> mem_fn(
  R (T::*pm)(A0, A1) const volatile)
{
  return mem_fn_impl<R (T::*)(A0, A1) const volatile>(pm);
}

template <class R, class T, class A0, class A1, class A2>
EASTL_FORCE_INLINE mem_fn_impl<R (T::*)(A0, A1, A2) const volatile> mem_fn(
  R (T::*pm)(A0, A1, A2) const volatile)
{
