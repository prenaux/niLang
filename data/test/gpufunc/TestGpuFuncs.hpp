...
struct TestGpuFuncs_TestUniforms {
  ...
  TestGpuFuncs_TestUniforms(ni::ain<ni::tF32> a_alphaRef, ni::ain<ni::sVec4f> a_materialColor);
...
inline TestGpuFuncs_TestUniforms::TestGpuFuncs_TestUniforms(ni::ain<ni::tF32> a_alphaRef, ni::ain<ni::sVec4f> a_materialColor) {
