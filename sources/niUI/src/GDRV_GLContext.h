...
using GLhandle = void*;
  ...
  #define GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET \
...
int tsglCreateContext(tsglContext** appCtx, ni::iOSWindow* apWindow,
                      ni::tU32 anColorBits, ni::tU32 anDepthBits,
                      ni::tU32 anStencilBits, ni::tU32 anAA,
                      ni::tU32 anSwapInterval);
...
//
//===========================================================================
#if defined niWindows || defined niJSCC || defined niAndroid || \
  defined niOSX || defined niIOS || defined niQNX || defined niLinux
  #define USE_FBO
#endif
