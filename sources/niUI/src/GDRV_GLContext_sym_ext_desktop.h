...
TSGL_EXT_PROC(void, glUnmapBuffer, (GLenum target));
...
TSGL_EXT_PROC(GLuint, glCreateShaderObject, (void));
TSGL_EXT_PROC(GLuint, glCreateProgramObject, (void));
TSGL_EXT_PROC(void, glDeleteObject, (GLuint obj));
TSGL_EXT_PROC(void, glAttachObject, (GLuint program, GLuint obj));
TSGL_EXT_PROC(void, glUseProgramObject, (GLuint program));

TSGL_EXT_PROC(GLuint, glCreateShader, (GLenum type));
TSGL_EXT_PROC(void, glShaderSource, (GLuint shader, GLsizei count, const char** string, const GLint* length));
TSGL_EXT_PROC(void, glCompileShader, (GLuint shader));
TSGL_EXT_PROC(void, glGetObjectParameteriv, (GLuint shader, GLenum pname, GLint* params));
TSGL_EXT_PROC(void, glAttachShader, (GLuint program, GLuint shader));
TSGL_EXT_PROC(void, glGetInfoLog, (GLuint object, GLsizei maxLength, GLsizei* length, GLchar* infoLog));
