...
TEST_FIXTURE(FBufferEncDec, Base32)
{
  ...
  tInt encodeResSize =
    Base32Encode((tPtr)encoded, encodedLen, (tPtr)data, dataSize);
  CHECK((encodeResSize + 1) <= encodedLen);
  TEST_DEBUGFMT("data: %s -> encoded: %s", data, encoded);
  CHECK_EQUAL(
    _ASTR(
      "8cx2yh3fcdtptsbeehsj0rbecgg56sbmehmpwsvk5x7qevk5e8qmty908hqp6xbdcnq78wsfc5h66s34cnk6et39regc7ae3n31tfgxswa1asgnnrare9fd0wpjvvknhsts2yhv1f5gjyx35edte9fd0wpjvtbkmf1t00"),
    _ASTR(encoded));
  ...
  tInt decodeResSize =
    Base32Decode((tPtr)decoded, decodedLen, encoded, StrLen(encoded));
  CHECK_EQUAL(ni::StrSizeZ(data), decodeResSize);
  TEST_DEBUGFMT("decoded: %s", decoded);
  CHECK_EQUAL(
    _ASTR(
      "C:/Documents and Settings/Owner/My Documents/abcddefghiàéèçù€µ°你好αβ/Gaya/test你好.txt"),
    _ASTR(decoded));
}
...
TEST_FIXTURE(FBufferEncDec, Base32DecodeFormatted)
{
  ...
  {
    const char* encoded =
      "8cx2yh3fcdtptsbeehsj0rbecgg56sbmehmpwsvk5x7qevk5e8qmty908hqp6xbdcnq78wsfc5h66s34cnk6et39regc7ae3n31tfgxswa1asgnnrare9fd0wpjvvknhsts2yhv1f5gjyx35edte9fd0wpjvtbkmf1t0O";
  ...
  {
    const char* encoded =
      "8cx2yh3fcdtptsbeehsj0rbecgg56sbmehmpwsvk5x7qevk5e8qmty908hqp6xbdcnq78wsfc5h66s34cnk6et39regc7ae3n3Itfgxswaiasgnnrare9fd0wpjvvknhsts2yhvLf5gjyx35edte9fd0wpjvtbkmfltOo";
...
TEST_FIXTURE(FBufferEncDec, Base64)
{
  ...
  tInt encodeResSize =
    Base64Encode((tPtr)encoded, encodedLen, (tPtr)data, dataSize);
  CHECK_EQUAL(encodedLen, encodeResSize + 1);
  TEST_DEBUGFMT("data: %s -> encoded: %s", data, encoded);
  CHECK_EQUAL(
    _ASTR(
      "QzovRG9jdW1lbnRzIGFuZCBTZXR0aW5ncy9Pd25lci9NeSBEb2N1bWVudHMvYWJjZGRlZmdoacOgw6nDqMOnw7nigqzCtcKw5L2g5aW9zrHOsi9HYXlhL3Rlc3TkvaDlpb0udHh0AA=="),
    _ASTR(encoded));
  ...
  tInt decodeResSize =
    Base64Decode((tPtr)decoded, decodedLen, encoded, StrLen(encoded));
...
TEST_FIXTURE(FBufferEncDec, Base64DecodeFormatted)
{
  ...
  {
    const char* encoded =
      "QzovRG9jdW1lbnRzIGFuZCBTZXR0aW5ncy9Pd25lci9NeSBEb2N1bWVudHMvYWJjZGRlZmdoacOgw6nDqMOnw7nigqzCtcKw5L2g5aW9zrHOsi9HYXlhL3Rlc3TkvaDlpb0udHh0AA==\0";
    ...
    tInt decodeResSize =
      Base64Decode((tPtr)decoded, decodedLen, encoded, encodedLen);
    CHECK_EQUAL(decodedLen, decodeResSize);
    TEST_DEBUGFMT("decoded: %s", decoded);
    CHECK_EQUAL(
      _ASTR(
...
TEST_FIXTURE(FBufferEncDec, Hex)
{
  ...
  *encoded = 0;
  ...
  tInt encodeResSize =
    HexEncode((tPtr)encoded, encodedLen, (tPtr)data, dataSize, eFalse);
  CHECK_EQUAL(encodedLen, encodeResSize + 1);
  TEST_DEBUGFMT("data: %s -> encoded: %s", data, encoded);
  CHECK_EQUAL(
    _ASTR(
      "433a2f446f63756d656e747320616e642053657474696e67732f4f776e65722f4d7920446f63756d656e74732f61626364646566676869c3a0c3a9c3a8c3a7c3b9e282acc2b5c2b0e4bda0e5a5bdceb1ceb22f476179612f74657374e4bda0e5a5bd2e74787400"),
    //_ASTR("666f6f00"),
    _ASTR(encoded));
  ...
  *decoded = 0;
  ...
  tInt decodeResSize =
    HexDecode((tPtr)decoded, decodedLen, encoded, StrLen(encoded));
  CHECK_EQUAL(decodedLen, decodeResSize);
  CHECK_EQUAL(ni::StrSizeZ(data), decodeResSize);
  TEST_DEBUGFMT("decoded: %s", decoded);
  CHECK_EQUAL(
...
{
  const char* encodedHex =
    "433a2f446f63756d656e747320616e642053657474696e67732f4f776e65722f4d7920446f63756d656e74732f61626364646566676869c3a0c3a9c3a8c3a7c3b9e282acc2b5c2b0e4bda0e5a5bdceb1ceb22f476179612f74657374e4bda0e5a5bd2e74787400";
  const char* encodedBase64 =
    "QzovRG9jdW1lbnRzIGFuZCBTZXR0aW5ncy9Pd25lci9NeSBEb2N1bWVudHMvYWJjZGRlZmdoacOgw6nDqMOnw7nigqzCtcKw5L2g5aW9zrHOsi9HYXlhL3Rlc3TkvaDlpb0udHh0AA==";
  const char* encodedBase32 =
    "8cx2yh3fcdtptsbeehsj0rbecgg56sbmehmpwsvk5x7qevk5e8qmty908hqp6xbdcnq78wsfc5h66s34cnk6et39regc7ae3n31tfgxswa1asgnnrare9fd0wpjvvknhsts2yhv1f5gjyx35edte9fd0wpjvtbkmf1t00";
  const ni::tU32 dataSize = GetTestDataStringSize(eTestDataString_PathFull);
  const ni::achar* const data = GetTestDataString(eTestDataString_PathFull);
...

  {
    ...
    fp->SeekSet(0);
    cString encoded =
      fp->ReadRawToString(eRawToStringEncoding_Base32, dataSize);
...

  {
    ...
    fp->SeekSet(0);
    cString encoded =
      fp->ReadRawToString(eRawToStringEncoding_Base64, dataSize);
    CHECK_EQUAL(dataSize, fp->Tell());
...
void EncodeBlockInvert(tU8* apData, const tInt anSize){
  niLoop (i, anSize){ apData[i] = ~apData[i];
}
}
;
...
TEST_FIXTURE(FBufferEncDec, EncInvert)
{
  ...
  const cString pathOut = UnitTest::GetTestOutputFilePath(
    m_testName, niFmt("%s_%d.bmp", m_testName, ++outputCount));
