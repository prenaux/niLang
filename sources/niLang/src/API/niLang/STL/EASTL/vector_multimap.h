...
///
  ...
  #define EASTL_VECTOR_MULTIMAP_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX                \
      " vector_multimap" // Unless the user overrides something, this is "EASTL vector_multimap".
#endif

/// EASTL_VECTOR_MULTIMAP_DEFAULT_ALLOCATOR
///
#ifndef EASTL_VECTOR_MULTIMAP_DEFAULT_ALLOCATOR
  #define EASTL_VECTOR_MULTIMAP_DEFAULT_ALLOCATOR \
    allocator_type(EASTL_VECTOR_MULTIMAP_DEFAULT_NAME)
#endif
...
class vector_multimap : public RandomAccessContainer {
 public:
  ...
  typedef vector_multimap<Key, T, Compare, Allocator, RandomAccessContainer>
    this_type;
 ...
 public:
  ...
  explicit vector_multimap(
    ...
    const allocator_type& allocator = EASTL_VECTOR_MULTIMAP_DEFAULT_ALLOCATOR);
...
template <typename K, typename T, typename C, typename A, typename RAC>
template <typename InputIterator>
inline vector_multimap<K, T, C, A, RAC>::vector_multimap(InputIterator first,
                                                         InputIterator last)
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_multimap<K, T, C, A, RAC>::this_type& vector_multimap<
  K, T, C, A, RAC>::operator=(const this_type& x)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_multimap<K, T, C, A, RAC>::this_type& vector_multimap<
  K, T, C, A, RAC>::operator=(this_type&& x)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_multimap<K, T, C, A, RAC>::this_type& vector_multimap<
  K, T, C, A, RAC>::operator=(std::initializer_list<value_type> ilist)
{
  base_type::clear();
  insert(ilist.begin(), ilist.end());
  return *this;
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_multimap<K, T, C, A, RAC>::key_compare& vector_multimap<
...
template <typename K, typename T, typename C, typename A, typename RAC>
template <class... Args>
inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<
  K, T, C, A, RAC>::emplace(Args&&... args)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<
  K, T, C, A, RAC>::insert(const value_type& value)
{
...
inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<
  K, T, C, A, RAC>::insert(P&& otherValue)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<
  K, T, C, A, RAC>::insert(const key_type& otherValue)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_multimap<K, T, C, A, RAC>::iterator vector_multimap<
  K, T, C, A, RAC>::insert(key_type&& otherValue)
{
  ...
  K, T, C, A, RAC>::insert(const_iterator position, const value_type& value)
{
  ...
  if ((position == end()) ||
      !mValueCompare(*position,
                     value)) // If value is <= the element at position...
  {
    if ((position == begin()) ||
        !mValueCompare(
          value,
          *(position - 1))) // If value is >= the element before position...
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline void vector_multimap<K, T, C, A, RAC>::insert(
  std::initializer_list<value_type> ilist)
{
  insert(ilist.begin(), ilist.end());
}
...
template <typename K, typename T, typename C, typename A, typename RAC>
template <typename InputIterator>
inline void vector_multimap<K, T, C, A, RAC>::insert(InputIterator first,
                                                     InputIterator last)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_multimap<K, T, C, A, RAC>::size_type vector_multimap<
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_multimap<K, T, C, A, RAC>::reverse_iterator
vector_multimap<K, T, C, A, RAC>::erase(const_reverse_iterator first,
                                        const_reverse_iterator last)
{
...
template <typename U, typename BinaryPredicate>
inline typename vector_multimap<K, T, C, A, RAC>::const_iterator
vector_multimap<K, T, C, A, RAC>::find_as(const U& u,
                                          BinaryPredicate predicate) const
{
  multimap_value_compare<U, value_type, BinaryPredicate> predicate_cmp(
    predicate);
  const eastl::pair<const_iterator, const_iterator> pairIts(
    eastl::equal_range(begin(), end(), u, predicate_cmp));
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline eastl::pair<typename vector_multimap<K, T, C, A, RAC>::iterator,
                   typename vector_multimap<K, T, C, A, RAC>::iterator>
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline eastl::pair<typename vector_multimap<K, T, C, A, RAC>::const_iterator,
                   typename vector_multimap<K, T, C, A, RAC>::const_iterator>
