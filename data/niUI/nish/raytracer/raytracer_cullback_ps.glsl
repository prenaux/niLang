...
nish_std_PixelOutput niUIGpuFuncs_raytracer_cullback_ps(nish_std_PixelInput aInput, niUIGpuFuncs_RayUniforms aUniforms, accelerationStructureEXT aAS);
...
nish_std_PixelOutput niUIGpuFuncs_raytracer_cullback_ps(nish_std_PixelInput aInput, niUIGpuFuncs_RayUniforms aUniforms, accelerationStructureEXT aAS) {
  ...
  niUIGpuFuncs_IntersectionResult intersection = niUIGpuFuncs_TraceRay_3_uint_RayDesc_RayInstances(nish_std_RayFlags_CullBackFacingTriangles,rayDesc,aAS);
  vec4 color;
...
// Pixel Shader main: niUIGpuFuncs_raytracer_cullback_ps
...
void main(void) {
  ...
  nish_std_PixelOutput _rval_ = niUIGpuFuncs_raytracer_cullback_ps(aInput, aUniforms, IN_1_aAS);
