...
class trans_viewport
{
 public:
  ...
  //-------------------------------------------------------------------
  void preserve_aspect_ratio(agg_real alignx,
                             agg_real aligny,
  ...
  //-------------------------------------------------------------------
  void device_viewport(agg_real x1, agg_real y1, agg_real x2, agg_real y2)
  {
    m_device_x1 = x1;
    m_device_y1 = y1;
    m_device_x2 = x2;
  ...
  //-------------------------------------------------------------------
  void world_viewport(agg_real x1, agg_real y1, agg_real x2, agg_real y2)
  {
    m_world_x1 = x1;
    m_world_y1 = y1;
    m_world_x2 = x2;
  ...
  //-------------------------------------------------------------------
  void device_viewport(agg_real* x1, agg_real* y1, agg_real* x2, agg_real* y2) const
  {
    *x1 = m_device_x1;
    *y1 = m_device_y1;
    *x2 = m_device_x2;
  ...
  //-------------------------------------------------------------------
  void world_viewport(agg_real* x1, agg_real* y1, agg_real* x2, agg_real* y2) const
  {
    *x1 = m_world_x1;
    *y1 = m_world_y1;
    *x2 = m_world_x2;
  ...
  //-------------------------------------------------------------------
  void world_viewport_actual(agg_real* x1, agg_real* y1,
                             agg_real* x2, agg_real* y2) const
  {
    *x1 = m_wx1;
    *y1 = m_wy1;
    *x2 = m_wx2;
  ...
  agg_real align_x()              const { return m_align_x; }
  agg_real align_y()              const { return m_align_y; }
  ...
  //-------------------------------------------------------------------
  void transform_scale_only(agg_real* x, agg_real* y) const
  {
    *x *= m_kx;
    *y *= m_ky;
  }
  ...
  //-------------------------------------------------------------------
  void inverse_transform_scale_only(agg_real* x, agg_real* y) const
  {
    *x /= m_kx;
    *y /= m_ky;
  }
  ...
  //-------------------------------------------------------------------
  agg_real device_dx() const { return m_dx1 - m_wx1 * m_kx; }
  agg_real device_dy() const { return m_dy1 - m_wy1 * m_ky; }

  //-------------------------------------------------------------------
  agg_real scale_x() const
  {
    return m_kx;
  }

  //-------------------------------------------------------------------
  agg_real scale_y() const
  {
    return m_ky;
  }
 ...
 private:
  ...
  agg_real         m_world_x2;
  agg_real         m_world_y2;
  agg_real         m_device_x1;
  agg_real         m_device_y1;
  agg_real         m_device_x2;
  agg_real         m_device_y2;
...
inline void trans_viewport::update()
{
  ...
  agg_real world_x1  = m_world_x1;
  agg_real world_y1  = m_world_y1;
  agg_real world_x2  = m_world_x2;
  agg_real world_y2  = m_world_y2;
  agg_real device_x1 = m_device_x1;
  agg_real device_y1 = m_device_y1;
  agg_real device_x2 = m_device_x2;
  agg_real device_y2 = m_device_y2;
