...
struct ras_conv_int
{
  ...
  static AGG_INLINE int mul_div(agg_real a, agg_real b, agg_real c)
  {
    return iround(a * b / c);
  }
  static int xi(int v) { return v; }
  static int yi(int v) { return v; }
  static int upscale(agg_real v) { return iround(v * poly_subpixel_scale); }
...
struct ras_conv_dbl
{
  typedef agg_real coord_type;
  static AGG_INLINE agg_real mul_div(agg_real a, agg_real b, agg_real c)
  {
    return a * b / c;
  }
  static int xi(agg_real v) { return iround(v * poly_subpixel_scale); }
  static int yi(agg_real v) { return iround(v * poly_subpixel_scale); }
  static agg_real upscale(agg_real v) { return v; }
  static agg_real downscale(int v)  { return v / agg_real(poly_subpixel_scale); }
};
...
struct ras_conv_dbl_3x
{
  ...
  static int xi(agg_real v) { return iround(v * poly_subpixel_scale * 3); }
  static int yi(agg_real v) { return iround(v * poly_subpixel_scale); }
  static agg_real upscale(agg_real v) { return v; }
  static agg_real downscale(int v)  { return v / agg_real(poly_subpixel_scale); }
};
