...
nish_std_RayPayload TestGpuFuncs_triangle_instanceid_rchit(nish_std_RayHitInfo aHitInfo, nish_std_RayGeometryIds aIds, nish_std_RayObjectParams aObject, nish_std_RayWorldParams aWorld, nish_std_RayParams aRay, nish_std_RayTransforms aTransforms);

// Function: TestGpuFuncs
nish_std_RayPayload TestGpuFuncs_triangle_instanceid_rchit(nish_std_RayHitInfo aHitInfo, nish_std_RayGeometryIds aIds, nish_std_RayObjectParams aObject, nish_std_RayWorldParams aWorld, nish_std_RayParams aRay, nish_std_RayTransforms aTransforms) {
  vec3 instanceColor = nish_std_UIntToHashColor((aIds.instanceImplIndex + 1));
...
void main(void) {
  ...
  nish_std_RayPayload _rval_ = TestGpuFuncs_triangle_instanceid_rchit(aHitInfo, aIds, aObject, aWorld, aRay, aTransforms);
