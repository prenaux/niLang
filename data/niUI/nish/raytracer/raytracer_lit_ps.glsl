...
nish_std_PixelOutput niUIGpuFuncs_raytracer_lit_ps(nish_std_PixelInput aInput, niUIGpuFuncs_RayUniforms aUniforms, accelerationStructureEXT aAS);
...
nish_std_PixelOutput niUIGpuFuncs_raytracer_lit_ps(nish_std_PixelInput aInput, niUIGpuFuncs_RayUniforms aUniforms, accelerationStructureEXT aAS) {
  ...
  vec4 color;
  bool _tmp_I5 = niUIGpuFuncs__op__gte_2__IntersectionTypeValue__IntersectionTypeValue(intersection.type,niUIGpuFuncs_IntersectionType_Triangle);
  if (_tmp_I5) {
    ...
    bool _tmp_i6 = niUIGpuFuncs__op__lt_2__IntersectionTypeValue__IntersectionTypeValue(intersection.type,niUIGpuFuncs_IntersectionType_None);
    if (_tmp_i6) {
  ...
  vec4 _tmp_w6 = color;
  return nish_std_PixelOutput_new(_tmp_w6);
}
...
// Pixel Shader main: niUIGpuFuncs_raytracer_lit_ps
...
void main(void) {
  ...
  nish_std_PixelOutput _rval_ = niUIGpuFuncs_raytracer_lit_ps(aInput, aUniforms, IN_1_aAS);
