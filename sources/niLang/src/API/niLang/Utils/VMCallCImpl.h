...
#define IDLC_BUF_TO_BASE(TYPE, VAR) ni::vmcall::BufRead(*aArgs__++, &VAR);
...
#define IDLC_STATIC_METH_BEGIN(NS, METH, ARITY)                               \
  IDLC_RET_TYPE VMCall_##METH(ni::iUnknown* apThis__, const ni::Var* aArgs__, \
                              const ni::tU32 aNumArgs__, ni::Var* apRet__)    \
  {                                                                           \
    if (aNumArgs__ != ARITY)                                                  \
...
#define IDLC_STATIC_METH_CALL(RET, NS, METH, ARITY, PARAMS) RET = METH PARAMS;
...
#define IDLC_METH_BEGIN(NS, INTF, METH, ARITY)                                \
  IDLC_RET_TYPE INTF##_##METH(ni::iUnknown* apThis__, const ni::Var* aArgs__, \
                              const ni::tU32 aNumArgs__, ni::Var* apRet__)    \
  {                                                                           \
...
#define IDLC_METH_INVALID_BEGIN(NS, INTF, METH, ARITY)                 \
  IDLC_RET_TYPE INTF##_##METH(ni::iUnknown*, const ni::Var*, ni::tU32, \
                              ni::Var*)                                \
  {
