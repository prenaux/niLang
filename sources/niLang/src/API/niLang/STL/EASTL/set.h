...
///
  ...
  #define EASTL_SET_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX    \
      " set" // Unless the user overrides something, this is "EASTL set".
#endif
...
///
  ...
  #define EASTL_MULTISET_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX         \
      " multiset" // Unless the user overrides something, this is "EASTL multiset".
#endif
...
///
  ...
  #define EASTL_MULTISET_DEFAULT_ALLOCATOR \
    allocator_type(EASTL_MULTISET_DEFAULT_NAME)
#endif
...
class set : public rbtree<Key, Key, Compare, Allocator, eastl::use_self<Key>,
                          false, true> {
 public:
  typedef rbtree<Key, Key, Compare, Allocator, eastl::use_self<Key>, false,
                 true>
    base_type;
 ...
 public:
  ...
  set(const Compare& compare,
      const allocator_type& allocator = EASTL_SET_DEFAULT_ALLOCATOR);
  ...
  set(
    Iterator itBegin,
    Iterator
      itEnd); // allocator arg removed because VC7.1 fails on the default arg. To do: Make a second version of this function without a default arg.
...
template <typename Key, typename Compare = eastl::less<Key>,
          typename Allocator = EASTLAllocatorType>
class multiset : public rbtree<Key, Key, Compare, Allocator,
                               eastl::use_self<Key>, false, false> {
 public:
  typedef rbtree<Key, Key, Compare, Allocator, eastl::use_self<Key>, false,
                 false>
    base_type;
 ...
 public:
  ...
  multiset(const Compare& compare,
           const allocator_type& allocator = EASTL_MULTISET_DEFAULT_ALLOCATOR);
...
template <typename Key, typename Compare, typename Allocator>
inline set<Key, Compare, Allocator>::set(const Compare& compare,
...
inline set<Key, Compare, Allocator>::set(
  std::initializer_list<value_type> ilist, const Compare& compare,
  const allocator_type& allocator)
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::value_compare set<
  Key, Compare, Allocator>::value_comp() const
{
  return mCompare;
}

template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::size_type set<
  Key, Compare, Allocator>::erase(const Key& k)
{
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::iterator set<
  Key, Compare, Allocator>::erase(const_iterator position)
{
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::iterator set<
  Key, Compare, Allocator>::erase(const_iterator first, const_iterator last)
{
  // We need to provide this version because we override another version
  // and C++ hiding rules would make the base version of this hidden.
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::size_type set<
  Key, Compare, Allocator>::count(const Key& k) const
{
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::reverse_iterator set<
  Key, Compare, Allocator>::erase(const_reverse_iterator position)
{
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::reverse_iterator set<
  Key, Compare, Allocator>::erase(const_reverse_iterator first,
                                  const_reverse_iterator last)
{
...
template <typename Key, typename Compare, typename Allocator>
inline multiset<Key, Compare, Allocator>::multiset(
  const allocator_type& allocator)
    : base_type(allocator)
{
}
...
template <typename Key, typename Compare, typename Allocator>
template <typename Iterator>
inline multiset<Key, Compare, Allocator>::multiset(Iterator itBegin,
                                                   Iterator itEnd)
...
template <typename Key, typename Compare, typename Allocator>
inline typename multiset<Key, Compare, Allocator>::value_compare multiset<
  Key, Compare, Allocator>::value_comp() const
{
  return mCompare;
}
...
template <typename Key, typename Compare, typename Allocator>
inline typename multiset<Key, Compare, Allocator>::size_type multiset<
  Key, Compare, Allocator>::erase(const Key& k)
{
...
template <typename Key, typename Compare, typename Allocator>
inline typename multiset<Key, Compare, Allocator>::iterator multiset<
  Key, Compare, Allocator>::erase(const_iterator position)
{
  // We need to provide this version because we override another version
  // and C++ hiding rules would make the base version of this hidden.
...
template <typename Key, typename Compare, typename Allocator>
inline typename multiset<Key, Compare, Allocator>::reverse_iterator multiset<
  Key, Compare, Allocator>::erase(const_reverse_iterator position)
{
  return reverse_iterator(erase((++position).base()));
}
