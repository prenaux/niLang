...
class span_interpolator_persp_exact
{
 public:
  ...
  span_interpolator_persp_exact(const agg_real* src, const agg_real* dst)
  {
  ...
  void begin(agg_real x, agg_real y, unsigned len)
  {
    ...
    agg_real xt = m_iterator.x;
    agg_real yt = m_iterator.y;
...
class span_interpolator_persp_lerp
{
 public:
  ...
  //--------------------------------------------------------------------
  // Arbitrary quadrangle transformations
  span_interpolator_persp_lerp(const agg_real* src, const agg_real* dst)
  {
    quad_to_quad(src, dst);
  }
