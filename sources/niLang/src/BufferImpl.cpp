  ...
  if (anSize > apBuffer->mnSize) {
    ...
    if (anSize >= Buffer_GetCapacity(apBuffer)) {
      if (apBuffer->mnSize == 0) {
        ...
        if (!Buffer_Reserve(
              apBuffer,
              ni::Max(anSize, (Buffer_GetCapacity(apBuffer) * 3) >> 1)))
          return eFalse;
      }
    }
...
tBool _AppendUTF(sBuffer* apBuffer, const _T* apData, tU32 anSizeInBytes,
                 tBool abAppendZero)
{
...
niExportFunc(tBool) Buffer_AppendUTF8(sBuffer* apBuffer, const cchar* apData,
                                      tU32 anSizeInBytes, tBool abAppendZero)
{
  return _AppendUTF<ni::utf8, ni::cchar, ni::utf8>(apBuffer, apData,
                                                   anSizeInBytes, abAppendZero);
}
niExportFunc(tBool) Buffer_AppendUTF8ToUTF16(sBuffer* apBuffer,
                                             const cchar* apData,
                                             tU32 anSizeInBytes,
                                             tBool abAppendZero)
{
  return _AppendUTF<ni::utf16, ni::cchar, ni::utf8>(
    apBuffer, apData, anSizeInBytes, abAppendZero);
}
niExportFunc(tBool) Buffer_AppendUTF8ToUTF32(sBuffer* apBuffer,
                                             const cchar* apData,
                                             tU32 anSizeInBytes,
                                             tBool abAppendZero)
{
  return _AppendUTF<ni::utf32, ni::cchar, ni::utf8>(
    apBuffer, apData, anSizeInBytes, abAppendZero);
}

niExportFunc(tBool) Buffer_AppendUTF16(sBuffer* apBuffer, const gchar* apData,
                                       tU32 anSizeInBytes, tBool abAppendZero)
{
  return _AppendUTF<ni::utf16, ni::gchar, ni::utf16>(
    apBuffer, apData, anSizeInBytes, abAppendZero);
}
niExportFunc(tBool) Buffer_AppendUTF16ToUTF8(sBuffer* apBuffer,
                                             const gchar* apData,
                                             tU32 anSizeInBytes,
                                             tBool abAppendZero)
{
  return _AppendUTF<ni::utf8, ni::gchar, ni::utf16>(
    apBuffer, apData, anSizeInBytes, abAppendZero);
}
niExportFunc(tBool) Buffer_AppendUTF16ToUTF32(sBuffer* apBuffer,
                                              const gchar* apData,
                                              tU32 anSizeInBytes,
                                              tBool abAppendZero)
{
  return _AppendUTF<ni::utf32, ni::gchar, ni::utf16>(
    apBuffer, apData, anSizeInBytes, abAppendZero);
}

niExportFunc(tBool) Buffer_AppendUTF32(sBuffer* apBuffer, const xchar* apData,
                                       tU32 anSizeInBytes, tBool abAppendZero)
{
  return _AppendUTF<ni::utf32, ni::xchar, ni::utf32>(
    apBuffer, apData, anSizeInBytes, abAppendZero);
}
niExportFunc(tBool) Buffer_AppendUTF32ToUTF8(sBuffer* apBuffer,
                                             const xchar* apData,
                                             tU32 anSizeInBytes,
                                             tBool abAppendZero)
{
  return _AppendUTF<ni::utf8, ni::xchar, ni::utf32>(
    apBuffer, apData, anSizeInBytes, abAppendZero);
}
niExportFunc(tBool) Buffer_AppendUTF32ToUTF16(sBuffer* apBuffer,
                                              const xchar* apData,
                                              tU32 anSizeInBytes,
                                              tBool abAppendZero)
{
  return _AppendUTF<ni::utf16, ni::xchar, ni::utf32>(
    apBuffer, apData, anSizeInBytes, abAppendZero);
}
