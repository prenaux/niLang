...
class rasterizer_scanline_aa {
 ...
 public:
  ...
  void gamma(const GammaF& gamma_function)
  {
    int i;
    for (i = 0; i < aa_scale; i++) {
      m_gamma[i] = uround(gamma_function(agg_real(i) / aa_mask) * aa_mask);
    }
  }
  ...
  void edge_d(agg_real x1, agg_real y1, agg_real x2, agg_real y2);
...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_scanline_aa<Clip>::clip_box(agg_real x1, agg_real y1,
...
{
  m_clipper.line_to(m_outline, conv_type::downscale(x),
...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_scanline_aa<Clip>::move_to_d(agg_real x, agg_real y)
{
  if (m_outline.sorted())
    reset();
  if (m_status == status_line_to)
...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_scanline_aa<Clip>::line_to_d(agg_real x, agg_real y)
{
...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_scanline_aa<Clip>::add_vertex(agg_real x, agg_real y,
                                              unsigned cmd)
{
  if (is_move_to(cmd)) {
    move_to_d(x, y);
...
void rasterizer_scanline_aa<Clip>::edge(int x1, int y1, int x2, int y2)
{
  ...
  m_clipper.line_to(m_outline, conv_type::downscale(x2),
...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_scanline_aa<Clip>::edge_d(agg_real x1, agg_real y1, agg_real x2,
                                          agg_real y2)
{
  if (m_outline.sorted())
    reset();
