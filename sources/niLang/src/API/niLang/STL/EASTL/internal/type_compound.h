...
// Until we revise the code below to handle EDG warnings, we don't have much choice but to disable them.
  ...
  #pragma diag_suppress = \
    1931 // operand of sizeof is not a type, variable, or dereferenced pointer expression
#endif
...
#define EASTL_TYPE_TRAIT_is_array_CONFORMANCE \
  1 // is_array is conforming; doesn't make mistakes.
...
struct is_array_of_unknown_bounds
    : public eastl::integral_constant<bool, eastl::is_array<T>::value &&
                                              (eastl::extent<T>::value == 0)> {
};
...
#define EASTL_TYPE_TRAIT_is_member_function_pointer_CONFORMANCE \
  1 // is_member_function_pointer is conforming; doesn't make mistakes.
...
template <typename T>
struct is_mem_fun_pointer_value : public false_type {};

template <typename R, typename T>
struct is_mem_fun_pointer_value<R (T::*)()> : public true_type {};
template <typename R, typename T>
struct is_mem_fun_pointer_value<R (T::*)() const> : public true_type {};
template <typename R, typename T>
struct is_mem_fun_pointer_value<R (T::*)() volatile> : public true_type {};
template <typename R, typename T>
struct is_mem_fun_pointer_value<R (T::*)() const volatile> : public true_type {
};

template <typename R, typename T, typename Arg0>
struct is_mem_fun_pointer_value<R (T::*)(Arg0)> : public true_type {};
template <typename R, typename T, typename Arg0>
struct is_mem_fun_pointer_value<R (T::*)(Arg0) const> : public true_type {};
template <typename R, typename T, typename Arg0>
struct is_mem_fun_pointer_value<R (T::*)(Arg0) volatile> : public true_type {};
template <typename R, typename T, typename Arg0>
struct is_mem_fun_pointer_value<R (T::*)(Arg0) const volatile>
    : public true_type {};

template <typename R, typename T, typename Arg0, typename Arg1>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1)> : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1) const> : public true_type {
};
template <typename R, typename T, typename Arg0, typename Arg1>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1) volatile>
    : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1) const volatile>
    : public true_type {};

template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2)> : public true_type {
};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2) const>
    : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2) volatile>
    : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2) const volatile>
    : public true_type {};
...
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3) volatile>
    : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3) const volatile>
    : public true_type {};
...
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4) volatile>
    : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4)
...
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4, typename Arg5>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4,
                                         Arg5) volatile> : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4, typename Arg5>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5)
                                  const volatile> : public true_type {};
...
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5,
                                         Arg6)> : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4, typename Arg5, typename Arg6>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5,
                                         Arg6) const> : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4, typename Arg5, typename Arg6>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5,
                                         Arg6) volatile> : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4, typename Arg5, typename Arg6>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5,
                                         Arg6) const volatile>
...
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          ...
          typename Arg7>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5,
                                         Arg6, Arg7)> : public true_type {};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4, typename Arg5, typename Arg6,
          typename Arg7>
struct is_mem_fun_pointer_value<R (T::*)(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5,
                                         Arg6, Arg7) const> : public true_type {
};
template <typename R, typename T, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4, typename Arg5, typename Arg6,
          typename Arg7>
...
#if EASTL_VARIABLE_TEMPLATES_ENABLED
template <typename T>
EA_CONSTEXPR bool is_member_function_pointer_v =
...
#define EASTL_TYPE_TRAIT_is_member_pointer_CONFORMANCE \
  1 // is_member_pointer is conforming; doesn't make mistakes.

template <typename T>
struct is_member_pointer
    : public eastl::integral_constant<
        bool, eastl::is_member_function_pointer<T>::value> {};

template <typename T, typename U>
struct is_member_pointer<U T::*> : public eastl::true_type {};
...
#define EASTL_TYPE_TRAIT_is_member_object_pointer_CONFORMANCE \
  1 // is_member_object_pointer is conforming; doesn't make mistakes.

template <typename T>
struct is_member_object_pointer
    : public eastl::integral_constant<
        bool, eastl::is_member_pointer<T>::value &&
                !eastl::is_member_function_pointer<T>::value> {};
#if EASTL_VARIABLE_TEMPLATES_ENABLED
template <typename T>
EA_CONSTEXPR bool is_member_object_pointer_v =
...
#define EASTL_TYPE_TRAIT_is_pointer_CONFORMANCE \
  1 // is_pointer is conforming; doesn't make mistakes.
...
template <typename T>
struct is_pointer_helper<T* const> : public true_type {};
template <typename T>
struct is_pointer_helper<T* volatile> : public true_type {};
template <typename T>
struct is_pointer_helper<T* const volatile> : public true_type {};

template <typename T>
struct is_pointer_value
    : public type_and<is_pointer_helper<T>::value,
                      type_not<is_member_pointer<T>::value>::value> {};
...
///////////////////////////////////////////////////////////////////////
  ...
  (defined(_MSC_VER) ||                               \
   (defined(EA_COMPILER_CLANG) && EA_COMPILER_HAS_FEATURE(is_convertible_to)))
  #define EASTL_TYPE_TRAIT_is_convertible_CONFORMANCE \
    1 // is_convertible is conforming.
...
template <typename From, typename To,
          bool = eastl::is_void<From>::value || eastl::is_function<To>::value ||
                 eastl::is_array<To>::value>
struct
  is_convertible_helper // Anything is convertible to void. Nothing is convertible to a function or an array.
{
...
class is_convertible_helper<From, To, false> {
  ...
  static void ToFunction(
    To1); // We try to call this function with an instance of From. It is valid if From can be converted to To.

  template <typename /*From1*/, typename /*To1*/>
  static eastl::no_type is(...);

  template <typename From1, typename To1>
  static decltype(ToFunction<To1>(eastl::declval<From1>()), eastl::yes_type())
  is(int);
...
///////////////////////////////////////////////////////////////////////
  ...
  (defined(_MSC_VER) || defined(EA_COMPILER_GNUC) ||  \
   (defined(EA_COMPILER_CLANG) && EA_COMPILER_HAS_FEATURE(is_union)))
  #define EASTL_TYPE_TRAIT_is_union_CONFORMANCE 1 // is_union is conforming.

template <typename T>
struct is_union : public integral_constant<bool, __is_union(T)> {};
#else
  #define EASTL_TYPE_TRAIT_is_union_CONFORMANCE \
    0 // is_union is not fully conforming.

template <typename T>
struct is_union : public false_type {};
#endif

#define EASTL_DECLARE_UNION(T)                    \
  namespace eastl {                               \
  template <>                                     \
...
#if EASTL_COMPILER_INTRINSIC_TYPE_TRAITS_AVAILABLE && \
  (defined(_MSC_VER) || defined(EA_COMPILER_GNUC) ||  \
   (defined(EA_COMPILER_CLANG) && EA_COMPILER_HAS_FEATURE(is_class)))
  #define EASTL_TYPE_TRAIT_is_class_CONFORMANCE 1 // is_class is conforming.

template <typename T>
struct is_class : public integral_constant<bool, __is_class(T)> {};
#elif defined(__EDG__)
  #define EASTL_TYPE_TRAIT_is_class_CONFORMANCE \
    EASTL_TYPE_TRAIT_is_union_CONFORMANCE

typedef char yes_array_type[1];
typedef char no_array_type[2];
template <typename U>
static yes_array_type& is_class_helper(void (U::*)());
template <typename U>
static no_array_type& is_class_helper(...);

template <typename T>
struct is_class
    : public integral_constant<bool, sizeof(is_class_helper<T>(0)) ==
                                         sizeof(yes_array_type) &&
                                       !is_union<T>::value> {};
#elif !defined(__GNUC__) || \
  (((__GNUC__ * 100) + __GNUC_MINOR__) >= 304) // Not GCC or GCC 3.4+
  #define EASTL_TYPE_TRAIT_is_class_CONFORMANCE \
    EASTL_TYPE_TRAIT_is_union_CONFORMANCE
...
#else
  #define EASTL_TYPE_TRAIT_is_class_CONFORMANCE \
    0 // is_class is not fully conforming.
...
#if EASTL_COMPILER_INTRINSIC_TYPE_TRAITS_AVAILABLE && \
  (defined(_MSC_VER) || defined(EA_COMPILER_GNUC) ||  \
   (defined(EA_COMPILER_CLANG) && EA_COMPILER_HAS_FEATURE(is_enum)))
...
struct is_enum_helper {
  template <typename T>
  struct nest : public is_convertible<T, int_convertible> {};
};

template <>
struct is_enum_helper<true> {
  template <typename T>
  struct nest : public false_type {};
};

template <typename T>
struct is_enum_helper2 {
  typedef type_or<is_arithmetic<T>::value, is_reference<T>::value,
                  is_class<T>::value>
    selector;
...
template <>
struct is_enum<void> : public false_type {};
template <>
struct is_enum<void const> : public false_type {};
template <>
struct is_enum<void volatile> : public false_type {};
template <>
struct is_enum<void const volatile> : public false_type {};
#endif
...
#if EASTL_COMPILER_INTRINSIC_TYPE_TRAITS_AVAILABLE && \
  (defined(_MSC_VER) || defined(EA_COMPILER_GNUC) ||  \
   (defined(EA_COMPILER_CLANG) && EA_COMPILER_HAS_FEATURE(is_polymorphic)))
  #define EASTL_TYPE_TRAIT_is_polymorphic_CONFORMANCE \
    1 // is_polymorphic is conforming.
...
#define EASTL_TYPE_TRAIT_is_object_CONFORMANCE  \
  (EASTL_TYPE_TRAIT_is_reference_CONFORMANCE && \
   EASTL_TYPE_TRAIT_is_void_CONFORMANCE &&      \
   EASTL_TYPE_TRAIT_is_function_CONFORMANCE)

template <typename T>
struct is_object : public integral_constant<bool, !is_reference<T>::value &&
                                                    !is_void<T>::value &&
                                                    !is_function<T>::value> {};
...
#define EASTL_TYPE_TRAIT_is_compound_CONFORMANCE \
  EASTL_TYPE_TRAIT_is_fundamental_CONFORMANCE
...
struct decay {
  ...
  typedef typename eastl::conditional<
    eastl::is_array<U>::value, typename eastl::remove_extent<U>::type*,
    typename eastl::conditional<
      eastl::is_function<U>::value, typename eastl::add_pointer<U>::type,
      typename eastl::remove_cv<U>::type>::type>::type type;
};
...
struct common_type<T, U> {
  typedef decay_t<decltype(true ? declval<T>() : declval<U>())>
    type; // The type of a tertiary expression is set by the compiler to be the common type of the two result types.
};

template <typename T, typename U, typename... V>
struct common_type<T, U, V...> {
  typedef
    typename common_type<typename common_type<T, U>::type, V...>::type type;
};
...
//
///////////////////////////////////////////////////////////////////////
#if EA_COMPILER_HAS_FEATURE(is_aggregate) || \
  defined(_MSC_VER) && (_MSC_VER >= 1916) // VS2017 15.9+
