...
nish_std_VertexOutput TestGpuFuncs_texture_vs(nish_std_VertexPAT1 aInput);
...
// Vertex Shader main: TestGpuFuncs_texture_vs
...
void main(void) {
  ...
  nish_std_VertexOutput _rval_ = TestGpuFuncs_texture_vs(aInput);
