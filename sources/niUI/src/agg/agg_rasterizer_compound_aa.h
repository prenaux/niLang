...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_compound_aa<Clip>::clip_box(agg_real x1, agg_real y1,
...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_compound_aa<Clip>::move_to_d(agg_real x, agg_real y)
{
  if (m_outline.sorted())
    reset();
...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_compound_aa<Clip>::line_to_d(agg_real x, agg_real y)
{
...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_compound_aa<Clip>::add_vertex(agg_real x, agg_real y,
                                              unsigned cmd)
{
  if (is_move_to(cmd)) {
    move_to_d(x, y);
...
//------------------------------------------------------------------------
template <class Clip>
void rasterizer_compound_aa<Clip>::edge_d(agg_real x1, agg_real y1, agg_real x2,
                                          agg_real y2)
{
  if (m_outline.sorted())
    reset();
...
unsigned rasterizer_compound_aa<Clip>::sweep_styles()
{
  for (;;) {
    ...
    while (num_cells--) {
      ...
      style_id =
        (curr_cell->right < 0) ? 0 : curr_cell->right - m_min_style + 1;
