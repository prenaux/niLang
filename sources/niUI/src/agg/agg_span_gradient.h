...
enum gradient_subpixel_scale_e {
  ...
  gradient_subpixel_scale =
    1 << gradient_subpixel_shift, //-----gradient_subpixel_scale
  gradient_subpixel_mask =
    gradient_subpixel_scale - 1 //-----gradient_subpixel_mask
};
...
class span_gradient {
 public:
  ...
  enum downscale_shift_e {
    downscale_shift =
      interpolator_type::subpixel_shift - gradient_subpixel_shift
  };
  ...
  span_gradient(interpolator_type& inter, const GradientF& gradient_function,
                const ColorF& color_function, agg_real d1, agg_real d2)
  ...
  agg_real d1() const
  {
    return agg_real(m_d1) / gradient_subpixel_scale;
  }
  agg_real d2() const
  {
    return agg_real(m_d2) / gradient_subpixel_scale;
  }
...
class gradient_radial_focus {
 public:
  ...
  //---------------------------------------------------------------------
  agg_real radius() const
  {
    return agg_real(m_radius) / gradient_subpixel_scale;
  }
  agg_real focus_x() const
  {
    return agg_real(m_focus_x) / gradient_subpixel_scale;
  }
  agg_real focus_y() const
  {
    return agg_real(m_focus_y) / gradient_subpixel_scale;
  }
...
class gradient_y {
 public:
  static int calculate(int, int y, int)
  {
    return y;
  }
};
