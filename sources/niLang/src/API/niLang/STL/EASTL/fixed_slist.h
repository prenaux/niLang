...
///
  ...
  #define EASTL_FIXED_SLIST_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX            \
      " fixed_slist" // Unless the user overrides something, this is "EASTL fixed_slist".
#endif

/// EASTL_FIXED_SLIST_DEFAULT_ALLOCATOR
///
#ifndef EASTL_FIXED_SLIST_DEFAULT_ALLOCATOR
  #define EASTL_FIXED_SLIST_DEFAULT_ALLOCATOR \
    overflow_allocator_type(EASTL_FIXED_SLIST_DEFAULT_NAME)
#endif
...
class fixed_slist
 ...
 public:
  ...
  fixed_slist(std::initializer_list<value_type> ilist,
...
inline fixed_slist<T, nodeCount, bEnableOverflow,
                   OverflowAllocator>::fixed_slist()
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline fixed_slist<T, nodeCount, bEnableOverflow, OverflowAllocator>::
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline fixed_slist<T, nodeCount, bEnableOverflow,
                   OverflowAllocator>::fixed_slist(size_type n)
    : base_type(fixed_allocator_type(mBuffer))
{
#if EASTL_NAME_ENABLED
  mAllocator.set_name(EASTL_FIXED_SLIST_DEFAULT_NAME);
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline fixed_slist<T, nodeCount, bEnableOverflow,
                   OverflowAllocator>::fixed_slist(const this_type& x)
    : base_type(fixed_allocator_type(mBuffer))
{
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline fixed_slist<T, nodeCount, bEnableOverflow,
                   OverflowAllocator>::fixed_slist(this_type&& x)
    : base_type(fixed_allocator_type(mBuffer))
{
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline fixed_slist<T, nodeCount, bEnableOverflow, OverflowAllocator>::
  fixed_slist(this_type&& x, const overflow_allocator_type& overflowAllocator)
    : base_type(fixed_allocator_type(mBuffer, overflowAllocator))
{
  // See comments above.
  mAllocator.copy_overflow_allocator(x.mAllocator);
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
template <typename InputIterator>
fixed_slist<T, nodeCount, bEnableOverflow, OverflowAllocator>::fixed_slist(
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline typename fixed_slist<T, nodeCount, bEnableOverflow,
                            OverflowAllocator>::this_type&
fixed_slist<T, nodeCount, bEnableOverflow, OverflowAllocator>::operator=(
  const this_type& x)
{
  if (this != &x) {
    base_type::clear();
    ...
    mAllocator =
      x.mAllocator; // The primary effect of this is to copy the overflow allocator.
#endif

    base_type::assign(
      x.begin(),
      x.end()); // It would probably be better to implement this like slist::operator=.
  }
  return *this;
}
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline void fixed_slist<T, nodeCount, bEnableOverflow, OverflowAllocator>::swap(
  this_type& x)
{
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline void fixed_slist<T, nodeCount, bEnableOverflow,
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline bool fixed_slist<T, nodeCount, bEnableOverflow,
                        OverflowAllocator>::full() const
{
  ...
  return !mAllocator
            .can_allocate(); // This is the quickest way of detecting this. has_overflowed uses a different method because it can't use this quick method.
}
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline const typename fixed_slist<T, nodeCount, bEnableOverflow,
                                  OverflowAllocator>::overflow_allocator_type&
fixed_slist<T, nodeCount, bEnableOverflow,
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline void fixed_slist<T, nodeCount, bEnableOverflow, OverflowAllocator>::
...
template <typename T, size_t nodeCount, bool bEnableOverflow,
          typename OverflowAllocator>
inline void swap(
  fixed_slist<T, nodeCount, bEnableOverflow, OverflowAllocator>& a,
