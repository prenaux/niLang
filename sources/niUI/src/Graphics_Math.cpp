...
///////////////////////////////////////////////
tF32 __stdcall cGraphics::ColorLuminanceEx(
  const sVec3f& aColor, const sVec3f& avLuminanceDistribution)
{
...
///////////////////////////////////////////////
sVec4f __stdcall cGraphics::ColorConvert(eColorSpace aSource, eColorSpace aDest,
                                         const sVec4f& aColor)
{
...
///////////////////////////////////////////////
sVec4f __stdcall cGraphics::ColorConvertEx(eColorSpace aSource,
                                           eColorSpace aDest,
                                           const sVec4f& aColor,
                                           const sVec4<tF32>& aXYZRef)
{
  ...
  for (tU32 i = 0; i < pColorEnumDef->mnNumValues; ++i) {
    ...
    tU32 diff =
      (v > nColor)
        ? v - nColor
        : nColor -
            v; // avoid overflow... probably not necessary, but for portability reason we make sure that their's no ambiguity
    if (diff <= nMinDiff) {
      nMinDiff = diff;
      nMinIndex = i;
      if (nMinDiff == 0)
...
sVec4f __stdcall cGraphics::GetCssColor4FromName(iHString* ahspName) const
{
  ...
  if (ni::HStringIsNotEmpty(ahspName)) {
    ...
    if (*p == '#') {
      ...
      tBool isRGBFloat =
        (*p == ':' || StrNICmp(p, "Vec", 3) == 0 || StrNCmp(p, "RGB", 3) == 0);
...
///////////////////////////////////////////////
sVec4f __stdcall cGraphics::GetCssColor4FromNameA(iHString* ahspName,
                                                  tF32 afAlpha) const
{
...
///////////////////////////////////////////////
sVec4f __stdcall cGraphics::GetColor4FromNameA(iHString* ahspName,
                                               tF32 afAlpha) const
{
...
///////////////////////////////////////////////
tF32 __stdcall cGraphics::DampedSpringGetDampingRatio(const tF32 Ks,
                                                      const tF32 Kd) const
{
...
///////////////////////////////////////////////
tF32 __stdcall cGraphics::DampedSpringComputeKdFromDampingRatio(
  const tF32 Ks, const tF32 E) const
{
  return ni::DampedSpringComputeKdFromDampingRatio(Ks, E);
}

///////////////////////////////////////////////
tF32 __stdcall cGraphics::DampedSpringAcceleration1(tF32 D, tF32 V,
                                                    const tF32 Ks,
                                                    const tF32 Kd) const
{
...
///////////////////////////////////////////////
sVec2f __stdcall cGraphics::DampedSpringAcceleration2(const sVec2f& D,
                                                      const sVec2f& V,
                                                      const tF32 Ks,
                                                      const tF32 Kd) const
{
...
///////////////////////////////////////////////
sVec3f __stdcall cGraphics::DampedSpringAcceleration3(const sVec3f& D,
                                                      const sVec3f& V,
                                                      const tF32 Ks,
                                                      const tF32 Kd) const
{
...
///////////////////////////////////////////////
sVec4f __stdcall cGraphics::DampedSpringAcceleration4(const sVec4f& D,
                                                      const sVec4f& V,
                                                      const tF32 Ks,
                                                      const tF32 Kd) const
{
...
///////////////////////////////////////////////
ni::iDampedSpring1* __stdcall cGraphics::CreateDampedSpring1(
...
///////////////////////////////////////////////
ni::iDampedSpring2* __stdcall cGraphics::CreateDampedSpring2(
  const tF32 Ks, const tF32 Kd) const
{
...
///////////////////////////////////////////////
ni::iDampedSpring3* __stdcall cGraphics::CreateDampedSpring3(
  const tF32 Ks, const tF32 Kd) const
{
...
///////////////////////////////////////////////
ni::iDampedSpring4* __stdcall cGraphics::CreateDampedSpring4(
  const tF32 Ks, const tF32 Kd) const
{
...
///////////////////////////////////////////////
ni::iDampedSpringPosition1* __stdcall cGraphics::CreateDampedSpringPosition1(
  const tF32 Ks, const tF32 Kd) const
{
...
///////////////////////////////////////////////
ni::iDampedSpringPosition2* __stdcall cGraphics::CreateDampedSpringPosition2(
  const tF32 Ks, const tF32 Kd) const
{
...
///////////////////////////////////////////////
ni::iDampedSpringPosition3* __stdcall cGraphics::CreateDampedSpringPosition3(
  const tF32 Ks, const tF32 Kd) const
{
...
///////////////////////////////////////////////
ni::iDampedSpringPosition4* __stdcall cGraphics::CreateDampedSpringPosition4(
  const tF32 Ks, const tF32 Kd) const
{
...
///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsSphereHammersleyEx(tVec3fCVec* apResults,
                                                     tI32 p1) const
{
  niAssert(tVec3fCVec::IsSameType(apResults));
  niCheckSilent(tVec3fCVec::IsSameType(apResults), ;);
  ni::UDPointsSphereHammersleyEx(apResults->_Data(), (tU32)apResults->size(),
                                 p1);
}

///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsSphereHalton(tVec3fCVec* apResults,
                                               tI32 p2) const
{
  niAssert(tVec3fCVec::IsSameType(apResults));
  niCheckSilent(tVec3fCVec::IsSameType(apResults), ;);
...
///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsSphereHaltonEx(tVec3fCVec* apResults, tI32 p1,
                                                 tI32 p2) const
{
  niAssert(tVec3fCVec::IsSameType(apResults));
  niCheckSilent(tVec3fCVec::IsSameType(apResults), ;);
  ni::UDPointsSphereHaltonEx(apResults->_Data(), (tU32)apResults->size(), p1,
                             p2);
}
...
///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsHemisphereHammersley(
  tVec3fCVec* apResults) const
{
  niAssert(tVec3fCVec::IsSameType(apResults));
  niCheckSilent(tVec3fCVec::IsSameType(apResults), ;);
...
///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsHemisphereHammersleyEx(tVec3fCVec* apResults,
                                                         tI32 p1) const
{
  niAssert(tVec3fCVec::IsSameType(apResults));
  niCheckSilent(tVec3fCVec::IsSameType(apResults), ;);
  ni::UDPointsHemisphereHammersleyEx(apResults->_Data(),
                                     (tU32)apResults->size(), p1);
}

///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsHemisphereHalton(tVec3fCVec* apResults,
                                                   tI32 p2) const
{
  niAssert(tVec3fCVec::IsSameType(apResults));
  niCheckSilent(tVec3fCVec::IsSameType(apResults), ;);
...
///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsHemisphereHaltonEx(tVec3fCVec* apResults,
                                                     tI32 p1, tI32 p2) const
{
  niAssert(tVec3fCVec::IsSameType(apResults));
  niCheckSilent(tVec3fCVec::IsSameType(apResults), ;);
  ni::UDPointsHemisphereHaltonEx(apResults->_Data(), (tU32)apResults->size(),
                                 p1, p2);
}
...
///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsPlaneHammersleyEx(tVec2fCVec* apResults,
                                                    tI32 p1) const
{
  niAssert(tVec2fCVec::IsSameType(apResults));
  niCheckSilent(tVec2fCVec::IsSameType(apResults), ;);
  ni::UDPointsPlaneHammersleyEx(apResults->_Data(), (tU32)apResults->size(),
                                p1);
}

///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsPlaneHalton(tVec2fCVec* apResults,
                                              tI32 p2) const
{
  niAssert(tVec2fCVec::IsSameType(apResults));
  niCheckSilent(tVec2fCVec::IsSameType(apResults), ;);
...
///////////////////////////////////////////////
void __stdcall cGraphics::UDPointsPlaneHaltonEx(tVec2fCVec* apResults, tI32 p1,
                                                tI32 p2) const
{
  niAssert(tVec2fCVec::IsSameType(apResults));
  niCheckSilent(tVec2fCVec::IsSameType(apResults), ;);
  ni::UDPointsPlaneHaltonEx(apResults->_Data(), (tU32)apResults->size(), p1,
                            p2);
}
