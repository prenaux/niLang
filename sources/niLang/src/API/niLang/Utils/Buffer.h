...
struct Buffer : public sBuffer {
  ...
  tBool AppendUTF8ToUTF16(const cchar* apData, tU32 anSizeInBytes,
                          tBool abAppendZero)
  {
    return Buffer_AppendUTF8ToUTF16(this, apData, anSizeInBytes, abAppendZero);
  }
  tBool AppendUTF8ToUTF32(const cchar* apData, tU32 anSizeInBytes,
                          tBool abAppendZero)
  {
  ...
  tBool AppendUTF16ToUTF8(const gchar* apData, tU32 anSizeInBytes,
                          tBool abAppendZero)
  {
    return Buffer_AppendUTF16ToUTF8(this, apData, anSizeInBytes, abAppendZero);
  }
  tBool AppendUTF16ToUTF32(const gchar* apData, tU32 anSizeInBytes,
                           tBool abAppendZero)
  {
  ...
  tBool AppendUTF32ToUTF8(const xchar* apData, tU32 anSizeInBytes,
                          tBool abAppendZero)
  {
    return Buffer_AppendUTF32ToUTF8(this, apData, anSizeInBytes, abAppendZero);
  }
  tBool AppendUTF32ToUTF16(const xchar* apData, tU32 anSizeInBytes,
                           tBool abAppendZero)
  {
