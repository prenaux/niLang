...
#include "VG.h"
#define CHECKDRIVER(RET) \
  if (!mptrDrv.IsOK())   \
    return RET;
#define CHECKMAINCTX(RET)      \
...
class cGraphics : public ImplRC<iGraphics> {
 public:
  ...
  iBitmapFormat* __stdcall CreateBitmapFormat(eBitmapType aType,
                                              const achar* aaszFormat,
                                              tU32 anNumMipMaps, tU32 anWidth,
                                              tU32 anHeight, tU32 anDepth);
  iBitmapFormat* __stdcall CreateBitmapFormatEx(eBitmapType aType,
                                                iPixelFormat* pFmt,
                                                tU32 anNumMipMaps, tU32 anWidth,
                                                tU32 anHeight, tU32 anDepth);
  iBitmapFormat* __stdcall CreateBitmapFormatEmpty();
  iBitmap2D* __stdcall CreateBitmap2DEx(tU32 nW, tU32 nH,
                                        iPixelFormat* pPixFmt);
  ...
  iBitmap3D* __stdcall CreateBitmap3DEx(tU32 ulW, tU32 ulH, tU32 ulD,
                                        iPixelFormat* pFmt);
  iBitmap3D* __stdcall CreateBitmap3D(tU32 ulW, tU32 ulH, tU32 ulD,
                                      const achar* aszPixFmt);
  iBitmap3D* __stdcall CreateBitmap3DMemoryEx(tU32 nW, tU32 nH, tU32 nD,
                                              iPixelFormat* pFmt,
                                              tU32 anRowPitch,
                                              tU32 anSlicePitch, tPtr ptrAddr,
                                              tBool bFreeAddr);
  iBitmap3D* __stdcall CreateBitmap3DMemory(tU32 nW, tU32 nH, tU32 nD,
                                            const achar* aszPixFmt,
                                            tU32 anRowPitch, tU32 anSlicePitch,
                                            tPtr ptrAddr, tBool bFreeAddr);
  iBitmapBase* __stdcall LoadBitmap(iFile* pFile);
  iBitmapBase* __stdcall LoadBitmapFromRes(iHString* ahspRes,
                                           iHString* ahspBasePath);
  iBitmapBase* __stdcall LoadBitmapEx(const achar* aaszFormat, iFile* pFile);
  tBool __stdcall SaveBitmap(const achar* aszFile, iBitmapBase* pBmp,
                             tU32 ulCompression = 0);
  tBool __stdcall SaveBitmapEx(const achar* aaszFormat, iFile* apFile,
                               iBitmapBase* apBmp, tU32 anCompression);
  cString __stdcall URLFindBitmapFilePath(const achar* aszRes,
                                          const achar* aszBasePath) niImpl;
  iFile* __stdcall OpenBitmapFile(const achar* aszRes,
  ...
  iGeometry* __stdcall CreateGeometryPolygonal(tU32 aulNumVertices,
                                               tU32 aulNumIndices,
                                               tGeometryCreateFlags aFlags,
                                               tFVF aFVF);
  iGeometry* __stdcall CreateGeometryPolygonalEx(iVertexArray* apVA,
                                                 iIndexArray* apIA);
  iGeometry* __stdcall CreateGeometryPolygonalCube(
    tGeometryCreateFlags aFlags, tFVF aFVF, const sVec3f& avCenter,
    tF32 afWidth, tBool abCW, tU32 aulColor, const sMatrixf& amtxUV);
  iGeometry* __stdcall CreateGeometryPolygonalPlane(
  ...
  iGeometry* __stdcall CreateGeometryPolygonalCylinder(
  ...
  iGeometry* __stdcall CreateGeometryPolygonalSphere(
    tGeometryCreateFlags aFlags, tFVF aFVF, tF32 radius, tI32 slices,
    tI32 stacks, tBool abCW, tU32 aulColor, const sMatrixf& amtxUV);
  iGeometry* __stdcall CreateGeometryPolygonalGeosphere(
    tGeometryCreateFlags aFlags, tFVF aFVF, tF32 radius, tI32 slices,
    tBool abCW, tU32 aulColor, const sMatrixf& amtxUV);
  iGeometry* __stdcall CreateGeometryPolygonalDiskSweep(
  ...
  tBool __stdcall UpdateGeometryPolygonalDiskSweep(
  ...
  iGeometry* __stdcall CreateGeometryPolygonalDisk(tGeometryCreateFlags aFlags,
                                                   tFVF aFVF, tF32 innerRadius,
                                                   tF32 outerRadius,
                                                   tI32 slices, tI32 stacks,
                                                   tBool abCW, tU32 aulColor,
                                                   const sMatrixf& amtxUV);
  iGeometryModifier* __stdcall CreateGeometryModifier(const achar* aszName,
  ...
  iGraphicsContextRT* __stdcall CreateContextForRenderTargets(iTexture* apRT0,
                                                              iTexture* apRT1,
                                                              iTexture* apRT2,
                                                              iTexture* apRT3,
                                                              iTexture* apDS);
  ...
  // GDRV_Textures.cpp
  tBool __stdcall CheckTextureFormat(iBitmapFormat* apFormat,
  ...
  iTexture* __stdcall CreateTexture(iHString* ahspName, eBitmapType aType,
                                    const achar* aaszFormat, tU32 anNumMipMaps,
                                    tU32 anWidth, tU32 anHeight, tU32 anDepth,
                                    tTextureFlags aFlags);
  iTexture* __stdcall CreateTextureFromBitmap(iHString* ahspName,
                                              iBitmapBase* apBitmap,
                                              tTextureFlags aFlags);
  iTexture* __stdcall CreateTextureFromRes(iHString* ahspRes,
                                           iHString* ahspBasePath,
                                           tTextureFlags aFlags);
  tBool __stdcall BlitBitmapToTexture(
  ...
  tBool __stdcall BlitBitmap3DToTexture(
    ...
    eTextureBlitFlags aFlags = eTextureBlitFlags_None);
  tBool __stdcall BlitTextureToBitmap3D(
  ...
  tBool __stdcall SerializeShaderConstants(iShaderConstants* apConsts,
                                           iDataTable* apDT,
                                           tSerializeFlags aFlags);

  iDeviceResourceManager* __stdcall GetShaderDeviceResourceManager()
    const niImpl;
  ...
  iVertexArray* __stdcall CreateVertexArray(tU32 anNumVertices, tFVF anFVF,
                                            eArrayUsage aUsage);

  // GDRV_IndexArray.cpp
  iIndexArray* __stdcall CreateIndexArray(eGraphicsPrimitiveType aPrimitiveType,
                                          tU32 anNumIndex,
  ...
  iRasterizerStates* __stdcall GetCompiledRasterizerStates(
    tIntPtr aHandle) const;
  iDepthStencilStates* __stdcall GetCompiledDepthStencilStates(
    tIntPtr aHandle) const;
  ...
  iTransform* __stdcall CreateTransform() const
  {
    return _CreateTransform();
  }
  static iFrustum* __stdcall _CreateFrustum();
  iFrustum* __stdcall CreateFrustum() const
  {
    return _CreateFrustum();
  }
  static iBoundingVolume* __stdcall _CreateAABB();
  iBoundingVolume* __stdcall CreateAABB() const
  {
    return _CreateAABB();
  }
  static iIntersection* __stdcall _CreateIntersection();
  iIntersection* __stdcall CreateIntersection() const
  {
    return _CreateIntersection();
  }
  static iCamera* __stdcall _CreateCamera();
  iCamera* __stdcall CreateCamera() const
  {
    return _CreateCamera();
  }

  tF32 __stdcall ColorLuminance(const sVec3f& aColor);
  tF32 __stdcall ColorLuminanceEx(const sVec3f& aColor,
  ...
  sVec4f __stdcall ColorConvert(eColorSpace aSource, eColorSpace aDest,
                                const sVec4f& aColor);
  sVec4f __stdcall ColorConvertEx(eColorSpace aSource, eColorSpace aDest,
                                  const sVec4f& aColor,
                                  const sVec4<tF32>& aXYZRef = kcolXYZRef2D65);
  ...
  sVec4f __stdcall GetCssColor4FromNameA(iHString* ahspName,
                                         tF32 afAlpha) const;

  tF32 __stdcall DampedSpringGetDampingRatio(const tF32 Ks,
                                             const tF32 Kd) const;
  tF32 __stdcall DampedSpringComputeKdFromDampingRatio(const tF32 Ks,
                                                       const tF32 E) const;
  tF32 __stdcall DampedSpringAcceleration1(tF32 D, tF32 V, const tF32 Ks,
                                           const tF32 Kd) const;
  sVec2f __stdcall DampedSpringAcceleration2(const sVec2f& D, const sVec2f& V,
                                             const tF32 Ks,
                                             const tF32 Kd) const;
  sVec3f __stdcall DampedSpringAcceleration3(const sVec3f& D, const sVec3f& V,
                                             const tF32 Ks,
                                             const tF32 Kd) const;
  sVec4f __stdcall DampedSpringAcceleration4(const sVec4f& D, const sVec4f& V,
                                             const tF32 Ks,
                                             const tF32 Kd) const;
  ni::iDampedSpring1* __stdcall CreateDampedSpring1(const tF32 Ks,
                                                    const tF32 Kd) const;
  ni::iDampedSpring2* __stdcall CreateDampedSpring2(const tF32 Ks,
                                                    const tF32 Kd) const;
  ni::iDampedSpring3* __stdcall CreateDampedSpring3(const tF32 Ks,
                                                    const tF32 Kd) const;
  ni::iDampedSpring4* __stdcall CreateDampedSpring4(const tF32 Ks,
                                                    const tF32 Kd) const;
  ni::iDampedSpringPosition1* __stdcall CreateDampedSpringPosition1(
    const tF32 Ks, const tF32 Kd) const;
  ni::iDampedSpringPosition2* __stdcall CreateDampedSpringPosition2(
    const tF32 Ks, const tF32 Kd) const;
  ni::iDampedSpringPosition3* __stdcall CreateDampedSpringPosition3(
    const tF32 Ks, const tF32 Kd) const;
  ni::iDampedSpringPosition4* __stdcall CreateDampedSpringPosition4(
    const tF32 Ks, const tF32 Kd) const;
  ...
  void __stdcall UDPointsSphereHammersleyEx(tVec3fCVec* apResults,
                                            tI32 p1) const;
  void __stdcall UDPointsSphereHalton(tVec3fCVec* apResults, tI32 p2 = 3) const;
  void __stdcall UDPointsSphereHaltonEx(tVec3fCVec* apResults, tI32 p1,
                                        tI32 p2) const;
  ...
  void __stdcall UDPointsHemisphereHammersleyEx(tVec3fCVec* apResults,
                                                tI32 p1) const;
  void __stdcall UDPointsHemisphereHalton(tVec3fCVec* apResults,
                                          tI32 p2 = 3) const;
  void __stdcall UDPointsHemisphereHaltonEx(tVec3fCVec* apResults, tI32 p1,
                                            tI32 p2) const;
  ...
  void __stdcall UDPointsPlaneHammersleyEx(tVec2fCVec* apResults,
                                           tI32 p1) const;
  void __stdcall UDPointsPlaneHalton(tVec2fCVec* apResults, tI32 p2 = 3) const;
  void __stdcall UDPointsPlaneHaltonEx(tVec2fCVec* apResults, tI32 p1,
                                       tI32 p2) const;
  ...
  iImageMap* __stdcall CreateImageMap(const achar* aaszBaseName,
                                      const achar* aaszPxf) niImpl;

  iFont* __stdcall CreateFont(iHString* ahspName, iFile* pFile) niImpl;
  iFont* __stdcall CreateFontFromBitmap(iHString* ahspName,
                                        iBitmap2D* pBmp) niImpl;
  ...
  tBool __stdcall RegisterSystemFont(iHString* ahspName, iHString* ahspFilePath,
                                     iFont* apFont) niImpl;
  ...
  iFont* __stdcall FindFont(iHString* ahspName,
                            tFontLoadFlags aFlags) const niImpl;
  ...
  Ptr<iVGImage> __stdcall CreateVGImageFromBitmapAndTexture(
  ...
  Ptr<iVGGradientTable> __stdcall CreateVGGradientTableTwoColors(
    const sColor4f& acolStart, const sColor4f& acolEnd);
  Ptr<iVGGradientTable> __stdcall CreateVGGradientTableStops(
    const tF32CVec* apOffsets, const tVec4fCVec* apColors);
  Ptr<iVGPaint> __stdcall CreateVGPaint(eVGPaintType aType);
  Ptr<iVGPaint> __stdcall CreateVGPaintSolid(const sColor4f& aColor);
  Ptr<iVGPaintImage> __stdcall CreateVGPaintImage(iVGImage* apImage,
                                                  eVGImageFilter aFilter,
                                                  eVGWrapType aWrap);
  Ptr<iVGPaintGradient> __stdcall CreateVGPaintGradient(
    eVGGradientType aType, iVGGradientTable* apGradientTable);
  Ptr<iVGPaintGradient> __stdcall CreateVGPaintGradientTwoColors(
    eVGGradientType aType, const sColor4f& acolStart, const sColor4f& acolEnd);
  Ptr<iVGPaintGradient> __stdcall CreateVGPaintGradientStops(
    eVGGradientType aType, const tF32CVec* apOffsets,
    const tVec4fCVec* apColors);
  ...
  iVideoDecoder* __stdcall CreateVideoDecoder(iHString* ahspName, iFile* apFile,
                                              tU32 aFlags) niImpl;
  //// iGraphics ////////////////////////////////
