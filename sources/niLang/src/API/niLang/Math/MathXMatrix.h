...
struct XMatrix {
 public:
  ...
  ///////////////////////////////////////////////
  inline XMatrix(const T& a00, const T& a01, const T& a02, const T& a10,
  ...
  ///////////////////////////////////////////////
  inline XMatrix(const XMatrix<N, 1, T>& xv, const XMatrix<N, 1, T>& yv,
  ...
  ///////////////////////////////////////////////
  inline XMatrix(const XMatrix<N, 1, T>& xv, const XMatrix<N, 1, T>& yv,
                 const XMatrix<N, 1, T>& zv, const XMatrix<N, 1, T>& wv)
  {
    SetVecX(xv);
    SetVecY(yv);
    SetVecZ(zv);
...
#define ImplementSpecializedConcat(X)                                      \
  ...
  ImplementSpecializedConcat(1) ImplementSpecializedConcat(2)
    ImplementSpecializedConcat(3) ImplementSpecializedConcat(4)
      ImplementSpecializedConcat(5) ImplementSpecializedConcat(6)
        ImplementSpecializedConcat(7) ImplementSpecializedConcat(8)
...
#undef ImplementSpecializedConcat
  ...
  inline XMatrix GenConvertedType(const tBool rowColumnSwap = eTrue,
                                  const tBool leftRightSwap = eFalse) const
  {
    niTAssert(N >= 3 && M >= 3);
  ...
  {
    return X();
  } // phi = rotational distance from the axis (like lattitude)
  inline T& Phi()
  {
    return X();
  }
  ///////////////////////////////////////////////
  inline const T& Theta() const
  {
    return Y();
  } // theta = rotation around the axis (like longitude)
  inline T& Theta()
  {
    return Y();
  }
  ...
  ///////////////////////////////////////////////
  inline const T& El(tU32 i) const
  {
    return mData[i];
  }
  ///////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////
  inline tU32 GetWidth() const
  {
    return N;
  }
  ///////////////////////////////////////////////
  inline tU32 GetHeight() const
  {
    return M;
  }
