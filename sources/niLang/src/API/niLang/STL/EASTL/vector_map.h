...
///
  ...
  #define EASTL_VECTOR_MAP_DEFAULT_NAME \
    EASTL_DEFAULT_NAME_PREFIX           \
      " vector_map" // Unless the user overrides something, this is "EASTL vector_map".
#endif
...
class vector_map : public RandomAccessContainer {
 public:
  ...
  typedef vector_map<Key, T, Compare, Allocator, RandomAccessContainer>
    this_type;
 ...
 protected:
  value_compare
    mValueCompare; // To do: Make this variable go away via the zero base size optimization.
 ...
 public:
  ...
  explicit vector_map(
    ...
    const allocator_type& allocator = EASTL_VECTOR_MAP_DEFAULT_ALLOCATOR);
  ...
  template <typename P, typename = eastl::enable_if_t<
  ...
  template <typename U, typename BinaryPredicate>
  eastl::pair<iterator, iterator> equal_range(const U& u,
                                              BinaryPredicate predicate);

  template <typename U, typename BinaryPredicate>
  eastl::pair<const_iterator, const_iterator> equal_range(
    const U& u, BinaryPredicate) const;
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline vector_map<K, T, C, A, RAC>::vector_map(const key_compare& comp,
...
template <typename K, typename T, typename C, typename A, typename RAC>
template <typename InputIterator>
inline vector_map<K, T, C, A, RAC>::vector_map(InputIterator first,
                                               InputIterator last)
    : base_type(EASTL_VECTOR_MAP_DEFAULT_ALLOCATOR)
    , mValueCompare(key_compare())
{
  insert(first, last);
}
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline vector_map<K, T, C, A, RAC>& vector_map<K, T, C, A, RAC>::operator=(
  const this_type& x)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline const typename vector_map<K, T, C, A, RAC>::key_compare& vector_map<
  K, T, C, A, RAC>::key_comp() const
{
  return mValueCompare.c;
}

template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::key_compare& vector_map<
  K, T, C, A, RAC>::key_comp()
{
  return mValueCompare.c;
}

template <typename K, typename T, typename C, typename A, typename RAC>
inline const typename vector_map<K, T, C, A, RAC>::value_compare& vector_map<
  K, T, C, A, RAC>::value_comp() const
{
  return mValueCompare;
}

template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::value_compare& vector_map<
  K, T, C, A, RAC>::value_comp()
{
  return mValueCompare;
}
...
template <typename K, typename T, typename C, typename A, typename RAC>
template <class... Args>
inline typename vector_map<K, T, C, A, RAC>::iterator vector_map<
  K, T, C, A, RAC>::emplace_hint(const_iterator position, Args&&... args)
{
#if EASTL_USE_FORWARD_WORKAROUND
  auto value = value_type(eastl::forward<Args>(
    args)...); // Workaround for compiler bug in VS2013 which results in a compiler internal crash while compiling this code.
...
vector_map<K, T, C, A, RAC>::insert(P&& otherValue)
{
  ...
  return eastl::pair<iterator, bool>(
    base_type::insert(itLB, eastl::move(value)), true);
}
...
template <typename K, typename T, typename C, typename A, typename RAC>
typename vector_map<K, T, C, A, RAC>::iterator vector_map<
  K, T, C, A, RAC>::insert(const_iterator position, const value_type& value)
{
  ...
  if ((position == end()) ||
      mValueCompare(
        value,
        *position)) // If the element at position is greater than value...
  {
    if ((position == begin()) ||
        mValueCompare(
          *(position - 1),
  ...
  const eastl::pair<typename vector_map<K, T, C, A, RAC>::iterator, bool>
    result = insert(value);
...
template <typename K, typename T, typename C, typename A, typename RAC>
typename vector_map<K, T, C, A, RAC>::iterator vector_map<
  K, T, C, A, RAC>::insert(const_iterator position, value_type&& value)
{
  if ((position == end()) ||
      mValueCompare(
        value,
  ...
  const eastl::pair<typename vector_map<K, T, C, A, RAC>::iterator, bool>
    result = insert(eastl::move(value));

  return result.first;
}

template <typename K, typename T, typename C, typename A, typename RAC>
inline void vector_map<K, T, C, A, RAC>::insert(
  std::initializer_list<value_type> ilist)
{
  insert(ilist.begin(), ilist.end());
}
...
template <typename K, typename T, typename C, typename A, typename RAC>
template <typename InputIterator>
inline void vector_map<K, T, C, A, RAC>::insert(InputIterator first,
                                                InputIterator last)
{
...
template <class M>
inline eastl::pair<typename vector_map<K, T, C, A, RAC>::iterator, bool>
vector_map<K, T, C, A, RAC>::insert_or_assign(const key_type& k, M&& obj)
{
  auto iter = find(k);
  if (iter == end()) {
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::iterator vector_map<
  K, T, C, A, RAC>::erase(const_iterator position)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::iterator vector_map<
  K, T, C, A, RAC>::erase(const_iterator first, const_iterator last)
{
  return base_type::erase(first, last);
}

template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::size_type vector_map<
  K, T, C, A, RAC>::erase(const key_type& k)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::reverse_iterator vector_map<
  K, T, C, A, RAC>::erase(const_reverse_iterator position)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::reverse_iterator vector_map<
  K, T, C, A, RAC>::erase(const_reverse_iterator first,
                          const_reverse_iterator last)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::iterator vector_map<
  K, T, C, A, RAC>::find(const key_type& k)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::const_iterator vector_map<
  K, T, C, A, RAC>::find(const key_type& k) const
{
...
template <typename U, typename BinaryPredicate>
inline typename vector_map<K, T, C, A, RAC>::iterator vector_map<
  K, T, C, A, RAC>::find_as(const U& u, BinaryPredicate predicate)
{
...
template <typename U, typename BinaryPredicate>
inline typename vector_map<K, T, C, A, RAC>::const_iterator vector_map<
  K, T, C, A, RAC>::find_as(const U& u, BinaryPredicate predicate) const
{
  const eastl::pair<const_iterator, const_iterator> pairIts(
    equal_range(u, predicate));
  return (pairIts.first != pairIts.second) ? pairIts.first : end();
}

template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::size_type vector_map<
  K, T, C, A, RAC>::count(const key_type& k) const
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::iterator vector_map<
  K, T, C, A, RAC>::lower_bound(const key_type& k)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::const_iterator vector_map<
  K, T, C, A, RAC>::lower_bound(const key_type& k) const
{
  return eastl::lower_bound(begin(), end(), k, mValueCompare);
}
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::iterator vector_map<
  K, T, C, A, RAC>::upper_bound(const key_type& k)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::const_iterator vector_map<
  K, T, C, A, RAC>::upper_bound(const key_type& k) const
{
  return eastl::upper_bound(begin(), end(), k, mValueCompare);
}

template <typename K, typename T, typename C, typename A, typename RAC>
inline eastl::pair<typename vector_map<K, T, C, A, RAC>::iterator,
...
vector_map<K, T, C, A, RAC>::equal_range(const key_type& k)
{
  ...
  if ((itLower == end()) ||
      mValueCompare(k, *itLower)) // If at the end or if (k is < itLower)...
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline eastl::pair<typename vector_map<K, T, C, A, RAC>::const_iterator,
                   typename vector_map<K, T, C, A, RAC>::const_iterator>
...
vector_map<K, T, C, A, RAC>::equal_range(const U& u, BinaryPredicate predicate)
{
  ...
  if ((itLower == end()) ||
      predicate_cmp(u, *itLower)) // If at the end or if (k is < itLower)...
    return eastl::pair<iterator, iterator>(itLower, itLower);
...
inline eastl::pair<typename vector_map<K, T, C, A, RAC>::const_iterator,
                   typename vector_map<K, T, C, A, RAC>::const_iterator>
vector_map<K, T, C, A, RAC>::equal_range(const U& u,
                                         BinaryPredicate predicate) const
{
  ...
  const const_iterator itLower(
    eastl::lower_bound(begin(), end(), u, predicate_cmp));
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::mapped_type& vector_map<
  K, T, C, A, RAC>::operator[](const key_type& k)
{
...
template <typename K, typename T, typename C, typename A, typename RAC>
inline typename vector_map<K, T, C, A, RAC>::mapped_type& vector_map<
  K, T, C, A, RAC>::operator[](key_type&& k)
{
  iterator itLB(lower_bound(k));
...
inline bool operator==(
  const vector_map<Key, T, Compare, Allocator, RandomAccessContainer>& a,
...
template <typename Key, typename T, typename Compare, typename Allocator,
          typename RandomAccessContainer>
inline void swap(
  vector_map<Key, T, Compare, Allocator, RandomAccessContainer>& a,
