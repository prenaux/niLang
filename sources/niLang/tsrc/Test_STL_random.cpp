...
TEST_FIXTURE(ASTL_random_independent_bits_engine, with_min_not_zero_engine)
{
  ...
  struct custom_engine {
    ...
    static constexpr ni::tU32 min()
    {
      return 100;
    }
    static constexpr ni::tU32 max()
    {
      return 200;
    }
    ni::tU32 operator()()
...
TEST_FIXTURE(ASTL_random_independent_bits_engine, with_32bit_engine)
{
  ...
  for (size_t w = 1; w <= 32; ++w) {
    ...
    for (int i = 0; i < 10; ++i) {
      ni::tU32 value = ind_engine();
      ni::tU32 max_value =
        (w == 32) ? 0xFFFFFFFFu : (ni::tU32)((1ull << w) - 1);
      // Check that the value is within the correct range
      CHECK(value <= max_value);
...
TEST_FIXTURE(ASTL_random_independent_bits_engine, with_64bit_engine)
{
  ...
  for (size_t w = 1; w <= 64; ++w) {
    ...
    for (int i = 0; i < 10; ++i) {
      ni::tU32 value = ind_engine();
      ni::tU32 max_value =
        (w == 64) ? 0xFFFFFFFFu : (ni::tU64)((1ull << w) - 1);
      // Check that the value is within the correct range
      CHECK(value <= max_value);
      // Check that bits beyond w are not set
...
TEST_FIXTURE(ASTL_random_uniform_int_distribution, SmallType32Bit)
{
  ...
  const int num_iterations =
    100000; // Increase sample size for better distribution
...
TEST_FIXTURE(ASTL_random_uniform_int_distribution, LargeType64Bit)
{
  ...
  const int num_iterations =
    1000000;                  // Increase sample size for better distribution
  ...
  // Simple uniformity check
  niLet min_count =
    *astl::min_element(bucket_counts.begin(), bucket_counts.end());
  niLet max_count =
    *astl::max_element(bucket_counts.begin(), bucket_counts.end());
...
{
  {
    static const ni::tU32 expected_values_seed42[10] = {
      1608637542ul, 3421126067ul, 4083286876ul, 787846414ul, 3143890026ul,
      3348747335ul, 2571218620ul, 2563451924ul, 670094950ul, 1914837113ul,
    };
...

  {
    static const ni::tU32 expected_values_seed123[10] = {
      2991312382ul, 3062119789ul, 1228959102ul, 1840268610ul, 974319580ul,
      2967327842ul, 2367878886ul, 3088727057ul, 3090095699ul, 2109339754ul,
    };
...
{
  {
    static const ni::tU64 expected_values_seed42[10] = {
      13930160852258120406ull, 11788048577503494824ull, 13874630024467741450ull,
      2513787319205155662ull,  16662371453428439381ull, 1735254072534978428ull,
      10598951352238613536ull, 6878563960102566144ull,  5052085463162682550ull,
...

  {
    static const ni::tU64 expected_values_seed123[10] = {
      5777523539921853504ull,  10256004525803361771ull, 17308305258728183101ull,
      13582745572890801790ull, 3549292889148046380ull,  3599698824668116388ull,
      17542111641530190888ull, 5357772020071635406ull,  15109402569541188053ull,
...
{
  {
    static const ni::tI64 expected_values_seed42[10] = {
      3553440125194606449ll,  -1850319953427250933ll, 2944846008281095542ll,
      2967949513766538177ll,  -871195780171771494ll,  8991170170311133055ll,
      5782326992556742051ll,  -6738130162589255370ll, 8429767824228939555ll,
...

  {
    static const ni::tI64 expected_values_seed123[10] = {
      -4048697855658168662ll, -7082651766117788805ll, 3890004149087476432ll,
      -5400778987231701158ll, -2592972133096244477ll, 6259147604711855511ll,
      3783169746704144679ll,  -7141846280920818374ll, -3186356822603128222ll,
...
{
  {
    static const ni::tI32 expected_values_seed42[10] = {
      827349751,  -430811186, 685650391,   691029595,  -202841075,
      2093419937, 1346302915, -1568843183, 1962708268, -1692671252,
    };
...

  {
    static const ni::tI32 expected_values_seed123[10] = {
      -942660928, -1649058370, 905712169,   -1257466848, -603723371,
      1457321365, 880837847,   -1662840667, -741881510,  196110699,
    };
...
{
  {
    static const ni::tF32 expected_values_seed42[10] = {
      0.022209f, 0.146437f, 0.887168f, 0.017177f, 0.555677f,
      0.440828f, 0.934513f, 0.834550f, 0.784466f, 0.742902f,
    };
    ...
    for (int i = 0; i < 10; ++i) {
      CHECK_CLOSE(expected_values_seed42[i], generated_values_seed42[i],
                  niEpsilon3);
    }
  }
...

  {
    static const ni::tF32 expected_values_seed123[10] = {
      0.008484f, 0.335387f, 0.754434f, 0.786164f, 0.244527f,
      0.809957f, 0.032432f, 0.191564f, 0.486658f, 0.025737f,
    };
    ...
    for (int i = 0; i < 10; ++i) {
      CHECK_CLOSE(expected_values_seed123[i], generated_values_seed123[i],
                  niEpsilon3);
    }
  }
}
...
{
  {
    static const ni::tF64 expected_values_seed42[10] = {
      0.022209, 0.146437, 0.887168, 0.017177, 0.555677,
      0.440828, 0.934513, 0.834550, 0.784466, 0.742902,
    };
...

  {
    static const ni::tF64 expected_values_seed123[10] = {
      0.008484, 0.335387, 0.754434, 0.786164, 0.244527,
      0.809957, 0.032432, 0.191564, 0.486658, 0.025737,
    };
