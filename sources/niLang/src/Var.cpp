...
niExportFunc(tInt) VarCompare(niConst Var* a, niConst Var* b)
{
  ...
  switch (niType(type)) {
  case eType_Null: return 0; // null == null
  case eType_I8:
  case eType_U8:
  case eType_AChar:
  ...
  case eType_I16:
  case eType_U16: return (tInt)a->mI16 - (tInt)b->mI16;
  case eType_I32:
  case eType_U32:
  case eType_F32: return (tInt)a->mI32 - (tInt)b->mI32;
  case eType_Vec2f:
  case eType_Vec2i:
  case eType_I64:
  case eType_U64:
  case eType_F64: return memcmp(a->mData, b->mData, 8);
  case eType_Vec3f:
  case eType_Vec3i: return memcmp(a->mData, b->mData, 12);
  case eType_String:
  case eType_Matrixf: return (tIntPtr)a->mpPointer - (tIntPtr)b->mpPointer;
  default:
  case eType_Vec4f:
  case eType_Vec4i:
  case eType_UUID: return memcmp(a->mData, b->mData, 16);
  }
}
...
niExportFunc(tBool) VarIsString(const Var& aVar)
{
  ...
  case eType_IUnknown:
    ...
    break;
  case eType_String: return eTrue;
  case eType_AChar: return niFlagIs(aVar.mType, eTypeFlags_Pointer);
  default: break;
  }
  return eFalse;
}
...
niExportFunc(void) VarToString(cString& str, const Var& aVar)
{
  ...
  case eType_String: str = aVar.GetString().Chars(); break;
  case eType_ASZ: str = aVar.mcpAChar; break;
  default: break;
  }
}
...
///////////////////////////////////////////////
static tBool _VarParseStringToType(const cString& str, Var& aVar,
                                   tType aDestType)
{
...
niExportFunc(tBool) VarConvertType(Var& aVar, tType aDestType)
{
  ...
  case eType_U64: {
    ...
    case eType_U16:
    case eType_U32:
    case eType_U64: bDstUnsigned = eTrue; break;
    }
    switch (srcType) {
    case eType_I8:
      ...
      if (bDstUnsigned)
        v = (tU8)v;
      break;
    case eType_U8: v = (tIntType)aVar.GetU8(); break;
    case eType_I16:
      v = (tIntType)aVar.GetI16();
      if (bDstUnsigned)
        v = (tU16)v;
      break;
    case eType_U16: v = (tIntType)aVar.GetU16(); break;
    case eType_I32:
      v = (tIntType)aVar.GetI32();
      if (bDstUnsigned)
        v = (tU32)v;
      break;
    case eType_U32: v = (tIntType)aVar.GetU32(); break;
    case eType_I64:
      v = (tIntType)aVar.GetI64();
      if (bDstUnsigned)
        v = (tU64)v;
      break;
    case eType_U64: v = (tIntType)aVar.GetU64(); break;
    case eType_IUnknown: v = (tIntType)aVar.GetIUnknownPointer(); break;
    }
    switch (dstType) {
    ...
    default: goto _conversion_failed;
    }
    return eTrue;
  }
  case eType_F32:
...
#define CONVERT_VECTOR_TYPE(TYPEDEF, TYPE, X, Y, Z, W)             \
  ...
  case eType_AChar: {
    return _VarParseStringToType(cString(aVar.GetACharConstPointer()), aVar,
                                 aDestType);
  }
  case eType_String: {
...
niExportFunc(tBool) VarSerializeWrite(iFile* apFile, const Var& aVar)
{
  if (niType(aVar.mType) == eType_IUnknown) {
    ...
    case eType_Vec2i:
      apFile->WriteLE32Array((tU32*)aVar.GetVec2i().ptr(), 2);
      break;
    case eType_Vec3i:
      apFile->WriteLE32Array((tU32*)aVar.GetVec3i().ptr(), 3);
      break;
    case eType_Vec4i:
      apFile->WriteLE32Array((tU32*)aVar.GetVec4i().ptr(), 4);
      break;
    ...
    case eType_Matrixf:
      apFile->WriteF32Array(aVar.GetMatrixf().ptr(), 16);
      break;
    default: break;
    }
  }
...
niExportFunc(tBool) VarSerializeRead(iFile* apFile, Var& aVar)
{
  ...
  if (niType(type) == eType_IUnknown) {
    ...
    case eType_Vec2i:
      aVar = sVec2i::Zero();
      apFile->ReadLE32Array((tU32*)aVar.mV2L, 2);
      break;
    case eType_Vec3i:
      aVar = sVec3i::Zero();
      apFile->ReadLE32Array((tU32*)aVar.mV3L, 3);
      break;
    case eType_Vec4i:
      aVar = sVec4i::Zero();
      apFile->ReadLE32Array((tU32*)aVar.mV4L, 4);
      break;
    case eType_Vec2f:
      aVar = sVec2f::Zero();
      apFile->ReadF32Array(aVar.mV2F, 2);
      break;
    case eType_Vec3f:
      aVar = sVec3f::Zero();
      apFile->ReadF32Array(aVar.mV3F, 3);
      break;
    case eType_Vec4f:
      aVar = sVec4f::Zero();
      apFile->ReadF32Array(aVar.mV4F, 4);
      break;
    case eType_Matrixf: {
      sMatrixf mtx;
    ...
    case eType_String: aVar = apFile->ReadBitsString(); break;
    default: return eFalse;
    }
  }
  return eTrue;
...
niExportFunc(tBool) VarSerializeReadRaw(iFile* apFile, Var& aVar)
{
  ...
  if (niType(type) == eType_IUnknown) {
    ...
    case eType_String: aVar = apFile->ReadString(); break;
    default: return eFalse;
    }
  }
  return eTrue;
