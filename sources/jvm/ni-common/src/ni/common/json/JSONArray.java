...
public class JSONArray {
    ...
    /**
     * Creates a new {@code JSONArray} by copying all values from the given list.
     * 
     * @throws JSONException if objects in the list are not of a valid JSON type.
     */
    public <T> JSONArray(final List<T> c) throws JSONException {
        this();
        for (final T item : c) {
            this.add(item);
        }
    ...
    /**
     * Creates a new {@code JSONArray} by copying all values from the given set.
     * 
     * @throws JSONException if objects in the set are not of a valid JSON type.
     */
    public <T> JSONArray(final Set<T> c) throws JSONException {
        this();
        for (final T item : c) {
            this.add(item);
        }
    ...
    /**
     * Adds all of the elements in the specified array to the end of this array.
     * 
     * @param a array containing elements to be added to this array 
     * @return this array.
     * @throws JSONException 
     */
    public JSONArray addAll(final JSONArray a) throws JSONException {
    ...
    /**
     * Adds {@code value} to the end of this array.
     *
     * @return this array.
     */
     ...
     * @return this array.
     */
    public JSONArray add(final double value) throws JSONException {
    ...
    public JSONObject toJSONObject(final JSONArray names) throws JSONException {
        ...
        final int length = Math.min(names.length(), values.size());
        if (length == 0) {
            return null;
        }
