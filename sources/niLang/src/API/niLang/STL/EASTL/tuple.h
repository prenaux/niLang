...
template <typename... Ts>
struct tuple_size<TupleTypes<Ts...>>
...
struct tuple_size<Internal::TupleImpl<Indices, Ts...>>
    : public integral_constant<size_t, sizeof...(Ts)> {};
...
struct tuple_element<I, Internal::TupleImpl<Indices, Ts...>>
    : public tuple_element<I, tuple<Ts...>> {};

template <size_t I, typename Indices, typename... Ts>
struct tuple_element<I, const Internal::TupleImpl<Indices, Ts...>>
    : public tuple_element<I, const tuple<Ts...>> {};

template <size_t I, typename Indices, typename... Ts>
struct tuple_element<I, volatile Internal::TupleImpl<Indices, Ts...>>
    : public tuple_element<I, volatile tuple<Ts...>> {};

template <size_t I, typename Indices, typename... Ts>
struct tuple_element<I, const volatile Internal::TupleImpl<Indices, Ts...>>
...
struct tuple_index<T, TupleTypes<>> {
  ...
  tuple_index() =
    delete; // tuple_index should only be used for compile-time assistance, and never be instantiated
...
class TupleLeaf<I, ValueType, true> : private ValueType {
 public:
  ...
  // is_constructible type trait incorrectly gives false for is_constructible<T&&, T&&>::value
  explicit TupleLeaf(ValueType&& v)
      : ValueType(eastl::forward<ValueType>(v))
  {
  }
...
//
template <size_t I, typename Indices, typename... Ts>
tuple_element_t<I, TupleImpl<Indices, Ts...>>& get(
  TupleImpl<Indices, Ts...>& t);

template <size_t I, typename Indices, typename... Ts>
const_tuple_element_t<I, TupleImpl<Indices, Ts...>>& get(
...
struct TupleImpl<integer_sequence<size_t, Indices...>, Ts...>
  ...
  TupleImpl(OtherTuple&& t)
      : TupleLeaf<Indices, Ts>(
          eastl::forward<
            tuple_element_t<Indices, MakeTupleTypes_t<OtherTuple>>>(
            get<Indices>(t)))...
  {
  }
  ...
  TupleImpl& operator=(OtherTuple&& t)
  {
    swallow(TupleLeaf<Indices, Ts>::operator=(
      eastl::forward<tuple_element_t<Indices, MakeTupleTypes_t<OtherTuple>>>(
        get<Indices>(t)))...);
    return *this;
  }
...
template <size_t I, typename Indices, typename... Ts>
inline tuple_element_t<I, TupleImpl<Indices, Ts...>>& get(
  TupleImpl<Indices, Ts...>& t)
{
...
template <size_t I, typename Indices, typename... Ts>
inline const_tuple_element_t<I, TupleImpl<Indices, Ts...>>& get(
  const TupleImpl<Indices, Ts...>& t)
{
  typedef tuple_element_t<I, TupleImpl<Indices, Ts...>> Type;
...
using TupleImplicitlyConvertible_t =
  enable_if_t<TupleImplicitlyConvertible<TargetTupleType, FromTypes...>::value,
              bool>;
...
using TupleExplicitlyConvertible_t =
  enable_if_t<TupleExplicitlyConvertible<TargetTupleType, FromTypes...>::value,
              bool>;
...
constexpr auto TupleThreeWay(const tuple<T1s...>& t1, const tuple<T2s...>& t2,
                             index_sequence<Is...> is)
{
  std::common_comparison_category_t<synth_three_way_result<T1s, T2s>...>
...
class tuple<T, Ts...> {
 public:
  ...
  EA_CONSTEXPR tuple(U&& u, Us&&... us)
      : mImpl(make_index_sequence<sizeof...(Us) + 1>{},
              Internal::MakeTupleTypes_t<tuple>{}, eastl::forward<U>(u),
              eastl::forward<Us>(us)...)
  {
  }
 ...
 private:
  typedef Internal::TupleImpl<make_index_sequence<sizeof...(Ts) + 1>, T, Ts...>
    Impl;
  Impl mImpl;
...
inline bool operator==(const tuple<T1s...>& t1, const tuple<T2s...>& t2)
{
  ...
  #if defined(EA_COMPILER_HAS_THREE_WAY_COMPARISON)
template <typename... T1s, typename... T2s>
inline constexpr std::common_comparison_category_t<
  synth_three_way_result<T1s, T2s>...>
operator<=>(const tuple<T1s...>& t1, const tuple<T2s...>& t2)
{
...
struct TupleCat2Impl<tuple<T1s...>, index_sequence<I1s...>, tuple<T2s...>,
  ...
  {
    return ResultType(get<I1s>(eastl::forward<Tuple1>(t1))...,
                      get<I2s>(eastl::forward<Tuple2>(t2))...);
  }
};
...
struct TupleCat<Tuple1, Tuple2, TuplesRest...> {
  ...
  using ResultType =
    typename TupleCat<FirstResultType, TuplesRest...>::ResultType;
...
struct TupleCat<Tuple1, Tuple2> {
  ...
  static inline ResultType DoCat(TupleArg1&& t1, TupleArg2&& t2)
  {
    return TC2::DoCat2(eastl::forward<TupleArg1>(t1),
                       eastl::forward<TupleArg2>(t2));
  }
};
...
//
template <typename... Tuples>
inline typename Internal::TupleCat<eastl::remove_cvref_t<Tuples>...>::ResultType
tuple_cat(Tuples&&... ts)
{
  return Internal::TupleCat<eastl::remove_cvref_t<Tuples>...>::DoCat(
    eastl::forward<Tuples>(ts)...);
}
...
//
template <typename... Ts>
inline EA_CONSTEXPR tuple<Internal::MakeTupleReturn_t<Ts>...> make_tuple(
  Ts&&... values)
{
  return tuple<Internal::MakeTupleReturn_t<Ts>...>(
    eastl::forward<Ts>(values)...);
}
...
EA_CONSTEXPR decltype(auto) apply(F&& f, Tuple&& t)
{
  return detail::apply_impl(
    eastl::forward<F>(f), eastl::forward<Tuple>(t),
...
namespace std {
template <class... Ts>
struct tuple_size<::eastl::tuple<Ts...>>
    : public ::eastl::integral_constant<size_t, sizeof...(Ts)> {};

template <size_t I, class... Ts>
struct tuple_element<I, ::eastl::tuple<Ts...>>
    : public ::eastl::tuple_element<I, ::eastl::tuple<Ts...>> {};
} // namespace std
  #endif
