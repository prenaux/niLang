...
int __cdecl vecop_transform_coord(HSQUIRRELVM v)
{
  ...
  switch (sizeof(T)) {
    ...
    default: {
      return sq_throwerror(v,niFmt(_A("vecop_transform_coord: Unknown this type.")));
    }
  }
...
SQRegFunction SQSharedState::_vec4f_default_delegate_funcz[]={
  ...
  {"frame_bottom_border",  rect_frameBottomBorder,          2,  NULL, _HC(typestr_float)},
  {"GetFrameBottomBorder", rect_frameBottomBorder,          2,  NULL, _HC(typestr_float)},
