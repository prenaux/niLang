...
class cFileImpl : public ImplRC<iFile, eImplFlags_Default> {
 ...
 public:
  ...
  {
    return mptrBase->GetFileFlags() | mnFlags;
  }
  inline tBool __stdcall GetCanRead() const
  {
    tFileFlags flags = GetFileFlags();
    return niFlagIs(flags, eFileFlags_Read);
  }
  inline tBool __stdcall GetCanWrite() const
  {
    tFileFlags flags = GetFileFlags();
    return niFlagIs(flags, eFileFlags_Write);
  }
  inline tBool __stdcall GetCanSeek() const
  {
    tFileFlags flags = GetFileFlags();
    return niFlagIsNot(flags, eFileFlags_NoSeek);
  }
  inline tBool __stdcall GetPartialRead() const
  {
    tFileFlags flags = GetFileFlags();
    return niFlagIs(flags, eFileFlags_PartialRead);
  }
  inline tBool __stdcall GetPartialWrite() const
  {
    tFileFlags flags = GetFileFlags();
    return niFlagIs(flags, eFileFlags_PartialWrite);
  }
  inline tBool __stdcall GetIsEncoder() const
  {
    tFileFlags flags = GetFileFlags();
    return niFlagIs(flags, eFileFlags_Encoder);
  }
  inline tBool __stdcall GetIsDummy() const
  {
    tFileFlags flags = GetFileFlags();
    return niFlagIs(flags, eFileFlags_Dummy);
  }
  inline tBool __stdcall GetIsMemory() const
  {
    return mptrMem.IsOK();
  }
  inline tBool __stdcall GetIsStream() const
  {
    tFileFlags flags = GetFileFlags();
    return niFlagIs(flags, eFileFlags_Stream);
  }

  ///////////////////////////////////////////////
  inline tPtr __stdcall GetBase() const
  {
    return mptrMem.IsOK() ? mptrMem->GetBase() : NULL;
  }
  inline tPtr __stdcall GetHere() const
  {
    return mptrMem.IsOK() ? mptrMem->GetHere() : NULL;
  }
  inline tPtr __stdcall GetStop() const
  {
    return mptrMem.IsOK() ? mptrMem->GetStop() : NULL;
  }
  inline tBool __stdcall SetMemPtr(tPtr apMem, tSize anSize, tBool abFree,
                                   tBool abKeepHere)
  {
    if (!mptrMem.IsOK())
      return eFalse;
  ...
  inline tBool __stdcall BeginTextFileRead(tBool abSeekSetZero)
  {
    if (abSeekSetZero)
      SeekSet(0);
    mFormat = TextEncodingFormatGet(this, eTrue,
                                    (mFormat == eTextEncodingFormat_Unknown
  ...
  inline tBool __stdcall BeginTextFileWrite(eTextEncodingFormat aFormat,
                                            tBool abSeekSetZero)
  {
    if (abSeekSetZero)
      SeekSet(0);
    if (aFormat != eTextEncodingFormat_Unknown)
      mFormat = aFormat;
  ...
  {
    return TextEncodingFormatWriteString(this, GetTextEncodingFormat(),
                                         aaszString, eFalse);
  }
  ...
  inline tSize __stdcall WriteStringEx(eTextEncodingFormat aFmt,
                                       const achar* aaszString)
  {
    return TextEncodingFormatWriteString(this, aFmt, aaszString, eFalse);
  }
  inline tSize __stdcall WriteStringZEx(eTextEncodingFormat aFmt,
                                        const achar* aaszString)
  {
  ...
  ///////////////////////////////////////////////
  inline void __stdcall WriteBits(tPtr apData, tU32 anBits,
  ...
  ///////////////////////////////////////////////
  inline void __stdcall ReadBits(tPtr apData, tU32 anBits,
                                 tBool abInvertBytesOrder)
  {
    if (anBits <= 0)
      return;
  ...
  {
    if (ReadBit())
      return ReadBitsPackedU48();
    else
      return ReadBitsU64(64);
  }
  ...
  {
    if (ReadBit())
      return ReadBitsPackedU32();
    else
      return ReadBitsU64(48);
  }
  ...
  {
    if (ReadBit())
      return ReadBitsPackedU24();
    else
      return ReadBitsU32(32);
  }
  ...
  {
    if (ReadBit())
      return ReadBitsPackedU16();
    else
      return ReadBitsU32(24);
  }
  ...
  {
    if (ReadBit())
      return ReadBitsPackedU8();
    else
      return ReadBitsU16(16);
  }
  ...
  {
    if (ReadBit())
      return ReadBitsPackedI48();
    else
      return ReadBitsI64(64);
  }
  ...
  {
    if (ReadBit())
      return ReadBitsPackedI32();
    else
      return ReadBitsI64(48);
  }
  ...
  {
    if (ReadBit())
      return ReadBitsPackedI24();
    else
      return ReadBitsI32(32);
  }
  ...
  {
    if (ReadBit())
      return ReadBitsPackedI16();
    else
      return ReadBitsI32(24);
  }
  ...
  {
    if (ReadBit())
      return ReadBitsPackedI8();
    else
      return ReadBitsI16(16);
  }
  ...
  {
    return TextEncodingFormatWriteString(this, eTextEncodingFormat_BitStream,
                                         aaszIn, eTrue);
  }
                                            ...
                                            const achar* apSrc)
  {
    ...
    case eRawToStringEncoding_Hex: {
      ...
      const tInt ws =
        HexDecode(buffer.begin(), (tInt)buffer.size(), apSrc, slen);
    ...
    case eRawToStringEncoding_Base64: {
      ...
      sWriteBufferToFile buffer(this, sz);
      const tInt ws =
        Base64Decode(buffer.begin(), (tInt)buffer.size(), apSrc, slen);
      return buffer.commit(ws);
    }
    case eRawToStringEncoding_Base32: {
      ...
      sWriteBufferToFile buffer(this, sz);
      const tInt ws =
        Base32Decode(buffer.begin(), (tInt)buffer.size(), apSrc, slen);
      return buffer.commit(ws);
    }
    }
    return 0;
...
class cFileMem : public ImplRC<iFileBase, eImplFlags_Default, iFileMemory> {
 public:
  ...
  ///////////////////////////////////////////////
  virtual tBool __stdcall SetMemPtr(tPtr pMem, tSize nSize, tBool bFree,
                                    tBool bKeepHere)
  {
    tU8* pOldBase = mpBase;
    mpBase = pMem;
  ...
  inline tBool __stdcall Resize(tI64)
  {
    return eFalse;
  }
...
class cFileDynamicMem
    : public ImplRC<iFileBase, eImplFlags_Default, iFileMemory> {
 public:
  ...
  tSize __stdcall WriteRaw(const void* pIn, tSize nSize)
  {
    if (this->mpHere + nSize > this->mpStop) {
      ...
      if (newsize >= this->mvData.size()) {
        this->mvData.resize(ni::Max(
          tSize(newsize), tSize(this->mvData.size() + this->mnBaseSize)));
      }
  ...
  ///////////////////////////////////////////////
  tBool __stdcall SetMemPtr(tPtr apMem, tSize anSize, tBool abFree,
                            tBool abKeepHere)
  {
    niUnused(apMem);
    niUnused(anSize);
  ...
  inline tBool __stdcall SeekEnd(tI64 offset)
  {
    return this->SeekSet((offset < this->GetSize()) ? (this->GetSize() - offset)
                                                    : 0);
  }
...
class cFileWindow : public ImplRC<iFileBase, eImplFlags_Default> {
 public:
  ///////////////////////////////////////////////
  cFileWindow(iFileBase* apBase, tI64 anBase, tI64 anSize,
...
/////////////////////////////////////////////////////////////////
niExportFunc(iFileBase*) CreateFileBaseMemory(tPtr pMem, tSize nSize,
                                              tBool bFree, const achar* aszPath)
{
  return niNew cFileMem(pMem, nSize, bFree, aszPath);
}
niExportFunc(iFile*) CreateFileMemory(tPtr pMem, tSize nSize, tBool bFree,
                                      const achar* aszPath)
{
...
/////////////////////////////////////////////////////////////////
niExportFunc(iFileBase*) CreateFileBaseMemoryAlloc(tSize nSize,
                                                   const achar* aszPath)
{
...
/////////////////////////////////////////////////////////////////
niExportFunc(iFileBase*) CreateFileBaseDynamicMemory(tSize anSize,
                                                     const achar* aszPath)
{
...
/////////////////////////////////////////////////////////////////
niExportFunc(iFileBase*) CreateFileBaseWindow(iFileBase* apBase, tI64 anBase,
                                              tI64 anSize,
...
niExportFunc(iFile*) CreateFileWindow(iFileBase* apBase, tI64 anBase,
                                      tI64 anSize, const achar* aaszPath,
                                      tBool abAutoSeekSet)
{
  niCheckIsOK(apBase, NULL);
  return ni::CreateFile(
    CreateFileBaseWindow(apBase, anBase, anSize, aaszPath, abAutoSeekSet));
}
