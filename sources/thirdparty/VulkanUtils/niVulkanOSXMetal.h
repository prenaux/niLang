...
#define vkCmdBuildAccelerationStructuresKHR __vkCmdBuildAccelerationStructuresKHR_NotSupportedInMoltenVK__
#define vkCmdTraceRaysKHR __vkCmdTraceRaysKHR_NotSupportedInMoltenVK__
#define vkCreateAccelerationStructureKHR __vkCreateAccelerationStructureKHR_NotSupportedInMoltenVK__
#define vkCreateRayTracingPipelinesKHR __vkCreateRayTracingPipelinesKHR_NotSupportedInMoltenVK__
#define vkDestroyAccelerationStructureKHR __vkDestroyAccelerationStructureKHR_NotSupportedInMoltenVK__
#define vkGetAccelerationStructureBuildSizesKHR __vkGetAccelerationStructureBuildSizesKHR_NotSupportedInMoltenVK__
#define vkGetAccelerationStructureDeviceAddressKHR __vkGetAccelerationStructureDeviceAddressKHR_NotSupportedInMoltenVK__
#define vkGetRayTracingShaderGroupHandlesKHR __vkGetRayTracingShaderGroupHandlesKHR_NotSupportedInMoltenVK__
