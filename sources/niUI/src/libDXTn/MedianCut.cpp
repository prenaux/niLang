...
void MedianCut::BuildTree(CodeBook &Codes, long TreeSize)
{
  ...
  while(!bFinished)
  {
    ...
    pNode->SplitAxis = (ni::tU8)Axis;
    pNode->SplitPoint = (ni::tU8)Split;
...
ni::tBool TreeNode::Encloses(cbVector &Vect)
{
  long i;
