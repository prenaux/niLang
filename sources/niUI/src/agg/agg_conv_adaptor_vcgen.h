...
{
  void remove_all() {}
  void add_vertex(agg_real, agg_real, unsigned) {}
  void prepare_src() {}

  void rewind(unsigned) {}
  unsigned vertex(agg_real*, agg_real*) { return path_cmd_stop; }
};
...
unsigned conv_adaptor_vcgen<VertexSource, Generator, Markers>::vertex(agg_real* x, agg_real* y)
{
