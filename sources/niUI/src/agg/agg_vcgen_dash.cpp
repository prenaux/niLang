...
//------------------------------------------------------------------------
void vcgen_dash::add_dash(agg_real dash_len, agg_real gap_len)
{
...
//------------------------------------------------------------------------
void vcgen_dash::dash_start(agg_real ds)
{
  m_dash_start = ds;
...
//------------------------------------------------------------------------
void vcgen_dash::calc_dash_start(agg_real ds)
{
  m_curr_dash = 0;
  m_curr_dash_start = 0.0;
  while (ds > 0.0) {
...
//------------------------------------------------------------------------
void vcgen_dash::add_vertex(agg_real x, agg_real y, unsigned cmd)
{
  m_status = initial;
  if (is_move_to(cmd)) {
...
//------------------------------------------------------------------------
unsigned vcgen_dash::vertex(agg_real* x, agg_real* y)
{
  ...
  while (!is_stop(cmd)) {
    ...
    case polyline: {
      agg_real dash_rest = m_dashes[m_curr_dash] - m_curr_dash_start;
