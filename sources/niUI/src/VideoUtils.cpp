...
{
  return StrEndsWith(aaszFileName, ".avi") ||
...
tBool Video_FileNameIsVideoTheoraPlayer(const char* aaszFileName)
{
  return StrEndsWith(aaszFileName, ".ogv") ||
         StrEndsWith(aaszFileName, ".ogw") ||
         StrEndsWith(aaszFileName, ".mp4") ||
         StrEndsWith(aaszFileName, ".mkv") || StrEndsWith(aaszFileName, ".wmv");
}
  #endif
...
///////////////////////////////////////////////
iVideoDecoder* __stdcall cGraphics::CreateVideoDecoder(
  iHString* ahspName, iFile* apFile, tVideoDecoderFlags aFlags)
{
