...
namespace eastl
{
	...
	{
		niPanicAssertMsg(Extent == dynamic_extent || Extent == mnSize, "impossible to create a span with a fixed Extent different than the size of the supplied buffer");
	}
	...
	{
		niPanicAssertMsg(!empty(),          "undefined behavior accessing an empty span");
		niPanicAssertMsg(bounds_check(idx), "undefined behavior accessing out of bounds");
	...
	{
		niPanicAssertMsg(Count <= size(), "undefined behavior accessing out of bounds");
	...
	{
		niPanicAssertMsg(Offset <= size(),                                       "undefined behaviour accessing out of bounds");
		niPanicAssertMsg(Count == dynamic_extent || Count <= (size() - Offset), "undefined behaviour exceeding size of span");
