...
///////////////////////////////////////////////
template <typename T>
inline sVec3<T>& VecClamp(sVec3<T>& Out, const sVec3<T>& V,
...
// pA + pB*pC
template <class T>
sVec3<T>& VecMAD(sVec3<T>& Out, const sVec3<T>& A, const sVec3<T>& B,
                 const sVec3<T>& C)
{
  Out.x = (A.x * B.x) + C.x;
  Out.y = (A.y * B.y) + C.y;
...
// pA + pB*scale
template <class T>
sVec3<T>& VecMAD(sVec3<T>& Out, const sVec3<T>& A, const T scale,
                 const sVec3<T>& B)
{
  Out.x = (A.x * scale) + B.x;
  Out.y = (A.y * scale) + B.y;
...
///////////////////////////////////////////////
template <class T>
sVec3<T>& VecBaryCentric(sVec3<T>& Out, const sVec3<T>& V1, const sVec3<T>& V2,
                         const sVec3<T>& V3, T f, T g)
{
...
///////////////////////////////////////////////
template <class T>
sVec3<T>& VecCatmullRom(sVec3<T>& Out, const sVec3<T>& V1, const sVec3<T>& V2,
                        const sVec3<T>& V3, const sVec3<T>& V4, T s)
{
  T ss, sss, a, b, c, d;
...
///////////////////////////////////////////////
template <class T>
sVec3<T>& VecHermite(sVec3<T>& Out, const sVec3<T>& V1, const sVec3<T>& T1,
                     const sVec3<T>& V2, const sVec3<T>& T2, T s)
{
  T ss, sss, a, b, c, d;
...
///////////////////////////////////////////////
template <class T>
sVec3<T>& VecTransformCoord(sVec3<T>& Out, const sVec3<T>& V,
                            const sMatrix<T>& M)
{
  T rhw, x, y, z;
  x = V.x;
...
///////////////////////////////////////////////
template <class T>
sVec3<T>& VecTransformNormal(sVec3<T>& Out, const sVec3<T>& V,
                             const sMatrix<T>& M)
{
  T x, y, z;
...
///////////////////////////////////////////////
template <class T>
sVec3<T>& VecLerp(sVec3<T>& Out, const sVec3<T>& V1, const sVec3<T>& V2,
                  const sVec3<T>& V3)
{
...
///////////////////////////////////////////////
template <typename T>
inline sVec3<T>& VecToViewport(sVec3<T>& aOut, const ni::sVec3<T>& avProjected,
...
///////////////////////////////////////////////
template <typename T>
inline sVec3<T>& VecProject(sVec3<T>& aOut, const ni::sVec3<T>& avPos,
...
///////////////////////////////////////////////
template <typename T>
inline sVec4<T>& VecProjectRHW(sVec4<T>& aOut, const ni::sVec3<T>& avPos,
...
///////////////////////////////////////////////
template <class T>
sVec3<T>& VecUnproject(sVec3<T>& avOut, const sVec3<T>& avIn, T afVPX, T afVPY,
                       T afVPW, T afVPH, const sMatrix<T>& amtxViewProj)
{
...
///////////////////////////////////////////////
template <class T>
inline tBool VecEqual(const sVec3<T>& A, const sVec3<T>& B,
...
///////////////////////////////////////////////
template <class T>
inline sVec3<T>& VecReflect(sVec3<T>& Out, const sVec3<T>& Dir,
...
///////////////////////////////////////////////
template <typename T>
inline ni::sVec3<T> __stdcall GetScreenPosition(const ni::sVec3<T>& avPos,
...
template <typename T>
inline T ComputePixelScaleX(const sVec3<T>& pos, const sMatrix<T>& worldView,
                            const sMatrix<T>& proj, const ni::sRect<T>& aRect)
{
  sVec3<T> ppcam0;
  VecTransformCoord(ppcam0, pos, worldView);
...
// Compute a PIXEL * Scale = WorldSize scale factor
template <typename T>
inline T ComputePixelScaleY(const sVec3<T>& pos, const sMatrix<T>& worldView,
                            const sMatrix<T>& proj, const ni::sRect<T>& aRect)
{
  sVec3<T> ppcam0;
  VecTransformCoord(ppcam0, pos, worldView);
...
///////////////////////////////////////////////
template <typename T>
inline T ComputePixelWorldSizeX(const T afPixelSize, const ni::sVec3<T>& avPos,
                                const ni::sMatrix<T>& mtxWorldView,
                                const ni::sMatrix<T>& mtxProj,
                                const ni::sRect<T>& aRect)
{
  T worldUnitXPixelSize =
    ComputePixelScaleX(avPos, mtxWorldView, mtxProj, aRect);
  return afPixelSize * worldUnitXPixelSize;
}

///////////////////////////////////////////////
template <typename T>
inline T ComputePixelWorldSizeY(const T afPixelSize, const ni::sVec3<T>& avPos,
                                const ni::sMatrix<T>& mtxWorldView,
                                const ni::sMatrix<T>& mtxProj,
                                const ni::sRect<T>& aRect)
{
  T worldUnitXPixelSize =
    ComputePixelScaleY(avPos, mtxWorldView, mtxProj, aRect);
  return afPixelSize * worldUnitXPixelSize;
}

///////////////////////////////////////////////
template <typename T>
inline sVec2<T> ComputePixelWorldSizeVec2(const T afPixelSize,
...
///////////////////////////////////////////////
template <typename T>
inline T ComputePixelWorldSize(const T afPixelSize, const ni::sVec3<T>& avPos,
                               const ni::sMatrix<T>& mtxWorldView,
                               const ni::sMatrix<T>& mtxProj,
                               const ni::sRect<T>& aRect)
{
  if (aRect.GetWidth() >= aRect.GetHeight()) {
    return ComputePixelWorldSizeX(afPixelSize, avPos, mtxWorldView, mtxProj,
                                  aRect);
  }
  else {
    return ComputePixelWorldSizeY(afPixelSize, avPos, mtxWorldView, mtxProj,
                                  aRect);
  }
}
...
///////////////////////////////////////////////
template <typename T>
inline ni::sVec3<T>& VecSphericalToCartesian(ni::sVec3<T>& aOut,
...
///////////////////////////////////////////////
template <typename T>
inline ni::sVec3<T>& VecCartesianToSpherical(ni::sVec3<T>& aOut,
...
///////////////////////////////////////////////
template <typename T>
inline ni::sVec3<T>& VecOrbitPitch(ni::sVec3<T>& aOut,
                                   const ni::sVec3<T>& aTarget,
                                   const ni::sVec3<T>& aPos, T afPitch)
{
  ni::sVec3<T> s;
...
///////////////////////////////////////////////
template <typename T>
inline ni::sVec3<T>& VecOrbitYaw(ni::sVec3<T>& aOut,
                                 const ni::sVec3<T>& aTarget,
                                 const ni::sVec3<T>& aPos, T afYaw)
{
  ni::sVec3<T> s;
  VecCartesianToSpherical(s, aPos - aTarget);
...
///////////////////////////////////////////////
template <typename T>
inline ni::sVec3<T>& VecOrbitYawPitch(ni::sVec3<T>& aOut,
                                      const ni::sVec3<T>& aTarget,
                                      const ni::sVec3<T>& aPos, T afYaw,
                                      T afPitch)
{
...
template <typename T>
inline sVec3<T>& RandomDirection(sVec3<T>& vDirOut, const sVec3<T>& vN,
