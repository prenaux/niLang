...
class cDataTable : public ni::ImplRC<ni::iDataTable, ni::eImplFlags_Default,
                                     ni::iSerializable> {
 ...
 public:
  ...
  tBool __stdcall Copy(const ni::iDataTable* apSource,
                       ni::tDataTableCopyFlags aMode);
  ...
  ni::eDataTablePropertyType __stdcall GetPropertyTypeFromIndex(
    tU32 anIndex) const;
  ...
  ni::eDataTablePropertyType __stdcall GetPropertyType(
    const achar* aaszProp) const;

  cString __stdcall GetString(const achar* aaszProp) const;
  cString __stdcall GetStringDefault(const achar* aaszProp,
                                     const achar* aDefault) const
  {
  ...
  Ptr<iHString> __stdcall GetHStringDefault(const achar* aaszProp,
                                            iHString* aDefault) const
  {
    tU32 idx = this->GetPropertyIndex(aaszProp);
    if (idx == eInvalidHandle)
      return aDefault;
  ...
  sVec2f __stdcall GetVec2Default(const achar* aaszProp,
                                  const sVec2f& aDefault) const
  {
    tU32 idx = this->GetPropertyIndex(aaszProp);
    if (idx == eInvalidHandle)
      return aDefault;
  ...
  sVec3f __stdcall GetVec3Default(const achar* aaszProp,
                                  const sVec3f& aDefault) const
  {
    tU32 idx = this->GetPropertyIndex(aaszProp);
    if (idx == eInvalidHandle)
      return aDefault;
  ...
  sVec4f __stdcall GetVec4Default(const achar* aaszProp,
                                  const sVec4f& aDefault) const
  {
    tU32 idx = this->GetPropertyIndex(aaszProp);
    if (idx == eInvalidHandle)
      return aDefault;
  ...
  sMatrixf __stdcall GetMatrixDefault(const achar* aaszProp,
                                      const sMatrixf& aDefault) const
  {
    tU32 idx = this->GetPropertyIndex(aaszProp);
    if (idx == eInvalidHandle)
      return aDefault;
  ...
  iUnknown* __stdcall GetIUnknownDefault(const achar* aaszProp,
                                         iUnknown* aDefault) const
  {
    tU32 idx = this->GetPropertyIndex(aaszProp);
    if (idx == eInvalidHandle)
      return aDefault;
  ...
  Var __stdcall GetVar(const achar* aaszProp) const
  {
    return _GetVar(aaszProp, eFalse);
  }
  Var __stdcall GetRawVar(const achar* aaszProp) const
  {
    return _GetVar(aaszProp, eTrue);
  }
  ...
  Var __stdcall GetRawVarDefault(const achar* aaszProp,
                                 const Var& aDefault) const
  {
    tU32 idx = this->GetPropertyIndex(aaszProp);
    if (idx == eInvalidHandle)
      return aDefault;
  ...
  __forceinline void __stdcall _SetVarFromIndex(tU32 anIndex, const Var& aVar,
                                                tBool abRaw);
  void __stdcall SetVarFromIndex(tU32 anIndex, const Var& aVar)
  {
    _SetVarFromIndex(anIndex, aVar, eFalse);
  }
  void __stdcall SetRawVarFromIndex(tU32 anIndex, const Var& aVar)
  {
    _SetVarFromIndex(anIndex, aVar, eTrue);
  }
  ...
  tU32 __stdcall GetEnumFromIndex(tU32 anIndex, const sEnumDef* apEnumDef,
                                  tEnumToStringFlags aFlags) const;
  tU32 __stdcall GetEnum(const achar* aaszProp, const sEnumDef* apEnumDef,
                         tEnumToStringFlags aFlags) const;
  tU32 __stdcall GetEnumDefault(const achar* aaszProp,
                                const sEnumDef* apEnumDef,
                                tEnumToStringFlags aFlags, tU32 anDefault) const
  {
  ...
  tU32 __stdcall SetEnum(const achar* aaszName, const sEnumDef* apEnumDef,
                         tEnumToStringFlags aFlags, tU32 anValue) niImpl;
  void __stdcall SetEnumFromIndex(tU32 anIndex, const sEnumDef* apEnumDef,
  ...
  __forceinline void __stdcall CallSink_AddChild(iDataTable* apDT,
                                                 iDataTable* apChild)
  {
    Ptr<SinkList<iDataTableSink>> pLst = _GetRootSinkList();
  ...
  __forceinline void __stdcall CallSink_RemoveChild(iDataTable* apDT,
                                                    iDataTable* apChild)
  {
    Ptr<SinkList<iDataTableSink>> pLst = _GetRootSinkList();
  ...
  __forceinline void __stdcall CallSink_SetProperty(iDataTable* apDT,
                                                    tU32 anProperty)
  {
    Ptr<SinkList<iDataTableSink>> pLst = _GetRootSinkList();
  ...
  __forceinline void __stdcall CallSink_SetMetadata(iDataTable* apDT,
                                                    tU32 anProperty)
  {
    Ptr<SinkList<iDataTableSink>> pLst = _GetRootSinkList();
  ...
  __forceinline void __stdcall CallSink_RemoveProperty(iDataTable* apDT,
                                                       tU32 anProperty)
  {
    Ptr<SinkList<iDataTableSink>> pLst = _GetRootSinkList();
  ...
  __forceinline Ptr<iExpressionVariable> __stdcall _EvaluateExpression(
    const achar* aaszExpr) const
  {
    return ni::GetLang()->GetExpressionContext()->Eval(aaszExpr);
  }

  tBool __stdcall _FindChildDataTable(iDataTable* apThis,
                                      iDataTable* apToFind) const;
  ...
  void _FetchPropertyVar(Var& aVar, tU32 anIndex) const
  {
    ...
    {
      aVar = it->_Value()->OnDataTableSink_GetProperty(
        const_cast<cDataTable*>(this), anIndex);
      if (!aVar.IsNull())
        return;
    }
...
{
  return CloneEx(eDataTableCopyFlags_Clone | eDataTableCopyFlags_Recursive |
...
///////////////////////////////////////////////
tBool cDataTable::Copy(const ni::iDataTable* apSource,
                       ni::tDataTableCopyFlags aMode)
{
  if (!niIsOK(apSource))
    return ni::eFalse;
  ...
  if (niFlagIs(aMode, eDataTableCopyFlags_Skip)) {
    for (tU32 i = 0; i < apSource->GetNumProperties(); ++i) {
      if (GetPropertyIndex(apSource->GetPropertyName(i)) != eInvalidHandle)
        continue;
      tU32 nIndex =
        SetVar(apSource->GetPropertyName(i), apSource->GetVarFromIndex(i));
  ...
  if (niFlagIs(aMode, eDataTableCopyFlags_Recursive)) {
    if (niFlagIs(aMode, eDataTableCopyFlags_UniqueChild)) {
      for (tU32 i = 0; i < apSource->GetNumChildren(); ++i) {
        ...
        if (!pChildDest) {
          AddChild(niFlagIs(aMode, eDataTableCopyFlags_Clone)
                     ? pChildSrc->Clone()
                     : pChildSrc);
        }
        else {
      ...
      if (niFlagIsNot(aMode, eDataTableCopyFlags_AppendAllChildren)) {
        ...
        for (i = 0; i < commonNum; ++i) {
          if (ni::StrCmp(GetChildFromIndex(i)->GetName(),
                         apSource->GetChildFromIndex(i)->GetName()) == 0)
          {
            vMerged[i] = eTrue;
        ...
        for (i = 0; i < commonNum; ++i) {
          ...
          if (cdt) {
            AddChild(niFlagIs(aMode, eDataTableCopyFlags_Clone) ? cdt->Clone()
                                                                : cdt);
          }
        }
      }
...
{
  if (!midmapProperties.HasIndex(anIndex)) {
    return AZEROSTR;
  }
...
///////////////////////////////////////////////
ni::eDataTablePropertyType cDataTable::GetPropertyTypeFromIndex(
  tU32 anIndex) const
{
  if (anIndex >= GetNumProperties())
    return eDataTablePropertyType_Unknown;
  Var v;
...
cString cDataTable::GetStringFromIndex(tU32 anIndex) const
{
  ...
  if (pVarChars) {
    ...
    cString ret;
    switch (v.GetType()) {
    case eDataTablePropertyType_Int32: ret.Format(_A("%d"), v.GetI32()); break;
    case eDataTablePropertyType_Int64: ret.Format(_A("%d"), v.GetI64()); break;
    ...
    case eDataTablePropertyType_Float64:
      ...
      break;
    case eDataTablePropertyType_Vec2: ret.Set(v.GetVec2f()); break;
    case eDataTablePropertyType_Vec3: ret.Set(v.GetVec3f()); break;
    case eDataTablePropertyType_Vec4: ret.Set(v.GetVec4f()); break;
    case eDataTablePropertyType_Matrix: ret.Set(v.GetMatrixf()); break;
    default: {
      if (v.IsIntValue()) {
...
tI64 cDataTable::GetIntFromIndex(tU32 anIndex) const
{
  ...
  Var v;
  _FetchPropertyVar(v, anIndex);
  if (niType(v.GetType()) == eType_I32 ||
      v.GetType() == eDataTablePropertyType_Int32)
  {
    return v.GetI32();
  }
  else if (niType(v.GetType()) == eType_I64 ||
           v.GetType() == eDataTablePropertyType_Int64)
  {
    return v.GetI64();
  }
  else {
    // not the same type, convert
    switch (v.GetType()) {
    case eDataTablePropertyType_Float32: return tI64(v.GetF32());
    case eDataTablePropertyType_Float64: return tI64(v.GetF64());
    case eDataTablePropertyType_String: {
      Ptr<iExpressionVariable> ptrV =
        _EvaluateExpression(v.GetString().Chars());
      if (ptrV.IsOK()) {
...
tF64 cDataTable::GetFloatFromIndex(tU32 anIndex) const
{
  ...
  Var v;
  _FetchPropertyVar(v, anIndex);
  if (niType(v.GetType()) == eType_F32 ||
      v.GetType() == eDataTablePropertyType_Float32)
  {
    return v.GetF32();
  }
  else if (niType(v.GetType()) == eType_F64 ||
           v.GetType() == eDataTablePropertyType_Float64)
  {
    return v.GetF64();
  }
  else {
    switch (v.GetType()) {
    case eDataTablePropertyType_Int32: return tF64(v.GetI32());
    case eDataTablePropertyType_Int64: return tF64(v.GetI64());
    case eDataTablePropertyType_String: {
      Ptr<iExpressionVariable> ptrV =
        _EvaluateExpression(v.GetString().Chars());
      if (ptrV.IsOK()) {
...
iUnknown* cDataTable::GetIUnknownFromIndex(tU32 anIndex) const
{
  ...
  Var v;
  _FetchPropertyVar(v, anIndex);
  if (v.GetType() != eDataTablePropertyType_IUnknown)
    return NULL;
  return v.GetIUnknownPointer();
}

///////////////////////////////////////////////
Var __stdcall cDataTable::_GetVarFromIndex(tU32 anIndex,
                                           const tBool abRaw) const
{
  if (anIndex >= GetNumProperties())
    return (Var&)niVarNull;
  Var v;
  if (abRaw) {
...
///////////////////////////////////////////////
ni::eDataTablePropertyType cDataTable::GetPropertyType(
  const achar* aaszProp) const
{
...
///////////////////////////////////////////////
void __stdcall cDataTable::_SetVarFromIndex(tU32 anIndex, const Var& aVar,
                                            const tBool abRaw)
{
  if (anIndex >= GetNumProperties())
    return;
...
///////////////////////////////////////////////
tU32 __stdcall cDataTable::SetString(const achar* aaszName,
...
///////////////////////////////////////////////
tBool __stdcall cDataTable::SetMetadataFromIndex(tU32 anIndex,
                                                 iHString* ahspData)
{
  if (anIndex >= GetNumProperties())
    return eFalse;
...
///////////////////////////////////////////////
tBool __stdcall cDataTable::SetMetadata(const achar* aaszProp,
                                        iHString* ahspData)
{
...
///////////////////////////////////////////////
tU32 __stdcall cDataTable::GetEnumFromIndex(tU32 anIndex,
                                            const sEnumDef* apEnumDef,
                                            tEnumToStringFlags aFlags) const
{
  if (anIndex >= GetNumProperties())
...
///////////////////////////////////////////////
tU32 __stdcall cDataTable::GetEnum(const achar* aaszProp,
                                   const sEnumDef* apEnumDef,
                                   tEnumToStringFlags aFlags) const
{
  return GetEnumFromIndex(midmapProperties.GetKeyIndex(aaszProp), apEnumDef,
                          aFlags);
}

///////////////////////////////////////////////
void __stdcall cDataTable::SetEnumFromIndex(tU32 anIndex,
                                            const sEnumDef* apEnumDef,
                                            tEnumToStringFlags aFlags,
                                            tU32 anValue)
{
  ...
  if (apEnumDef) {
    SetStringFromIndex(
      anIndex, ni::GetLang()->EnumToString(anValue, apEnumDef, aFlags).Chars());
  }
  else {
    SetIntFromIndex(anIndex, anValue);
  }
...
///////////////////////////////////////////////
tU32 __stdcall cDataTable::SetEnum(const achar* aaszProp,
                                   const sEnumDef* apEnumDef,
                                   tEnumToStringFlags aFlags, tU32 anValue)
{
  tU32 nIndex = _GetNewProperty(aaszProp);
...
///////////////////////////////////////////////
tBool __stdcall cDataTable::_FindChildDataTable(iDataTable* apThis,
                                                iDataTable* apToFind) const
{
  tU32 i;
  if (apThis == apToFind)
...
//
//----------------------------------------------------------------------------
cString __stdcall cLang::GetAbsoluteDataTablePath(iDataTable* apDT,
                                                  tU32 anPropIndex)
{
...
static tBool _GetPathProperty(iDataTable* apDT, const achar* aPath,
                              Ptr<iDataTable>& resDT, tU32& resIndex,
                              tBool abCreate)
{
...
Var __stdcall cDataTable::GetVarFromPath(const achar* aPath,
                                         const Var& aDefault) const
{
  Ptr<iDataTable> dt;
  tU32 prop;
...
tSize DataTableSerialize_Write(iFile* apFile, iDataTable* apTable,
                               const tU32 anVersion);
...
tSize __stdcall cDataTable::Serialize(iFile* apFile, eSerializeMode aMode)
{
  ...
  case eSerializeMode_WriteRaw: {
    size = DataTableSerialize_Write(apFile, this,
                                    _knDataTableObjectSerializeVersion);
