...
///////////////////////////////////////////////////////////////////////
  ...
  ((defined(_MSC_VER) && (_MSC_VER >= 1700)) ||                    \
   ...
   defined(EA_COMPILER_CLANG)) // VS2012+
  #define EASTL_TYPE_TRAIT_underlying_type_CONFORMANCE \
    1 // underlying_type is conforming.
...
struct has_unique_object_representations
    : public integral_constant<
        bool, is_integral_v<remove_cv_t<remove_all_extents_t<
                T>>>> // only integral types (floating point types excluded).
{};
...
template <class T>
EA_CONSTEXPR auto has_unique_object_representations_v =
...
template <>
struct is_signed_helper<signed char> : public true_type {};
template <>
struct is_signed_helper<signed short> : public true_type {};
template <>
struct is_signed_helper<signed int> : public true_type {};
template <>
struct is_signed_helper<signed long> : public true_type {};
template <>
struct is_signed_helper<signed long long> : public true_type {};
template <>
struct is_signed_helper<float> : public true_type {};
template <>
struct is_signed_helper<double> : public true_type {};
template <>
struct is_signed_helper<long double> : public true_type {};

#if (CHAR_MAX == SCHAR_MAX)
template <>
struct is_signed_helper<char> : public true_type {};
#endif
#ifndef EA_WCHAR_T_NON_NATIVE // If wchar_t is a native type instead of simply a define to an existing type...
  #if defined(__WCHAR_MAX__) &&       \
    ((__WCHAR_MAX__ == 2147483647) || \
     (__WCHAR_MAX__ ==                \
      32767)) // GCC defines __WCHAR_MAX__ for most platforms.
template <>
struct is_signed_helper<wchar_t> : public true_type {};
  #endif
#endif

template <typename T>
struct is_signed
    : public eastl::is_signed_helper<typename eastl::remove_cv<T>::type> {};
...
#define EASTL_DECLARE_SIGNED(T)                             \
  ...
  template <>                                               \
  struct is_signed<volatile T> : public true_type {};       \
  template <>                                               \
  struct is_signed<const volatile T> : public true_type {}; \
  }
...
template <typename T>
struct is_unsigned_helper : public false_type {};

template <>
struct is_unsigned_helper<unsigned char> : public true_type {};
template <>
struct is_unsigned_helper<unsigned short> : public true_type {};
template <>
struct is_unsigned_helper<unsigned int> : public true_type {};
template <>
struct is_unsigned_helper<unsigned long> : public true_type {};
template <>
struct is_unsigned_helper<unsigned long long> : public true_type {};

#if (CHAR_MAX == UCHAR_MAX)
template <>
struct is_unsigned_helper<char> : public true_type {};
#endif
#ifndef EA_WCHAR_T_NON_NATIVE // If wchar_t is a native type instead of simply a define to an existing type...
  #if defined(_MSC_VER) ||              \
    (defined(__WCHAR_MAX__) &&          \
     ((__WCHAR_MAX__ == 4294967295U) || \
      (__WCHAR_MAX__ ==                 \
       65535))) // GCC defines __WCHAR_MAX__ for most platforms.
template <>
struct is_unsigned_helper<wchar_t> : public true_type {};
  #endif
#endif

template <typename T>
struct is_unsigned
    : public eastl::is_unsigned_helper<typename eastl::remove_cv<T>::type> {};
...
#define EASTL_DECLARE_UNSIGNED(T)                             \
  ...
  template <>                                                 \
  struct is_unsigned<volatile T> : public true_type {};       \
  template <>                                                 \
  struct is_unsigned<const volatile T> : public true_type {}; \
  }
...
#define EASTL_TYPE_TRAIT_alignment_of_CONFORMANCE \
  1 // alignment_of is conforming.
...
struct rank<T[N]>
    : public eastl::integral_constant<size_t, rank<T>::value + 1> {};
...
///////////////////////////////////////////////////////////////////////
  ...
  (defined(_MSC_VER) || defined(EA_COMPILER_GNUC) ||  \
   (defined(EA_COMPILER_CLANG) && EA_COMPILER_HAS_FEATURE(is_base_of)))
...
struct is_base_of
    : public eastl::integral_constant<bool,
                                      __is_base_of(Base, Derived) ||
                                        eastl::is_same<Base, Derived>::value> {
};

  #if EASTL_VARIABLE_TEMPLATES_ENABLED
template <typename Base, typename Derived>
EASTL_CPP17_INLINE_VARIABLE EA_CONSTEXPR bool is_base_of_v =
...
#define EASTL_TYPE_TRAIT_is_lvalue_reference_CONFORMANCE \
  1 // is_lvalue_reference is conforming.

template <typename T>
struct is_lvalue_reference : public eastl::false_type {};
template <typename T>
struct is_lvalue_reference<T&> : public eastl::true_type {};
...
#define EASTL_TYPE_TRAIT_is_rvalue_reference_CONFORMANCE \
  1 // is_rvalue_reference is conforming.

template <typename T>
struct is_rvalue_reference : public eastl::false_type {};
template <typename T>
struct is_rvalue_reference<T&&> : public eastl::true_type {};
...
template <typename T>
struct has_equality<
  T, eastl::void_t<decltype(eastl::declval<T>() == eastl::declval<T>())>>
    : eastl::true_type {};
