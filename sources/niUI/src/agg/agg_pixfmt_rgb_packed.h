...
struct blender_rgb555 {
  ...
  static AGG_INLINE void blend_pix(pixel_type* p, unsigned cr, unsigned cg,
                                   unsigned cb, unsigned alpha, unsigned)
  {
    pixel_type rgb = *p;
  ...
  {
    return (pixel_type)(((r & 0xF8) << 7) | ((g & 0xF8) << 2) | (b >> 3) |
                        0x8000);
  }
...
struct blender_rgb555_pre {
                                   ...
                                   unsigned cb, unsigned alpha, unsigned cover)
  {
    ...
    calc_type g = (rgb >> 2) & 0xF8;
    calc_type b = (rgb << 3) & 0xF8;
    *p = (pixel_type)((((r * alpha + cr * cover) >> 1) & 0x7C00) |
...
class blender_rgb555_gamma {
 public:
  ...
  AGG_INLINE void blend_pix(pixel_type* p, unsigned cr, unsigned cg,
                            unsigned cb, unsigned alpha, unsigned)
  {
    pixel_type rgb = *p;
...
struct blender_rgb565 {
                                   ...
                                   unsigned cb, unsigned alpha, unsigned)
  {
    ...
    calc_type b = (rgb << 3) & 0xF8;
    *p = (pixel_type)(((((cr - r) * alpha + (r << 8))) & 0xF800) |
...
struct blender_rgb565_pre {
                                   ...
                                   unsigned cb, unsigned alpha, unsigned cover)
  {
    ...
    calc_type g = (rgb >> 3) & 0xFC;
    calc_type b = (rgb << 3) & 0xF8;
    *p = (pixel_type)((((r * alpha + cr * cover)) & 0xF800) |
...
struct blender_rgbAAA {
  ...
  static AGG_INLINE pixel_type make_pix(unsigned r, unsigned g, unsigned b)
  {
    return (pixel_type)(((r & 0xFFC0) << 14) | ((g & 0xFFC0) << 4) | (b >> 6) |
                        0xC0000000);
  }
...
struct blender_rgbAAA_pre {
                                   ...
                                   unsigned cb, unsigned alpha, unsigned cover)
  {
    ...
    calc_type g = (rgb >> 4) & 0xFFC0;
    calc_type b = (rgb << 6) & 0xFFC0;
    *p = (pixel_type)((((r * alpha + cr * cover) >> 2) & 0x3FF00000) |
...
class blender_rgbAAA_gamma {
 public:
                            ...
                            unsigned cb, unsigned alpha, unsigned)
  {
    ...
    *p = (pixel_type)(((m_gamma->inv(
                          ((m_gamma->dir(cr) - r) * alpha + (r << 16)) >> 16)
                        << 14) &
                       0x3FF00000) |
                      ((m_gamma->inv(
                          ((m_gamma->dir(cg) - g) * alpha + (g << 16)) >> 16)
                        << 4) &
                       0x000FFC00) |
                      (m_gamma->inv(
                         ((m_gamma->dir(cb) - b) * alpha + (b << 16)) >> 16) >>
                       6) |
                      0xC0000000);
  }
...
struct blender_bgrAAA {
  ...
  static AGG_INLINE pixel_type make_pix(unsigned r, unsigned g, unsigned b)
  {
    return (pixel_type)(((b & 0xFFC0) << 14) | ((g & 0xFFC0) << 4) | (r >> 6) |
                        0xC0000000);
  }
...
class pixfmt_alpha_blend_rgb_packed {
 ...
 public:
  //--------------------------------------------------------------------
  pixfmt_alpha_blend_rgb_packed(rbuf_type& rb)
      : m_rbuf(&rb)
  {
  }
  ...
  void blend_vline(int x, int y, unsigned len, const color_type& c, int8u cover)
  {
    if (c.a) {
      ...
      if (alpha == base_mask) {
        ...
        do {
          m_blender.blend_pix((pixel_type*)m_rbuf->row_ptr(x, y++, 1), c.r, c.g,
                              c.b, alpha, cover);
        } while (--len);
      }
    }
  ...
  {
    do {
      copy_or_blend_pix((pixel_type*)m_rbuf->row_ptr(x, y++, 1) + x, c,
                        *covers++);
    } while (--len);
  }
  ...
  {
    do {
      copy_or_blend_pix((pixel_type*)m_rbuf->row_ptr(x, y++, 1) + x, *colors++,
                        covers ? *covers++ : cover);
    } while (--len);
  }
      ...
      do {
        ...
        if (alpha) {
          if (alpha == base_mask && cover == 255) {
            *pdst = m_blender.make_pix(psrc[src_order::R], psrc[src_order::G],
                                       psrc[src_order::B]);
          }
          else {
            m_blender.blend_pix(pdst, psrc[src_order::R], psrc[src_order::G],
                                psrc[src_order::B], alpha, cover);
          }
        }
        psrc += 4;
        ++pdst;
