...
#define niEpsilonF16 \
  0.00097656f // Smallest positive e for which cFloat16 (1.0 + e) != cFloat16 (1.0)

#define niMantiDigiF16 \
  11 // Number of digits in mantissa (significand + hidden leading 1)

#define niDifF16 \
  2 // Number of base 10 digits that can be represented without change
