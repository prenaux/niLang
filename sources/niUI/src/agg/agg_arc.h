...
class arc {
 public:
  ...
  arc(agg_real x, agg_real y, agg_real rx, agg_real ry, agg_real a1,
      agg_real a2, bool ccw = true);

  void init(agg_real x, agg_real y, agg_real rx, agg_real ry, agg_real a1,
            agg_real a2, bool ccw = true);
