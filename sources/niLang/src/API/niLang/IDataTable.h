...
struct iDataTableSink : public iUnknown {
  ...
  //! {Optional}
  virtual void __stdcall OnDataTableSink_AddChild(iDataTable* apDT,
                                                  iDataTable* apChild) = 0;
  //! A child data table has been removed.
  //! {Optional}
  virtual void __stdcall OnDataTableSink_RemoveChild(iDataTable* apDT,
                                                     iDataTable* apChild) = 0;
  ...
  virtual void __stdcall OnDataTableSink_SetProperty(iDataTable* apDT,
                                                     tU32 anProperty) = 0;
  //! A property's meta-data has been set.
  //! {Optional}
  virtual void __stdcall OnDataTableSink_SetMetadata(iDataTable* apDT,
                                                     tU32 anProperty) = 0;
  //! A property is going to be removed.
  //! {Optional}
  virtual void __stdcall OnDataTableSink_RemoveProperty(iDataTable* apDT,
                                                        tU32 anProperty) = 0;
  //! Get the value of the specified property.
  //! {Optional}
  virtual Var __stdcall OnDataTableSink_GetProperty(iDataTable* apDT,
                                                    tU32 anProperty) = 0;
};
...
struct iDataTable : public iUnknown {
  ...
  virtual tBool __stdcall Copy(const iDataTable* apSource,
                               tDataTableCopyFlags aMode) = 0;
  ...
  //! {Property}
  virtual eDataTablePropertyType __stdcall GetPropertyType(
    const achar* aaszProp) const = 0;
  //! Get the type of the property at the specified index.
  //! {Property}
  virtual eDataTablePropertyType __stdcall GetPropertyTypeFromIndex(
  ...
  //! {Property}
  virtual tBool __stdcall SetMetadata(const achar* aaszProp,
                                      iHString* ahspData) = 0;
  ...
  //! Set a property meta-data.
  //! {Property}
  virtual tBool __stdcall SetMetadataFromIndex(tU32 anIndex,
                                               iHString* ahspData) = 0;
  //! Get a property meta-data.
  //! {Property}
  ...
  virtual Var __stdcall GetVarDefault(const achar* aaszName,
                                      const Var& v) const = 0;
  ...
  //! Get a String property.
  //! \remark Allow to specify the default value.
  virtual cString __stdcall GetStringDefault(const achar* aaszName,
                                             const achar* v) const = 0;
  ...
  //! Get a HString property.
  //! \remark Allow to specify the default value.
  virtual Ptr<iHString> __stdcall GetHStringDefault(const achar* aaszName,
                                                    iHString* v) const = 0;
  ...
  //! Get a Bool property.
  //! \remark Allow to specify the default value.
  virtual tBool __stdcall GetBoolDefault(const achar* aaszName,
                                         tBool v) const = 0;
  ...
  //! Get a Float property.
  //! \remark Allow to specify the default value.
  virtual tF64 __stdcall GetFloatDefault(const achar* aaszName,
                                         tF64 v) const = 0;
  ...
  //! Get a Vec2 property.
  //! \remark Allow to specify the default value.
  virtual sVec2f __stdcall GetVec2Default(const achar* aaszName,
                                          const sVec2f& v) const = 0;
  ...
  //! Get a Vec3 property.
  //! \remark Allow to specify the default value.
  virtual sVec3f __stdcall GetVec3Default(const achar* aaszName,
  ...
  //! Get a Vec4 property.
  //! \remark Allow to specify the default value.
  virtual sVec4f __stdcall GetVec4Default(const achar* aaszName,
                                          const sVec4f& v) const = 0;
  ...
  //! Get a Matrix property.
  //! \remark Allow to specify the default value.
  virtual sMatrixf __stdcall GetMatrixDefault(const achar* aaszName,
                                              const sMatrixf& v) const = 0;
  ...
  //! Get a IUnknown property.
  //! \remark Allow to specify the default value.
  virtual iUnknown* __stdcall GetIUnknownDefault(const achar* aaszName,
                                                 iUnknown* v) const = 0;

  //! Get a Enum property.
  virtual tU32 __stdcall GetEnum(const achar* aaszName,
                                 const sEnumDef* apEnumDef,
                                 tEnumToStringFlags aFlags) const = 0;
  //! Get a Enum property from the specified index.
  virtual tU32 __stdcall GetEnumFromIndex(tU32 anIndex,
                                          const sEnumDef* apEnumDef,
                                          tEnumToStringFlags aFlags) const = 0;
  //! Get a Enum property.
  //! \remark Allow to specify the default value.
  virtual tU32 __stdcall GetEnumDefault(const achar* aaszName,
                                        const sEnumDef* apEnumDef,
  ...
  //! {Property}
  virtual tU32 __stdcall SetMatrix(const achar* aaszName,
                                   const sMatrixf& v) = 0;
  //! Set a Matrix property from the specified index.
  //! {Property}
  virtual void __stdcall SetMatrixFromIndex(tU32 anIndex,
                                            const sMatrixf& v) = 0;
  ...
  virtual tU32 __stdcall SetEnum(const achar* aaszName,
                                 const sEnumDef* apEnumDef,
                                 tEnumToStringFlags aFlags, tU32 anVal) = 0;
  //! Set an Enum property from the specified index.
  virtual void __stdcall SetEnumFromIndex(tU32 anIndex,
                                          const sEnumDef* apEnumDef,
                                          tEnumToStringFlags aFlags,
                                          tU32 anVal) = 0;
  //! @}
  ...
  //! Get a Var property without ever calling the callback sink.
  //! \remark Allow to specify the default value.
  virtual Var __stdcall GetRawVarDefault(const achar* aaszName,
                                         const Var& v) const = 0;

  //! Set a new variant property. Property name being a path.
  //! \return false if the the path doesnt exist and cant be created.
  virtual tBool __stdcall NewVarFromPath(const achar* aPath,
                                         const Var& aVal) = 0;
  //! Set a variant property. Property name being a path. Return false if the path doesnt exist.
  virtual tBool __stdcall SetVarFromPath(const achar* aPath,
                                         const Var& aVal) = 0;
  //! Get a variant property. Property name being a path.
  virtual Var __stdcall GetVarFromPath(const achar* aPath,
                                       const Var& aDefault) const = 0;
  //! @}
};
...
struct iDataTableReadStack : public iUnknown {
  ...
  //! Push the specified data table on top of the stack.
  //! Push a NULL data table if it doesn't exists.
  virtual tBool __stdcall PushEx(const achar* aaszName, const achar* aaszProp,
                                 const achar* aaszVal) = 0;
  //! Push the specified data table on top of the stack.
  //! Do not push a data table if it doesn't exists and returns eFalse.
  virtual tBool __stdcall PushFailEx(const achar* aaszName,
...
struct iDataTableWriteStack : public iUnknown {
  ...
  //! {Property}
  virtual void __stdcall SetMatrix(const achar* aaszName,
                                   const sMatrixf& v) = 0;
  ...
  virtual void __stdcall SetEnum(const achar* aaszName,
                                 const sEnumDef* apEnumDef,
                                 tEnumToStringFlags aFlags, tU32 anVal) = 0;
...
niExportFunc(iUnknown*) New_niLang_DataTable(const Var& avarA,
                                             const Var& avarB);

///////////////////////////////////////////////
inline iDataTableWriteStack* __stdcall CreateDataTableWriteStack(
  iDataTable* apDT)
{
...
///////////////////////////////////////////////
inline iDataTableWriteStack* __stdcall CreateDataTableWriteStackFromName(
...
///////////////////////////////////////////////
inline tBool __stdcall SerializeDataTable(const achar* aaszSerName,
                                          eSerializeMode aMode,
                                          iDataTable* apTable, iFile* apFile)
{
