...
///////////////////////////////////////////////
template <class T>
void MatrixFromQuat(T& r11, T& r12, T& r13, T& r21, T& r22, T& r23, T& r31,
                    T& r32, T& r33, const sQuat<T>& q)
{
...
void MatrixPostRotateQuat(sMatrix<T>& m, const sQuat<T>& q)
{
  ...
  MatrixFromQuat(r11, r12, r13, r21, r22, r23, r31, r32, r33, q);
...
void MatrixPostRotateQuatInverse(sMatrix<T>& m, const sQuat<T>& q)
{
  ...
  MatrixFromQuat(r11, r21, r31, r12, r22, r32, r13, r23, r33, q);
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixAffineTransformation(sMatrix<T>& Out, T scaling,
                                       ...
                                       const sVec3<T>* pTranslation = NULL)
{
  ...
  if (pRotation) {
    if (pRotationCenter)
      MatrixPostTranslate(Out, -pRotationCenter->x, -pRotationCenter->y,
                          -pRotationCenter->z);
...
{
  return Det3x3(M._11, M._12, M._13, M._21, M._22, M._23, M._31, M._32, M._33);
}
...
{
  return Det4x4(M._11, M._12, M._13, M._14, M._21, M._22, M._23, M._24, M._31,
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixInverse(sMatrix<T>& aOut, const sMatrix<T>& aIn,
                          T* apDet = NULL)
{
  const T* pIn;
  sMatrix<T> t;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixLookAtRH(sMatrix<T>& Out, const sVec3<T>& Eye,
                           const sVec3<T>& At, const sVec3<T>& Up)
{
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixLookAtLH(sMatrix<T>& Out, const sVec3<T>& Eye,
                           const sVec3<T>& At, const sVec3<T>& Up)
{
  sVec3<T> uAxis, vAxis, nAxis;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixMultiply(sMatrix<T>& Out, const sMatrix<T>& M1,
                           const sMatrix<T>& M2)
{
  T a1, a2, a3, a4;
  const sMatrix<T>* pA;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixOrthoOffCenterRH(sMatrix<T>& Out, T l, T r, T t, T b, T zn,
                                   T zf)
{
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixOrthoOffCenterLH(sMatrix<T>& Out, T l, T r, T t, T b, T zn,
                                   T zf)
{
  T nfRatio, width, height;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixPerspectiveFovRH(sMatrix<T>& Out, T fovy, T aspect, T zn,
                                   T zf)
{
  T nfRatio, cotFovY;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixPerspectiveFovLH(sMatrix<T>& Out, T fovy, T aspect, T zn,
                                   T zf)
{
  T nfRatio, cotFovY;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixPerspectiveOffCenterRH(sMatrix<T>& Out, T l, T r, T t, T b,
                                         T zn, T zf)
{
  T nfRatio, width, height;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixPerspectiveOffCenterLH(sMatrix<T>& Out, T l, T r, T t, T b,
                                         T zn, T zf)
{
  T nfRatio, width, height;
...
///////////////////////////////////////////////
template <typename T>
ni::sMatrix<T>& MatrixRotationAxis(ni::sMatrix<T>& Out, const ni::sVec3<T>& V,
                                   T angle)
{
...
{
  MatrixFromQuat(Out._11, Out._12, Out._13, Out._21, Out._22, Out._23, Out._31,
                 Out._32, Out._33, Q);
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixScale(sMatrix<T>& Out, const sMatrix<T>& M, const T x,
                        const T y, const T z)
{
  // Right
  Out._11 = M._11 * x;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixShadow(sMatrix<T>& Out, const sVec4<T>& vLight,
                         const sVec4<T>& Plane)
{
                                 ...
                                 const sVec3<T>* pTranslation)
{
  ...
  if (pScaling) {
    if (pScalingCenter) {
      MatrixPostScale(Out, -pScalingCenter->x, -pScalingCenter->y,
                      -pScalingCenter->z);
    }
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixTextureOffset2(sMatrix<T>& Out, T fBias, tI32 nTexW,
                                 tI32 nTexH, tI32 nDepthBits)
{
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixTextureOffset(sMatrix<T>& Out, T fBias, tI32 nTexW,
                                tI32 nTexH)
{
  T fOffsetX = 0.5f + (0.5f / (T)nTexW);
  T fOffsetY = 0.5f + (0.5f / (T)nTexH);
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixLerp(sMatrix<T>& Out, const sMatrix<T>& A,
                       const sMatrix<T>& B, T fFac)
{
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixToCoordinateSystem(sMatrix<T>& Out, const sVec3<T>& avRight,
                                     const sVec3<T>& avUp,
                                     const sVec3<T>& avFwd,
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>* MatrixOrthogonalize(sMatrix<T>& Out, const sMatrix<T>& In,
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixSetScale(sMatrix<T>& Out, const sMatrix<T>& In,
...
///////////////////////////////////////////////
template <typename T>
sVec3<T>& MatrixGetProjectedTranslation(sVec3<T>& Out, const sMatrix<T>& M,
                                        T* pDeterminant = NULL)
{
  T det;
  T a1, b1, c1, d1;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixRotate(sMatrix<T>& Out, const sMatrix<T>& M1,
                         const sMatrix<T>& M2)
{
  T a1, a2, a3;
  const sMatrix<T>* pA;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T> MatrixRotationPivot(sMatrix<T>& aOut, const sMatrix<T>& aM2,
                               const sVec3<T>& avPivot)
{
  sMatrix<T> M2Translation = sMatrix<T>::Identity(),
             M2Rotation = sMatrix<T>::Identity();
  MatrixSetNotRotation(M2Translation, aM2);
  MatrixSetRotation(M2Rotation, aM2);
  sMatrixf t, ot;
  aOut = MatrixTranslation(ot, -avPivot) * M2Rotation *
         MatrixTranslation(t, avPivot) * M2Translation;
  return aOut;
}

///////////////////////////////////////////////
template <typename T>
sMatrix<T> MatrixRotationPivotAndScale(sMatrix<T>& aOut, const sMatrix<T>& aM2,
                                       const sVec3<T>& avPivot,
                                       const sVec3<T>& avScale)
{
  ...
  MatrixSetRotation(M2Rotation, aM2);
  sMatrix<T> t, ot, s;
  aOut = MatrixTranslation(ot, -avPivot) * MatrixScaling(s, avScale) *
         M2Rotation * MatrixTranslation(t, avPivot) * M2Translation;
  return aOut;
}
...
{
  aS.x =
    ni::Sqrt(In(0, 0) * In(0, 0) + In(0, 1) * In(0, 1) + In(0, 2) * In(0, 2));
  aS.y =
    ni::Sqrt(In(1, 0) * In(1, 0) + In(1, 1) * In(1, 1) + In(1, 2) * In(1, 2));
  aS.z =
    ni::Sqrt(In(2, 0) * In(2, 0) + In(2, 1) * In(2, 1) + In(2, 2) * In(2, 2));
  return aS;
}
...
template <typename T>
void MatrixDecompose(const sMatrix<T>& In, sVec3<T>& aT, sVec3<T>& aR,
                     sVec4<T>& aS, const T aEps = (T)niEpsilon4)
{
  aS.x =
    ni::Sqrt(In(0, 0) * In(0, 0) + In(0, 1) * In(0, 1) + In(0, 2) * In(0, 2));
  aS.y =
  ...
  if (FuzzyEqual(aS.x, 0.0f, aEps)) {
    aS.x = aEps;
  }
  if (FuzzyEqual(aS.y, 0.0f, aEps)) {
    aS.y = aEps;
  }
  if (FuzzyEqual(aS.z, 0.0f, aEps)) {
    aS.z = aEps;
  }
...
///////////////////////////////////////////////
template <typename T>
void MatrixDecomposeQ(const sMatrix<T>& In, sVec3<T>& aT, sQuat<T>& aR,
                      sVec4<T>& aS, const T aEps = (T)niEpsilon5)
{
  sVec3<T> vR;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixCompose(sMatrix<T>& Out, const sVec3<T>& aT,
                          const sVec3<T>& aR, const sVec4<T>& aS)
{
  sMatrix<T> tmp;
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixComposeQ(sMatrix<T>& Out, const sVec3<T>& aT,
                           const sQuat<T>& aR, const sVec4<T>& aS)
{
  sMatrix<T> tmp;
  Out = sMatrix<T>::Identity();
  Out *= MatrixScalingH(tmp, aS);
...
///////////////////////////////////////////////
template <typename T>
sMatrix<T>& MatrixViewport(sMatrix<T>& Out, const sVec4<T>& aVP, const T aMinZ,
                           const T aMaxZ)
{
  Out = sMatrix<T>::Identity();
...
///////////////////////////////////////////////
template <typename T>
const sMatrix<T>& MatrixAdjustViewport(sMatrix<T>& Out,
                                       const sVec4<T>& aContextVP,
                                       const sVec4<T>& aVirtualVP,
                                       const T afMinZ, const T afMaxZ)
{
...
///////////////////////////////////////////////
template <typename T>
sVec3<T>& MatrixDecomposeGetZYX(sVec3<T>& aR, const sMatrix<T>& In,
...
///////////////////////////////////////////////
template <typename T>
sQuat<T>& MatrixDecomposeGetQuat(sQuat<T>& aR, const sMatrix<T>& In,
                                 const T aEps = (T)niEpsilon4)
{
  sVec3<T> t;
  sVec4<T> s;
...
///////////////////////////////////////////////
template <typename T>
sVec4<T>& MatrixDecomposeGetScale(sVec4<T>& aS, const sMatrix<T>& In,
                                  const T aEps = (T)niEpsilon4)
{
  sVec3<T> Tr, R;
...
template <typename T>
sMatrix<T> MatrixProjection2D(const T afOrthoProjectionOffset,
                              const sRect<T>& aRect, const T afVerticalFov,
                              const sVec2<T>& aCameraPos = sVec2<T>::Zero())
{
  ...
  if (afVerticalFov > 0.0f) {
    ...
    const T theta = fov / 2;
    const T s =
      20; // this is arbitrary, just needs to be enought so that there's some room for the near space
    ...
    const sVec3<T> cameraPos = { aRect.GetWidth() / 2.0f + aCameraPos.x,
                                 aRect.GetHeight() / 2.0f + aCameraPos.y, 0 };
    rect.Move(-(sVec2<T>&)cameraPos);

    sMatrix<T> t, p;
    // perspective
    MatrixLookAtLH(t, Vec3<T>(o, o, -d) + cameraPos,
                   Vec3<T>(o, o, 0) + cameraPos, sVec3<T>::YAxis());
    MatrixPerspectiveOffCenterLH(p, rect.Left() / s, rect.Right() / s,
                                 rect.Bottom() / s, rect.Top() / s, n, f);
    proj = t * p;
  }
  else {
    const T o = -afOrthoProjectionOffset;
    // ortho
    MatrixOrthoOffCenterLH(proj, rect.Left() + o, rect.Right() + o,
                           rect.Bottom() + o, rect.Top() + o, -1.0f, 1.0f);
  }
  return proj;
}
