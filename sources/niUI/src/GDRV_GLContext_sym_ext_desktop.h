...
TSGL_EXT_PROC(void, glBufferData,
              (GLenum target, GLsizeiptr size, const void* data, GLenum usage));
TSGL_EXT_PROC(void, glBufferSubData,
...
TSGL_EXT_PROC(void, glShaderSource,
              (GLuint shader, GLsizei count, const char* const* src,
               const GLint* length));
TSGL_EXT_PROC(void, glCompileShader, (GLuint shader));
TSGL_EXT_PROC(void, glGetObjectParameteriv,
              (GLhandle shader, GLenum pname, GLint* params));
TSGL_EXT_PROC(void, glAttachShader, (GLuint program, GLuint shader));
TSGL_EXT_PROC(void, glGetInfoLog,
              (GLhandle object, GLsizei maxLength, GLsizei* length,
               GLchar* infoLog));
...
TSGL_EXT_PROC(void, glUniform3f,
              (GLint location, GLfloat v0, GLfloat v1, GLfloat v2));
TSGL_EXT_PROC(void, glUniform4f,
              (GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3));
TSGL_EXT_PROC(void, glUniform1fv,
              (GLint location, GLsizei count, const GLfloat* value));
TSGL_EXT_PROC(void, glUniform2fv,
              (GLint location, GLsizei count, const GLfloat* value));
TSGL_EXT_PROC(void, glUniform3fv,
              (GLint location, GLsizei count, const GLfloat* value));
TSGL_EXT_PROC(void, glUniform4fv,
              (GLint location, GLsizei count, const GLfloat* value));
TSGL_EXT_PROC(void, glUniformMatrix4fv,
              (GLint location, GLsizei count, GLboolean transpose,
               const GLfloat* value));
TSGL_EXT_PROC(void, glUniform1i, (GLint location, GLint v0));
TSGL_EXT_PROC(void, glBindAttribLocation,
              (GLuint program, GLuint index, const char* name));
TSGL_EXT_PROC(void, glGetActiveUniform,
...
TSGL_EXT_PROC(void, glVertexAttribPointer,
              (GLuint index, GLint size, GLenum type, GLboolean normalized,
               GLsizei stride, const void* pointer));
TSGL_EXT_PROC(void, glGetShaderInfoLog,
              (GLuint shader, GLsizei bufSize, GLsizei* length,
               GLchar* infoLog));
TSGL_EXT_PROC(void, glGetProgramiv,
              (GLuint program, GLenum pname, GLint* params));
TSGL_EXT_PROC(void, glGetProgramInfoLog,
...
TSGL_EXT_PROC(void, glDeleteRenderbuffers,
              (GLsizei n, const GLuint* renderbuffers));
TSGL_EXT_PROC(void, glGenRenderbuffers, (GLsizei n, GLuint* renderbuffers));
TSGL_EXT_PROC(void, glRenderbufferStorage,
              (GLenum target, GLenum internalformat, GLsizei width,
               GLsizei height));
TSGL_EXT_PROC(void, glGetRenderbufferParameteriv,
...
TSGL_EXT_PROC(void, glDeleteFramebuffers,
...
TSGL_EXT_PROC(void, glFramebufferTexture2D,
              (GLenum target, GLenum attachment, GLenum textarget,
               GLuint texture, GLint level));

TSGL_EXT_PROC(void, glFramebufferRenderbuffer,
              (GLenum target, GLenum attachment, GLenum renderbuffertarget,
               GLuint renderbuffer));
TSGL_EXT_PROC(void, glGetFramebufferAttachmentParameteriv,
...
#ifdef USE_OQ
TSGL_OPT_EXT_PROC(void, glGetQueryiv,
                  (GLenum target, GLenum pname, GLint* params));
...
TSGL_OPT_EXT_PROC(void, glGetQueryObjectiv,
                  (GLuint id, GLenum pname, GLint* params));
TSGL_OPT_EXT_PROC(void, glGetQueryObjectuiv,
