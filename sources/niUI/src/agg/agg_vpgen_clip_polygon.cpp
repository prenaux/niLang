...
//
//
unsigned vpgen_clip_polygon::clipping_flags(agg_real x, agg_real y)
{
  if(x < m_clip_box.x1)
  {
...
//----------------------------------------------------------------------------
void vpgen_clip_polygon::move_to(agg_real x, agg_real y)
{
  m_vertex = 0;
  m_num_vertices = 0;
...
//----------------------------------------------------------------------------
void vpgen_clip_polygon::line_to(agg_real x, agg_real y)
{
  m_vertex = 0;
  m_num_vertices = 0;
...
//----------------------------------------------------------------------------
unsigned vpgen_clip_polygon::vertex(agg_real* x, agg_real* y)
{
