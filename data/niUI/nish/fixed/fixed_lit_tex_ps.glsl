...
nish_std_PixelOutput niUIGpuFuncs_fixed_lit_tex_ps(nish_std_VertexOutput aInput, niUIGpuFuncs_FixedUniforms aUniforms, texture2D aTexture, sampler aSS);
...
nish_std_PixelOutput niUIGpuFuncs_fixed_lit_tex_ps(nish_std_VertexOutput aInput, niUIGpuFuncs_FixedUniforms aUniforms, texture2D aTexture, sampler aSS) {
  ...
  vec3 _tmp_q1 = diffuse;
  vec4 _tmp_n1 = ((texColor*aInput.color)*vec4(_tmp_q1.x,_tmp_q1.y,_tmp_q1.z,1.0));
  return nish_std_PixelOutput_new(_tmp_n1);
}
// MODULE END niUIGpuFuncs

// Pixel Shader main: niUIGpuFuncs_fixed_lit_tex_ps
...
void main(void) {
  ...
  nish_std_PixelOutput _rval_ = niUIGpuFuncs_fixed_lit_tex_ps(aInput, aUniforms, IN_1_aTexture, IN_1_aSS);
