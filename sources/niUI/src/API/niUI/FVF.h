...
#define eFVF_TexCooSize1(CoordIndex) \
  ni::eFVF((ni::tU32)(3 << (CoordIndex * 2 + 16)))
...
#define eFVF_TexCooDim(fvf, CoordIndex) \
  ((ni::tU32)((0x1432 >> (((fvf) >> ((CoordIndex)*2 + 14)) & 0xC)) & 0xF))
//! Get the number of texture coordinates of the specified FVF.
#define eFVF_TexNumCoo(fvf) \
  ((ni::tU32)(((fvf)&eFVF_TexCount_Mask) >> eFVF_TexCount_Shift))
//! FVF position mask.
...
#define eFVF_HasWeights(fvf) \
  ((((fvf)) & eFVF_Position_Mask) >= ni::eFVF_PositionB1)
//! FVF check number of weights.
#define eFVF_NumWeights(fvf)                                               \
  (eFVF_HasWeights(fvf)                                                    \
     ? ((((((fvf)) - ni::eFVF_PositionB1) & eFVF_Position_Mask) >> 1) + 1) \
     : 0)
        ...
        if (p != e && nIndex >= 1 && nIndex <= 8) {
          ...
          if (*p) {
            ...
            if (p != e) {
              switch (nDim) {
              case 1:
                fvf |= eFVF_TexUnit(nIndex - 1) | eFVF_TexCooSize1(nIndex - 1);
                break;
              case 2:
                fvf |= eFVF_TexUnit(nIndex - 1) | eFVF_TexCooSize2(nIndex - 1);
                break;
              case 3:
                fvf |= eFVF_TexUnit(nIndex - 1) | eFVF_TexCooSize3(nIndex - 1);
                break;
              case 4:
                fvf |= eFVF_TexUnit(nIndex - 1) | eFVF_TexCooSize4(nIndex - 1);
                break;
              }
            }
            else {
...
class cFVFDescription {
 public:
  ...
  inline tFVF GetFVF() const
  {
    return mFVF;
  }
  //! Get the FVF stride.
  inline tU16 GetStride() const
  {
    return munStride;
  }

  //! Check if the FVF has a position.
  inline tBool HasPosition() const
  {
    return munPositionSize >= 12;
  }
  //! Get the position offset.
  inline tI32 GetPositionOffset() const
  {
    return munPositionSize >= 12 ? 0 : -1;
  }
  //! Get the position size.
  inline tU32 GetPositionSize() const
  {
    return munPositionSize;
  }

  //! Check if the FVF has 1 weight.
  inline tBool HasWeights1() const
  {
    return niFlagTest(mFVF, eFVF_PositionB1);
  }
  //! Check if the FVF has 2 weights.
  inline tBool HasWeights2() const
  {
    return niFlagTest(mFVF, eFVF_PositionB2);
  }
  //! Check if the FVF has 3 weights.
  inline tBool HasWeights3() const
  {
    return niFlagTest(mFVF, eFVF_PositionB3);
  }
  //! Check if the FVF has 4 weights.
  inline tBool HasWeights4() const
  {
    return niFlagTest(mFVF, eFVF_PositionB4);
  }
  //! Get the weight offset.
  inline tI16 GetWeightsOffset() const
  {
    return (munPositionSize > 12) ? 12 : -1;
  }
  //! Get the number of weights.
  inline tU16 GetNumWeights() const
  {
    return HasWeights4()   ? 4
           : HasWeights3() ? 3
           : HasWeights2() ? 2
           : HasWeights1() ? 1
                           : 0;
  ...
  inline tBool HasIndices() const
  {
    return mnOffIndices >= 0;
  }
  //! Get the indices offset.
  inline tI16 GetIndicesOffset() const
  {
    return mnOffIndices;
  }

  //! Check if the FVF has normals.
  inline tBool HasNormal() const
  {
    return mnOffNormal >= 0;
  }
  //! Get the normal offset.
  inline tI16 GetNormalOffset() const
  {
    return mnOffNormal;
  }

  //! Check if the FVF has a point size.
  inline tBool HasPointSize() const
  {
    return mnOffPointSize >= 0;
  }
  //! Get the offset of the point size.
  inline tI16 GetPointSizeOffset() const
  {
    return mnOffPointSize;
  }

  //! Check if the FVF has a color A.
  inline tBool HasColorA() const
  {
    return mnOffColorA >= 0;
  }
  //! Get the offset of the color A.
  inline tI16 GetColorAOffset() const
  {
    return mnOffColorA;
  }

  //! Get the number of texture coordinates.
  inline tU16 GetNumTexCoos() const
  {
    return munNumTexCoos;
  }
  //! Check if the FVF has the specified texture coordinate. (index based)
  inline tBool HasTexCoo(tU32 idx = 0) const
  {
    return idx < munNumTexCoos;
  }
  //! Get the number of dimensions of the specified texture coordinates. (index based).
  inline tU16 GetTexCooDim(tU32 idx = 0) const
  {
    return munTexSize[idx] >> 2;
  }
  //! Get the offset of the specified texture coordinates. (index based)
  inline tU16 GetTexCooOffset(tU32 idx = 0) const
  {
    return munOffTex[idx];
  }
...
class cFVFVertex {
 public:
  ...
  inline const cFVFDescription& GetFVF() const
  {
    return *mpFVF;
  }
  inline tPtr GetBase() const
  {
    return mpCurrent;
  }

  inline sVec3f& Position() const
  {
    return *((sVec3f*)(mpCurrent));
  }
  inline tF32& Weights1() const
  {
    return *((tF32*)(mpCurrent + 12));
  }
  inline sVec2f& Weights2() const
  {
    return *((sVec2f*)(mpCurrent + 12));
  }
  inline sVec3f& Weights3() const
  {
    return *((sVec3f*)(mpCurrent + 12));
  }
  inline sVec4f& Weights4() const
  {
    return *((sVec4f*)(mpCurrent + 12));
  }
  inline tU32& Indices() const
  {
    return *((tU32*)(mpCurrent + mpFVF->GetIndicesOffset()));
  }
  inline sVec3f& Normal() const
  {
    return *((sVec3f*)(mpCurrent + mpFVF->GetNormalOffset()));
  }
  inline tF32& PointSize() const
  {
    return *((tF32*)(mpCurrent + mpFVF->GetPointSizeOffset()));
  }
  inline tU32& ColorA() const
  {
    return *((tU32*)(mpCurrent + mpFVF->GetColorAOffset()));
  }
  inline tF32& TexCoo1(int idx = 0) const
  {
    return *((tF32*)(mpCurrent + mpFVF->GetTexCooOffset(idx)));
  }
  inline sVec2f& TexCoo2(int idx = 0) const
  {
    return *((sVec2f*)(mpCurrent + mpFVF->GetTexCooOffset(idx)));
  }
  inline sVec3f& TexCoo3(int idx = 0) const
  {
    return *((sVec3f*)(mpCurrent + mpFVF->GetTexCooOffset(idx)));
  }
  inline sVec4f& TexCoo4(int idx = 0) const
  {
    return *((sVec4f*)(mpCurrent + mpFVF->GetTexCooOffset(idx)));
  }

  inline const sVec3f& GetPosition() const
  {
    return *((sVec3f*)(mpCurrent));
  }
  inline const tF32& GetWeights1() const
  {
    return *((tF32*)(mpCurrent + 12));
  }
  inline const sVec2f& GetWeights2() const
  {
    return *((sVec2f*)(mpCurrent + 12));
  }
  inline const sVec3f& GetWeights3() const
  {
    return *((sVec3f*)(mpCurrent + 12));
  }
  inline const sVec4f& GetWeights4() const
  {
    return *((sVec4f*)(mpCurrent + 12));
  }
  inline const tU32& GetIndices() const
  {
    return *((tU32*)(mpCurrent + mpFVF->GetIndicesOffset()));
  }
  inline const sVec3f& GetNormal() const
  {
    return *((sVec3f*)(mpCurrent + mpFVF->GetNormalOffset()));
  }
  inline const tF32& GetPointSize() const
  {
    return *((tF32*)(mpCurrent + mpFVF->GetPointSizeOffset()));
  }
  inline const tU32& GetColorA() const
  {
    return *((tU32*)(mpCurrent + mpFVF->GetColorAOffset()));
  }
  inline tF32 GetTexCoo1(int idx = 0) const
  {
    return *((tF32*)(mpCurrent + mpFVF->GetTexCooOffset(idx)));
  }
  inline const sVec2f& GetTexCoo2(int idx = 0) const
  {
    return *((sVec2f*)(mpCurrent + mpFVF->GetTexCooOffset(idx)));
  }
  inline const sVec3f& GetTexCoo3(int idx = 0) const
  {
    return *((sVec3f*)(mpCurrent + mpFVF->GetTexCooOffset(idx)));
  }
  inline const sVec4f& GetTexCoo4(int idx = 0) const
  {
    return *((sVec4f*)(mpCurrent + mpFVF->GetTexCooOffset(idx)));
  }

  inline void SetPosition(const sVec3f& aV)
  {
    *((sVec3f*)(mpCurrent)) = aV;
  }
  inline void SetWeights1(const tF32& aV)
  {
    *((tF32*)(mpCurrent + 12)) = aV;
  }
  inline void SetWeights2(const sVec2f& aV)
  {
    *((sVec2f*)(mpCurrent + 12)) = aV;
  }
  inline void SetWeights3(const sVec3f& aV)
  {
    *((sVec3f*)(mpCurrent + 12)) = aV;
  }
  inline void SetWeights4(const sVec4f& aV)
  {
    *((sVec4f*)(mpCurrent + 12)) = aV;
  }
  inline void SetIndices(const tU32& aV)
  {
    *((tU32*)(mpCurrent + mpFVF->GetIndicesOffset())) = aV;
  }
  inline void SetNormal(const sVec3f& aV)
  {
    *((sVec3f*)(mpCurrent + mpFVF->GetNormalOffset())) = aV;
  }
  inline void SetPointSize(const tF32& aV)
  {
    *((tF32*)(mpCurrent + mpFVF->GetPointSizeOffset())) = aV;
  }
  inline void SetColorA(const tU32& aV)
  {
    *((tU32*)(mpCurrent + mpFVF->GetColorAOffset())) = aV;
  }
  inline void SetTexCoo1(int idx, tF32 aV)
  {
    *((tF32*)(mpCurrent + mpFVF->GetTexCooOffset(idx))) = aV;
  }
  inline void SetTexCoo2(int idx, const sVec2f& aV)
  {
    *((sVec2f*)(mpCurrent + mpFVF->GetTexCooOffset(idx))) = aV;
  }
  inline void SetTexCoo3(int idx, const sVec3f& aV)
  {
    *((sVec3f*)(mpCurrent + mpFVF->GetTexCooOffset(idx))) = aV;
  }
  inline void SetTexCoo4(int idx, const sVec4f& aV)
  {
    *((sVec4f*)(mpCurrent + mpFVF->GetTexCooOffset(idx))) = aV;
  }
...
class cFVFStream {
 public:
  inline cFVFStream();
  inline cFVFStream(const cFVFDescription* FVF, tPtr pBase = NULL,
                    tU32 ulCount = 0);

  inline void Setup(const cFVFDescription* FVF, tPtr pBase = NULL,
                    tU32 ulCount = 0);
  inline void SetBase(tPtr pBase, tU32 ulCount);

  inline tBool IsOK() const
  {
    return mpBase != NULL;
  }

  inline tSize GetNumVertices() const
  {
    return (mpEnd - mpBase) / mpFVF->GetStride();
  }
  inline const cFVFDescription& GetFVFDescription() const
  {
    return *mpFVF;
  }
  inline tPtr GetBase() const
  ...
  inline void SetCurrentIndex(tSize idx)
  {
    mpCurrent = mpBase + (mpFVF->GetStride() * idx);
    mVertex.Set(mpCurrent);
  }
  inline tSize GetCurrentIndex() const
  {
    return (mpCurrent - mpBase) / mpFVF->GetStride();
  }
  inline tBool End() const
  {
    return mpCurrent >= mpEnd;
  }
  inline void Next()
  {
    mpCurrent += mpFVF->GetStride();
    mVertex.Set(mpCurrent);
  }
  inline void Prev()
  {
  ...
  inline tPtr Current() const
  {
    return mpCurrent;
  }
  inline tPtr GetVertex(tU32 ulIdx) const
  {
    return mpBase + (ulIdx * mpFVF->GetStride());
  }

  inline cFVFVertex& Vertex() const
  {
    return mVertex;
  }
...
inline void cFVFDescription::Setup(tFVF aFVF)
{
  ...
  tU16 unCurrentOff = 0;
  if (niFlagTest(mFVF, eFVF_PositionB4))
    munPositionSize = 28;
  else if (niFlagTest(mFVF, eFVF_PositionB3))
    munPositionSize = 24;
  else if (niFlagTest(mFVF, eFVF_PositionB2))
    munPositionSize = 20;
  else if (niFlagTest(mFVF, eFVF_PositionB1))
    munPositionSize = 16;
  else if (niFlagTest(mFVF, eFVF_Position))
    munPositionSize = 12;
...
///////////////////////////////////////////////
inline cFVFStream::cFVFStream(const cFVFDescription* FVF, tPtr pBase,
                              tU32 ulCount)
{
...
///////////////////////////////////////////////
inline void cFVFStream::Setup(const cFVFDescription* FVF, tPtr pBase,
                              tU32 ulCount)
{
  mpFVF = FVF;
...
inline tU16 FVFGetComponentOffset(tFVF aFVF, eFVF aC)
{
  ...
  if (aC == eFVF_Position || aC == eFVF_PositionB4 || aC == eFVF_PositionB3 ||
...
inline void FVFCopy(tPtr pDest, const cFVFDescription& DestFVF, tPtr pSrc,
                    const cFVFDescription& SrcFVF, tU32 ulCount)
{
  if (DestFVF == SrcFVF) { // Same FVF so just need a simple memcpy
  ...
  if (DestFVF.HasPosition() && SrcFVF.HasPosition()) {
    ...
    pS = (tU8*)pSrc;
    tU32 ulPositionSize =
      Min(DestFVF.GetPositionSize(), SrcFVF.GetPositionSize());
    i = ulCount;
...
inline tPtr FVFLerp(tFVF aFVF, tPtr _pOut, const tPtr _pA, const tPtr _pB,
                    tF32 fF)
{
  tU8* pOut = (tU8*)_pOut;
  tU8* pA = (tU8*)_pA;
...
#define INCR(off) \
  ...
  if (niFlagTest(aFVF, eFVF_PositionB4)) {
    *((sVec3f*)pOut) = ni::Lerp(*((sVec3f*)pA), *((sVec3f*)pB), fF);
    INCR(12);
    *((sVec4f*)pOut) = ni::Lerp(*((sVec4f*)pA), *((sVec4f*)pB), fF);
    INCR(16);
  }
  else if (niFlagTest(aFVF, eFVF_PositionB3)) {
    *((sVec3f*)pOut) = ni::Lerp(*((sVec3f*)pA), *((sVec3f*)pB), fF);
    ...
    *((sVec3f*)pOut) = ni::Lerp(*((sVec3f*)pA), *((sVec3f*)pB), fF);
    INCR(12);
    *((sVec2f*)pOut) = ni::Lerp(*((sVec2f*)pA), *((sVec2f*)pB), fF);
    INCR(8);
  }
  else if (niFlagTest(aFVF, eFVF_PositionB1)) {
    *((sVec4f*)pOut) = ni::Lerp(*((sVec4f*)pA), *((sVec4f*)pB), fF);
  ...
  if (niFlagTest(aFVF, eFVF_PointSize)) {
    *((tF32*)(pOut)) = Lerp(*((tF32*)(pA)), *((tF32*)(pB)), fF);
    INCR(4);
  }

  if (niFlagTest(aFVF, eFVF_ColorA)) {
    *((tU32*)(pOut)) = ULColorLerp(*((tU32*)(pA)), *((tU32*)(pB)), fF);
    INCR(4);
  }
  ...
  for (tU32 i = 0; i <= ulNumTexCoos; ++i) {
    if (niFlagTest(aFVF, eFVF_TexCooSize1(i))) {
      *((tF32*)(pOut)) = ni::Lerp(*((tF32*)(pA)), *((tF32*)(pB)), fF);
      INCR(4);
    }
...
enum eVertexFormat {
  ...
  eVertexFormat_PB4INT1 =
    eFVF_PositionB4 | eFVF_Indices | eFVF_Normal | eFVF_Tex1,
  eVertexFormat_PB4INAT1 =
    eFVF_PositionB4 | eFVF_Indices | eFVF_Normal | eFVF_ColorA | eFVF_Tex1,
  //! \internal
