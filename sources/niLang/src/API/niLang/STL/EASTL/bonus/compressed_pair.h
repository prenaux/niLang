...
EA_DISABLE_VC_WARNING(
  4626 5027) // warning C4626: 'eastl::compressed_pair_imp<T1,T2,0>': assignment operator was implicitly defined as deleted because a base class assignment operator is inaccessible or deleted
#endif
...
class compressed_pair_imp<T1, T2, 0> {
 public:
  ...
  typedef
    typename call_traits<second_type>::const_reference second_const_reference;
...
class compressed_pair
 ...
 private:
  typedef compressed_pair_imp<
    T1, T2,
    compressed_pair_switch<T1, T2,
                           is_same<typename remove_cv<T1>::type,
                                   typename remove_cv<T2>::type>::value,
                           is_empty<T1>::value, is_empty<T2>::value>::value>
    base;
...
class compressed_pair<T, T>
    : private compressed_pair_imp<
        ...
        compressed_pair_switch<T, T,
                               ...
                               is_empty<T>::value, is_empty<T>::value>::value> {
 private:
  typedef compressed_pair_imp<
    T, T,
