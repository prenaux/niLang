...
nish_std_VertexOutput TestGpuFuncs_triangle_vs(nish_std_VertexPA aInput);
...
// Vertex Shader main: TestGpuFuncs_triangle_vs
...
void main(void) {
  ...
  nish_std_VertexOutput _rval_ = TestGpuFuncs_triangle_vs(aInput);
