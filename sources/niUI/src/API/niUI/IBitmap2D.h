...
struct iBitmap2D : public iBitmapBase {
  ...
  // {NoAutomation}
  virtual tBool __stdcall SetMemoryAddress(tPtr apAddr, tBool abFreeData,
                                           tU32 anPitch = eInvalidHandle) = 0;
  ...
  //!         resized version.
  virtual iBitmap2D* __stdcall CreateResizedEx(
    tI32 nW, tI32 nH, tBool abPreserveMipMaps) const = 0;
  //! Create a cube bitmap from the specified 6 rectangles.
  virtual iBitmapCube* __stdcall CreateCubeBitmap(
    ...
    ePixelFormatBlit aBlitNZ) const = 0;
  ...
  virtual tBool __stdcall Blit(
    const iBitmap2D* src, tI32 xs, tI32 ys, tI32 xd, tI32 yd, tI32 w, tI32 h,
    ePixelFormatBlit eBlit = ePixelFormatBlit_Normal) = 0;
  //! Blit stretch a bitmap in this bitmap.
  //! \remark Clipping and pixel format conversion are automatically performed.
  virtual tBool __stdcall BlitStretch(const iBitmap2D* src, tI32 xs, tI32 ys,
                                      tI32 xd, tI32 yd, tI32 ws, tI32 hs,
                                      tI32 wd, tI32 hd) = 0;
  ...
  //! \remark Clipping and pixel format conversion are automatically performed.
  virtual tBool __stdcall BlitAlpha(const iBitmap2D* src, tI32 xs, tI32 ys,
                                    tI32 xd, tI32 yd, tI32 w, tI32 h,
  ...
  //! \remark The source and destination color are used to replace missing components in the source/destination format.
  //! \remark Clipping and pixel format conversion are automatically performed.
  virtual tBool __stdcall BlitAlphaStretch(const iBitmap2D* src, tI32 xs,
                                           tI32 ys, tI32 xd, tI32 yd, tI32 ws,
                                           tI32 hs, tI32 wd, tI32 hd,
                                           const sColor4f& acolSource,
                                           const sColor4f& acolDest,
                                           eBlendMode aBlendMode) = 0;
  //! @}
  ...
  //! Clear the bitmap.
  //! \remark The right and bottom edges are not filled.
  virtual void __stdcall ClearRectf(const sRecti& aRect,
