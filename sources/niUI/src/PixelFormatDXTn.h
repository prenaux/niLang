...
class cPixelFormatDXTn : public ImplRC<iPixelFormat> {
 public:
  ...
  tPtr __stdcall BuildPixelus(tPtr pOut, tU16 r, tU16 g, tU16 b,
                              tU16 a = 0) const
  {
    return BuildPixelub(pOut, tU8(r >> 8), tU8(g >> 8), tU8(b >> 8),
                        tU8(a >> 8));
  }
  tPtr __stdcall BuildPixelul(tPtr pOut, tU32 r, tU32 g, tU32 b,
                              tU32 a = 0) const
  {
    return BuildPixelub(pOut, tU8(r >> 24), tU8(g >> 24), tU8(b >> 24),
                        tU8(a >> 24));
  }
  tPtr __stdcall BuildPixelf(tPtr pOut, tF32 r, tF32 g, tF32 b,
                             tF32 a = 0.0f) const
  {
    return BuildPixelub(pOut, tU8(r * 255.0f), tU8(g * 255.0f), tU8(b * 255.0f),
                        tU8(a * 255.0f));
  }
