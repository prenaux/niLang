...
struct UTFBuffer {
  ...
  niDeprecated(202010, data) inline T* begin()
  {
...
inline BOOL ConvertUTF8ToUTF16(UTF16Buffer& aOut, const CHAR* pszTextUTF8,
                               size_t cchUTF8 = 0)
{
  //
  ...
  //
  int cchUTF16 =
    ::MultiByteToWideChar(CP_UTF8,     // convert from UTF-8
...
inline BOOL ConvertUTF16ToUTF8(UTF8Buffer& aOut, const WCHAR* pszTextUTF16,
                               size_t cchUTF16 = 0)
{
  //
  // Special case of NULL or empty input string
