...
enum ePCREError {
  ePCREError_OK = 0,
  ePCREError_NoMatch        = (-1),
  ePCREError_Null           = (-2),
  ePCREError_BadOption      = (-3),
  ePCREError_BadMagic       = (-4),
  ePCREError_UnknownOpcode  = (-5),
  ePCREError_NoMemory       = (-6),
  ePCREError_NoSubstring    = (-7),
  ePCREError_MatchLimit     = (-8),
  ePCREError_Callout        = (-9),
  ePCREError_BadUTF8        = (-10),
  ePCREError_BadUTF8Offset  = (-11),
  ePCREError_Partial        = (-12),
  ePCREError_BadPartial     = (-13),
  ePCREError_Internal       = (-14),
  ePCREError_BadCount       = (-15),
  ePCREError_DFA_UITEM      = (-16),
  ePCREError_DFA_UCOND      = (-17),
  ePCREError_DFA_UMLIMIT    = (-18),
  ePCREError_DFA_WSSIZE     = (-19),
  ePCREError_DFA_RECURSE    = (-20),
  ePCREError_RecursionLimit = (-21),
  ePCREError_NullWSLimit    = (-22),
  ePCREError_BadNewLine     = (-23),
  ePCREError_LoopLimit      = (-24),
  ePCREError_BadRegexString = (-1000),
  //! \internal
