...
class cZip : public ImplLocal<iZip> {
 public:
  ...
  tBool __stdcall ZipUncompressBuffer(tPtr apDest, tU32 anDestSize, tPtr apSrc,
                                      tU32 anSrcSize);
  tBool __stdcall ZipUncompressBufferInFile(iFile* apDest, tU32 anDestSize,
                                            tPtr apSrc, tU32 anSrcSize);
  tBool __stdcall ZipUncompressFile(iFile* apDest, tU32 anDestSize,
                                    iFile* apSrc, tU32 anSrcSize);
  tBool __stdcall ZipUncompressFileInBuffer(tPtr apDest, tU32 anDestSize,
                                            iFile* apSrc, tU32 anSrcSize);
  tBool __stdcall ZipInflateFileInBuffer(tPtr apDest, tU32 anDestSize,
                                         iFile* apSrc);
  tU32 __stdcall ZipCompressBuffer(tPtr apDest, tPtr apSrc, tU32 anSrcSize,
                                   tU32 anLevel);
  tU32 __stdcall ZipCompressBufferInFile(iFile* apDest, tPtr apSrc,
                                         tU32 anSrcSize, tU32 anLevel);
  tU32 __stdcall ZipCompressFile(iFile* apDest, iFile* apSrc, tU32 anSrcSize,
                                 tU32 anLevel);
  ...
  tI32 __stdcall UnzLocateFile(tHandle file, const achar* szFileName,
                               tBool bCaseSensitivity);
  tI32 __stdcall UnzLocateFileInc(tHandle file, tU32 num, tU32 pos);
  tI32 __stdcall UnzGetCurrentFileInfo(tHandle file, unz_file_info* pfile_info,
                                       cString& strFilename,
  ...
  tI32 __stdcall DeflateSetDictionary(z_streamp strm, const tU8* dictionary,
                                      tI32 dictLength);
  ...
  tI32 __stdcall DeflateTune(z_streamp strm, tI32 good_length, tI32 max_lazy,
                             tI32 nice_length, tI32 max_chain);
  ...
  tI32 __stdcall InflateSetDictionary(z_streamp strm, const tU8* dictionary,
                                      tI32 dictLength);
  ...
  tI32 __stdcall InflateBack(z_streamp strm, zlib_in_func aIn, void* in_desc,
                             zlib_out_func aOut, void* out_desc);
  tI32 __stdcall InflateBackEnd(z_streamp strm);
  tU32 __stdcall ZlibCompileFlags(void);
  tI32 __stdcall Compress(tU8* dest, tU32* destLen, const tU8* source,
                          tU32 sourceLen);
  tI32 __stdcall Compress2(tU8* dest, tU32* destLen, const tU8* source,
                           tU32 sourceLen, tI32 level);
  tU32 __stdcall CompressBound(tU32 sourceLen);
  tI32 __stdcall Uncompress(tU8* dest, tU32* destLen, const tU8* source,
                            tU32 sourceLen);
  ...
  tI32 __stdcall DeflateInit2(z_streamp strm, tI32 level, tI32 method,
                              tI32 windowBits, tI32 memLevel, tI32 strategy);
  tI32 __stdcall InflateInit2(z_streamp strm, tI32 windowBits);
  tI32 __stdcall InflateBackInit(z_streamp strm, tI32 windowBits,
  ...
  iFile* __stdcall CreateFileZipBufferEncoder(iFileBase* apBaseFile,
                                              tU32 anCLevel);
  iFile* __stdcall CreateFileZipBufferDecoder(iFileBase* apBaseFile,
                                              tSize aDecSize);
  ...
  iFile* __stdcall CreateFileRawBufferDecoder(iFileBase* apBaseFile,
                                              tSize aDecSize);

#if niMinFeatures(15)
  iZipArchWrite* __stdcall CreateZipArchive(
    iFile* apDest, const char* aaszPwd, const tStringCVec* apStoredExtensions);
