...
public class JSONTokener {
    ...
    private int nextCleanInternal() throws JSONException {
        while (pos < in.length()) {
            ...
            case '/':
                ...
                final char peek = in.charAt(pos);
                switch (peek) {
                case '*':
                    // skip a /* c-style comment */
                    pos++;
                    final int commentEnd = in.indexOf("*/", pos);
                    if (commentEnd == -1) {
    ...
    private char readEscapeCharacter() throws JSONException {
        final char escaped = in.charAt(pos++);
        switch (escaped) {
        case 'u':
            if (pos + 4 > in.length()) {
                throw syntaxError("Unterminated escape sequence");
            }
            final String hex = in.substring(pos, pos + 4);
            pos += 4;
    ...
    private Object readLiteral() throws JSONException {
        final String literal = nextToInternal("{}[]/\\:,=;# \t\f");
    ...
    private JSONObject readObject() throws JSONException {
        ...
        final int first = nextCleanInternal();
        if (first == '}') {
            return result;
        }
        else if (first != -1) {
        ...
        while (true) {
             ...
             */
            final int separator = nextCleanInternal();
    ...
    public char nextClean() throws JSONException {
        final int nextCleanInt = nextCleanInternal();
    ...
    public String next(final int length) throws JSONException {
        ...
        final String result = in.substring(pos, pos + length);
        pos += length;
        return result;
    }
    ...
    public void skipPast(final String thru) {
        final int thruStart = in.indexOf(thru, pos);
    ...
    public char skipTo(final char to) {
        final int index = in.indexOf(to, pos);
        if (index != -1) {
            pos = index;
            return to;
        }
