...
static const char* _MultiLineText_Line0 =
  "If you can keep your head when all about you Are losing theirs and blaming it on you,";
static const char* _MultiLineText_Line4 = "";
static const char* _MultiLineText_Line7 =
  "If you can meet with Triumph and Disaster And treat those two impostors just the same;";
static const char* _MultiLineText_Line20 = "-- Rudyard Kipling";

static const char* _MultiLineText2 =
  "<f = Tahoma>< s = 32 >Coucou voici gjp AVT PJ</s></f> gjp un $1,234.56 <s=24><c=RGBA(1,1,0,1)>super</c></s> <b>Mot <i>Tagge</i></b>!\n\nOn se demande d'ailleurs <bc=RGB(0,0,0)>ce</bc> qu'il va se passer a la ligne suivante avec les changements de tailles de fonts qu'on a <b>pu</b> faire.";
static const char* _MultiLineText2_Line0 =
  "<f = Tahoma>< s = 32 >Coucou voici gjp AVT PJ</s></f> gjp un $1,234.56 <s=24><c=RGBA(1,1,0,1)>super</c></s> <b>Mot <i>Tagge</i></b>!";
...
extern "C" const ni::achar* GetTestDataString(ni::tU32 aString)
{
  ...
  case eTestDataString_Bug1: return (const ni::achar*)_kaszTestString_Bug1;
...
{
  switch (aString) {
  case eTestDataString_PathFull: return _kaszTestString_PathFull_size;
  case eTestDataString_PathFullBS_notzeroterminated:
    return _kaszTestString_PathFullBS_size;
  case eTestDataString_PathDirSlash: return _kaszTestString_PathDirSlash_size;
  case eTestDataString_PathDirNoSlash:
    return _kaszTestString_PathDirNoSlash_size;
  case eTestDataString_PathFile: return _kaszTestString_PathFile_size;
  case eTestDataString_PathEl1: return _kaszTestString_PathEl1_size;
  case eTestDataString_PathEl2: return _kaszTestString_PathEl2_size;
  case eTestDataString_PathEl3: return _kaszTestString_PathEl3_size;
  case eTestDataString_PathEl4: return _kaszTestString_PathEl4_size;
  case eTestDataString_PathEl5: return _kaszTestString_PathEl5_size;
  case eTestDataString_PathEl6: return _kaszTestString_PathEl6_size;
  case eTestDataString_PathEl7: return _kaszTestString_PathEl7_size;
  case eTestDataString_Bug1: return _kaszTestString_Bug1_size;
  case eTestDataString_Bug1Slash: return _kaszTestString_Bug1Slash_size;
  case eTestDataString_Bug1GB_notzeroterminated:
    return _kaszTestString_Bug1GB_size;
  case eTestDataString_Bug1U16: return _kaszTestString_Bug1U16_size;
  case eTestDataString_Bug2_notzeroterminated: return _kaszTestString_Bug2_size;
  }
  niAssert(0 && "Unreachable");
  return 0;
}
...
static const ni::tU8 _TestString[] = { 0x61, 0x62, 0x63, 0x64, 0x64, 0x65, 0x66,
                                       0x67, 0x68, 0x69, 0xc3, 0xa0, 0xc3, 0xa9,
                                       0xc3, 0xa8, 0xc3, 0xa7, 0xc3, 0xb9, 0xe2,
                                       0x82, 0xac, 0xc2, 0xb5, 0xc2, 0xb0, 0xe4,
                                       0xbd, 0xa0, 0xe5, 0xa5, 0xbd, 0xce, 0xb1,
                                       0xce, 0xb2, 0x63, 0x62, 0x61, 0x00 };
...
{
  ni::cString utfSet =
    (abSet ? _ASTR("Set") : _ASTR("Get")) + GetTestStringUTF8();
...
const ni::achar* _kaszTestData = _A(
  "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ");
...
struct sFuncRetString {
  ni::cString _str;
  void Set(ni::cString v)
  {
    _str = v;
  }
  ni::cString Get() const
  {
    return _str;
  }
  ni::cString GetX(ni::cString v)
  {
    return v;
  }
};
...
{
  const ni::cString ref = _kaszTestString;
  CHECK_EQUAL(ref, ni::cString(GetTestStringUTF8(),
                               GetTestStringUTF8() + _knTestStringLen));
  CHECK_EQUAL(ref, ni::cString(GetTestStringUTF16(),
                               GetTestStringUTF16() + _knTestStringLen));
  CHECK_EQUAL(ref, ni::cString(GetTestStringUTF32(),
                               GetTestStringUTF32() + _knTestStringLen));
  CHECK_EQUAL(ref.slice(0, -3),
              ni::cString(GetTestStringUTF8(),
                          GetTestStringUTF8() + (_knTestStringLen - 3)));
  CHECK_EQUAL(ref.slice(0, -3),
              ni::cString(GetTestStringUTF16(),
                          GetTestStringUTF16() + (_knTestStringLen - 3)));
  CHECK_EQUAL(ref.slice(0, -3),
              ni::cString(GetTestStringUTF32(),
                          GetTestStringUTF32() + (_knTestStringLen - 3)));
...
TEST_FIXTURE(niCore_String, Empty)
{
  ...
  CHECK_EQUAL(
    emptyA.c_str(),
    emptyB.c_str()); // make sure both point to the same static empty string
...
TEST_FIXTURE(niCore_String, Split_TestPath1)
{
  ...
  {
    CHECK_EQUAL(_ASTR(GetTestDataString(i)),
                vToks->at(i - eTestDataString_PathEl1));
  }
}
...
{
  const ni::cString strTestPath(
    GetTestDataString(eTestDataString_PathFullBS_notzeroterminated),
...
TEST_FIXTURE(niCore_String, Split_TestPathNULL1)
{
  const ni::cString strTestPath = _A("/");
  ni::Ptr<ni::tStringCVec> vToks = ni::tStringCVec::Create();
  CHECK_EQUAL((ni::tSize)1,
              StringSplit(strTestPath, (const ni::achar*)NULL, vToks.ptr()));
...
{
  const ni::cString strTestPath = _A("/");
  CHECK_EQUAL((ni::tSize)1, StringSplit(strTestPath, (const ni::achar*)NULL,
                                        (astl::vector<ni::cString>*)NULL));
}
...
{
  const ni::cString strTestPath = _A("");
  CHECK_EQUAL((ni::tSize)0, StringSplit(strTestPath, (const ni::achar*)NULL,
                                        (astl::vector<ni::cString>*)NULL));
}
...
TEST_FIXTURE(niCore_String, Split_TestPathNULL6)
{
  ...
  CHECK_EQUAL((ni::tSize)8, StringSplit(strTestPath, _A("/\\"),
                                        (astl::vector<ni::cString>*)NULL));
}
...
TEST_FIXTURE(niCore_String, Compare)
{
  ...
  ni::cString testC(_kaszTestString);
  testC.ToUpper();
...
TEST_FIXTURE(niCore_String, FindUTF8)
{
  ...
  CHECK_EQUAL(_ASTR(test.substr(pos)),
              _ASTR(GetTestDataString(eTestDataString_PathFile)));
}
...
{
  ni::cString test(_kaszTestString);
  CHECK_EQUAL(ni::cString(_A("")),
              test.Mid(ni::eInvalidHandle, ni::eInvalidHandle));
}
...
TEST_FIXTURE(niCore_String, PropertyName)
{
  ...
  CHECK_EQUAL(_ASTR("color4_from_name"),
              StringToPropertyName(tmp, "GetColor4FromName"));
  CHECK_EQUAL(_ASTR("color4_from_name"),
              StringToPropertyName(tmp, "Color4FromName"));
  CHECK_EQUAL(_ASTR("vec3"), StringToPropertyName(tmp, "SetVec3"));
  CHECK_EQUAL(_ASTR("vec3"), StringToPropertyName(tmp, "GetVec3"));
  CHECK_EQUAL(_ASTR("my_cool_property"),
              StringToPropertyName(tmp, "SetMyCoolProperty"));
  CHECK_EQUAL(_ASTR("my_cool_property"),
              StringToPropertyName(tmp, "GetMyCoolProperty"));
  CHECK_EQUAL(_ASTR(GetTestStringUTF8()),
              StringToPropertyName(tmp, utfSet.Chars()));
  CHECK_EQUAL(_ASTR(GetTestStringUTF8()),
              StringToPropertyName(tmp, utfGet.Chars()));
  ...
  CHECK_EQUAL(_ASTR("Context55D"),
              StringToPropertyMethodName(tmp, "context55d"));
  CHECK_EQUAL(_ASTR("MyCoolProperty"),
              StringToPropertyMethodName(tmp, "my_cool_property"));
  CHECK_EQUAL(utfSet, _ASTR("Set") +
                        StringToPropertyMethodName(tmp, GetTestStringUTF8()));
  CHECK_EQUAL(utfGet, _ASTR("Get") +
                        StringToPropertyMethodName(tmp, GetTestStringUTF8()));
  CHECK_EQUAL(_ASTR("loaded_module_from_id"),
              StringToPropertyName(tmp, "GetLoadedModuleFromID"));
}
...
TEST_FIXTURE(niCore_String, PropertyName2)
{
  ...
  CHECK_EQUAL(_ASTR("myCoolProperty"),
              StringToPropertyName2(tmp, "SetMyCoolProperty"));
  CHECK_EQUAL(_ASTR("myCoolProperty"),
              StringToPropertyName2(tmp, "GetMyCoolProperty"));
  CHECK_EQUAL(_ASTR(GetTestStringProperty2UTF8()),
              StringToPropertyName2(tmp, utfSet.Chars()));
  CHECK_EQUAL(_ASTR(GetTestStringProperty2UTF8()),
              StringToPropertyName2(tmp, utfGet.Chars()));
  CHECK_EQUAL(_ASTR("Name"), StringToPropertyMethodName2(tmp, "name"));
  CHECK_EQUAL(_ASTR("Context3D"),
              StringToPropertyMethodName2(tmp, "context3D"));
  CHECK_EQUAL(_ASTR("Context55D"),
              StringToPropertyMethodName2(tmp, "context55D"));
  CHECK_EQUAL(_ASTR("MyCoolProperty"),
              StringToPropertyMethodName2(tmp, "myCoolProperty"));
  CHECK_EQUAL(utfSet, _ASTR("Set") + StringToPropertyMethodName2(
                                       tmp, GetTestStringProperty2UTF8()));
  CHECK_EQUAL(utfGet, _ASTR("Get") + StringToPropertyMethodName2(
                                       tmp, GetTestStringProperty2UTF8()));
  CHECK_EQUAL(_ASTR("loadedModuleFromID"),
              StringToPropertyName2(tmp, "GetLoadedModuleFromID"));
}
...
TEST_FIXTURE(niCore_String, PrintTestData)
{
  niLoop (i, eTestDataString_Last) {
    ...
    const ni::cString v(GetTestDataString((eTestDataString)i),
                        GetTestDataStringSize((eTestDataString)i));
    niDebugFmt(("TESTDATA[%d,%s]: (%d) '%s'", i,
                GetTestDataStringName((eTestDataString)i),
                GetTestDataStringSize((eTestDataString)i), v));
  }
}
...
{
  ni::cString v(GetTestDataString(eTestDataString_Bug2_notzeroterminated),
                GetTestDataStringSize(eTestDataString_Bug2_notzeroterminated));
...
TEST_FIXTURE(niCore_String, BreakLineIt2)
{
  ...
  while (!lineIt.is_end()) {
    ...
    case 0:
      ...
      break;
    case 1: CHECK_EQUAL(0, lineIt.current().length()); break;
    case 2: CHECK(lineIt.current().length() > 0); break;
    }
    lineIt.next();
    ++numLines;
  }
...
TEST_FIXTURE(niCore_String, StrGetUCPProps)
{
  ...
  for (int i = 32; i < 127; ++i) {
    ...
    niDebugFmt((
      "CHAR[%3d,%02X]: %c, category: %s (%d), charType: %s (%d), script: %s (%d)",
      i, i, i, niEnumToChars(eUCPCategory, cat), cat,
