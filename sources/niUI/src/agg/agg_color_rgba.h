...
inline rgba rgba_pre(const rgba& c, agg_real a)
{
  return rgba(c, a).premultiply();
}

//------------------------------------------------------------------------
inline rgba rgba::from_wavelength(agg_real wl, agg_real gamma)
{
  rgba t(0.0, 0.0, 0.0);
...
struct rgba8
{
  ...
  //--------------------------------------------------------------------
  AGG_INLINE self_type gradient(const self_type& c, agg_real k) const
  {
    self_type ret;
