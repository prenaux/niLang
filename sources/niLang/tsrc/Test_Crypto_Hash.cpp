...
TEST_FIXTURE(FCryptoHash, MD5)
{
  const ni::tU32 dataSize = GetTestDataStringSize(eTestDataString_PathFull) -
                            1; // -1 don't include the terminating zero
...
TEST_FIXTURE(FCryptoHash, SHA256)
{
  ...
  CHECK_EQUAL(
    _ASTR("e770ff443471bb0e279a0c8ce793d556ea81a87bb6740b6d5daa591361ce04e5"),
    res);
}
...
TEST_FIXTURE(FCryptoHash, SHA384)
{
  ...
  hash->UpdateRaw((tPtr)data, dataSize);
  cString res = hash->FinalString(eRawToStringEncoding_Hex);
  TEST_DEBUGFMT("SHA384: %s -> %s", data, res);
  CHECK_EQUAL(
    _ASTR(
      "f785f66618308d1cc08fc1bc7c86483d6f02e5111370b5bd3c9c2e4db4aba7efc641a89d7a89a969f5974f05fbca42a6"),
    res);
}
...
TEST_FIXTURE(FCryptoHash, SHA512)
{
  ...
  hash->UpdateRaw((tPtr)data, dataSize);
  cString res = hash->FinalString(eRawToStringEncoding_Hex);
  TEST_DEBUGFMT("SHA512: %s -> %s", data, res);
  CHECK_EQUAL(
    _ASTR(
      "625408ee195a4a6881acf1ac3d7413eadacced4427321069c4c41d5d6e9685a9cfb49bf68b640580d3c14acb31b427a79bb823839f96f9b164a47fe5534f88d9"),
    res);

  // test the truncated variants
  {
    CHECK_EQUAL(_ASTR("625408ee195a4a6881acf1ac3d7413ea"),
                ni::GetCrypto()->DigestRaw((ni::tPtr)data, dataSize,
                                           "sha512_128",
    ...
    CHECK_EQUAL(
      _ASTR("625408ee195a4a6881acf1ac3d7413eadacced4427321069c4c41d5d6e9685a9"),
      ni::GetCrypto()->DigestRaw((ni::tPtr)data, dataSize, "sha512_256",
                                 eRawToStringEncoding_Hex));
  }
}
